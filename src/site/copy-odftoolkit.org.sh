...
git archive --format=tar v0.13.0 | tar -x -C "${dir}" docs/
git archive --format=tar --prefix=0.12/ odftoolkit-0.12.0-docs | tar -x -C "${dir}" 0.12/docs/api
mv "${dir}/0.12/docs/api" "${dir}/docs/api-0.12"
rm -r "${dir}/0.12"
