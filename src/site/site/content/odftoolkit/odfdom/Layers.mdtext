...
The main requirements for this layer in regard of ZIP are:   
  ...
  - Enlist all file streams in the /META-INF/manifest.xml (similar to an
    inventory)
  - Begin the package with an unzipped 'mimetype' file stream (allowing
    others to easily identify the package)
