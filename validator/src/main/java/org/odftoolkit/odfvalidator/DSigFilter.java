...
class DSigFilter extends NamespaceFilter {
  ...
  private static final String OOO_DSIG_NAMESPACE_URI =
      "http://openoffice.org/2004/documentsignatures";
  private static final String DSIG_NAMESPACE_URI =
  ...
  String adaptNamespaceUri(String aUri, String aPrefix) {
    String aNewUri = null;
    if (aUri.equals(OOO_DSIG_NAMESPACE_URI)) aNewUri = DSIG_NAMESPACE_URI;
