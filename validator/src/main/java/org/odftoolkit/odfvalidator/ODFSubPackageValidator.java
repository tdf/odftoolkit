...
class ODFSubPackageValidator extends ODFPackageValidator {
  ...
  ODFSubPackageValidator(
    ...
    if (aFilter != null)
      aFilter.startPackage(
          aParentGenerator); // take build id from main document as default (embedded objects can
    // nevern be newer)
  }
