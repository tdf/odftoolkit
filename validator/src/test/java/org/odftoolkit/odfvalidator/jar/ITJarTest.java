...
/**
 * Integration test to validate via JAR testing command line parameters on (an invalid) ODF package.
 */
public class ITJarTest {
  ...
  public void validateOdtViaCommandline() {
    ...
    try {
      ...
      // java -jar
      // .m2/repository/org/apache/odftoolkit/odfvalidator/1.2.0-incubating-SNAPSHOT/odfvalidator-1.2.0-incubating-SNAPSHOT-jar-with-dependencies.jar foo.odt
