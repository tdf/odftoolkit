...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://relaxng.org/ns/structure/1.0" xmlns:rng="http://relaxng.org/ns/structure/1.0" xmlns:exsl="http://exslt.org/common" extension-element-prefixes="exsl" 
...
<xsl:template match="/">
	...
	<xsl:if test="$out=1">
		<xsl:document href="{$out-name}7-2.rng" method="xml" indent="no">
...
<xsl:template match="/" mode="step7.3">
	...
	<xsl:if test="$out=1">
		<xsl:document href="{$out-name}7-3.rng" method="xml" indent="yes">
			<xsl:copy-of select="$step"/>
		</xsl:document>
	</xsl:if>
	<xsl:choose>
...
<xsl:template match="/" mode="step7.4">
	...
	<xsl:if test="$out=1">
		<xsl:document href="{$out-name}7-4.rng" method="xml" indent="yes">
			<xsl:copy-of select="$step"/>
		</xsl:document>
	</xsl:if>
	<xsl:choose>
...
<xsl:template match="/" mode="step7.5">
	...
	<xsl:if test="$out=1">
		<xsl:document href="{$out-name}7-5.rng" method="xml" indent="yes">
			<xsl:copy-of select="$step"/>
		</xsl:document>
	</xsl:if>
	<xsl:choose>
...
<xsl:template match="/" mode="step7.7">
	...
	<xsl:if test="$out=1">
		<xsl:document href="{$out-name}7-7.rng" method="xml" indent="yes">
			<xsl:copy-of select="$step"/>
		</xsl:document>
	</xsl:if>
	<xsl:choose>
...
<xsl:template match="/" mode="step7.8">
	...
	<xsl:if test="$out=1">
		<xsl:document href="{$out-name}7-8.rng" method="xml" indent="yes">
			<xsl:copy-of select="$step"/>
		</xsl:document>
	</xsl:if>
	<xsl:choose>
...
<xsl:template match="/" mode="step7.9">
	...
	<xsl:if test="$out=1">
		<xsl:document href="{$out-name}7-9.rng" method="xml" indent="yes">
			<xsl:copy-of select="$step"/>
		</xsl:document>
	</xsl:if>
	<xsl:choose>
...
<xsl:template match="/" mode="step7.10">
	...
	<xsl:if test="$out=1">
		<xsl:document href="{$out-name}7-10.rng" method="xml" indent="yes">
			<xsl:copy-of select="$step"/>
		</xsl:document>
	</xsl:if>
	<xsl:choose>
...
<xsl:template match="/" mode="step7.11">
	...
	<xsl:if test="$out=1">
		<xsl:document href="{$out-name}7-11.rng" method="xml" indent="yes">
			<xsl:copy-of select="$step"/>
		</xsl:document>
	</xsl:if>
	<xsl:choose>
...
<xsl:template match="/" mode="step7.12">
	...
	<xsl:if test="$out=1">
		<xsl:document href="{$out-name}7-12.rng" method="xml" indent="yes">
			<xsl:copy-of select="$step"/>
		</xsl:document>
	</xsl:if>
	<xsl:choose>
...
<xsl:template match="/" mode="step7.13">
	...
	<xsl:if test="$out=1">
		<xsl:document href="{$out-name}7-13.rng" method="xml" indent="yes">
			<xsl:copy-of select="$step"/>
		</xsl:document>
	</xsl:if>
	<xsl:choose>
...
<xsl:template match="/" mode="step7.14">
	...
	<xsl:if test="$out=1">
		<xsl:document href="{$out-name}7-14.rng" method="xml" indent="yes">
			<xsl:copy-of select="$step"/>
		</xsl:document>
	</xsl:if>
	<xsl:choose>
...
<xsl:template match="/" mode="step7.15">
	...
	<xsl:if test="$out=1">
		<xsl:document href="{$out-name}7-15.rng" method="xml" indent="yes">
			<xsl:copy-of select="$step"/>
		</xsl:document>
	</xsl:if>
	<xsl:choose>
...
<xsl:template match="/" mode="step7.16">
	...
	<xsl:if test="$out=1">
		<xsl:document href="{$out-name}7-16.rng" method="xml" indent="yes">
			<xsl:copy-of select="$step"/>
		</xsl:document>
	</xsl:if>
	<xsl:choose>
...
<xsl:template match="/" mode="step7.18">
	...
	<xsl:if test="$out=1">
		<xsl:document href="{$out-name}7-18.rng" method="xml" indent="yes">
			<xsl:copy-of select="$step"/>
		</xsl:document>
	</xsl:if>
	<xsl:choose>
...
<xsl:template match="/" mode="step7.19">
	...
	<xsl:if test="$out=1">
		<xsl:document href="{$out-name}7-19.rng" method="xml" indent="yes">
			<xsl:copy-of select="$step"/>
		</xsl:document>
	</xsl:if>
	<xsl:choose>
...
<xsl:template match="/" mode="step7.20">
	...
	<xsl:if test="$out=1">
		<xsl:document href="{$out-name}7-20.rng" method="xml" indent="yes">
			<xsl:copy-of select="$step"/>
		</xsl:document>
	</xsl:if>
	<xsl:choose>
...
<xsl:template match="/" mode="step7.22">
	...
	<xsl:if test="$out=1">
		<xsl:document href="{$out-name}7-22.rng" method="xml" indent="yes">
			<xsl:copy-of select="$step"/>
		</xsl:document>
	</xsl:if>
	<xsl:choose>
