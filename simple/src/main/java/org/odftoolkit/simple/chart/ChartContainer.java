...
/**
 * ChartContainer is a container which maintains Chart(s) as element(s). Chart(s) can be added,
 * removed and iterated in this container.
 *
 * @see Chart
...
public interface ChartContainer {
   ...
   * @param cellRangeAddr the cell range address list which is used as chart data set.
   ...
   *
   * @param chartId the id of specified chart.
   * @since 0.6
   */
   ...
   *
   * @param title the title of specified chart(s).
   * @since 0.6
   */
