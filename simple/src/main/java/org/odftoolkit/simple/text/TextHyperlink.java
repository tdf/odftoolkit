...
/**
 * This class represents a text hyperlink in ODF document. It provides convenient methods to
 * get/set/remove the URI of hyperlinks.
 *
 * @since 0.6.5
 */
public class TextHyperlink extends Component {
   ...
   *
   * @param aElement the instance of TextAElement.
  ...
  public void setTextContent(String text) {
    ...
    if (text != null && !text.equals("")) Paragraph.appendTextElements(getOdfElement(), text, true);
  }
...
class AbstractTextHyperlinkContainer implements TextHyperlinkContainer {
  ...
  public AbstractTextHyperlinkContainer(OdfElement parent) {
    if ((parent instanceof TextPElement)
        ...
        || (parent instanceof TextSpanElement)) linkContainer = parent;
    else throw new InvalidParameterException(parent.getClass() + "is not a valid element.");
  }
