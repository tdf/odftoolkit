...
/**
 * This class represents footer definition in text document. It provides methods to manipulate
 * footer in text document, such as, set text, add table.
 *
 * @since 0.4.5
 */
public class Footer extends Component implements TableContainer, VariableContainer {
   ...
   *
   * @param element - an object of <code>StyleFooterElement</code>
   */
  ...
  /**
   * Return an instance of <code>StyleFooterElement</code> which represents this feature.
   *
   ...
   *
   * @return If this footer is visible return <code>true</code>, otherwise return <code>false</code>
   *     .
   * @since 0.5.5
   */
   ...
   *
   * @param isVisible If <code>isVisible</code> is true, the footer of this document is visible,
  ...
  private void updateTableToNone(Table table) {
    ...
    NodeList cells =
        tableEle.getElementsByTagNameNS(OdfDocumentNamespace.TABLE.getUri(), "table-cell");
  ...
  public Section appendSection(String name) {
    ...
    try {
      Document doc = (Document) ((OdfFileDom) footerEle.getOwnerDocument()).getDocument();
