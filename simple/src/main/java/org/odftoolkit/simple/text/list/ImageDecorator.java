 ...
 * image list. Users can set an image as the list item prefix. They also can extend this class and
 * realize their own list and list item style. For example, set a specifies list item with red
 * color.
 *
 * <p>An ImageDecorator can be reused in the same Document.
 *
 * @since 0.4
 */
public class ImageDecorator implements ListDecorator {

  private static String[] DEFAULT_MARGIN_LEFT_ATTRIBUTES = {
    "0.741cm", "1.482cm", "2.223cm", "2.963cm", "3.704cm", "4.445cm", "5.186cm", "5.927cm",
    "6.668cm", "7.408cm"
  };
   ...
   *
   * @param doc the Document which this ImageDecorator will be used on.
   * @param imageUri the image location.
   */
  public ImageDecorator(Document doc, URI imageUri) {
    ...
    try {
      ...
      if (listStyle == null) {
        ...
        for (int i = 0; i < 10; i++) {
          TextListLevelStyleImageElement listLevelElement =
              listStyle.newTextListLevelStyleImageElement(i + 1);
          ...
          StyleListLevelPropertiesElement styleListLevelPropertiesElement =
              listLevelElement.newStyleListLevelPropertiesElement();
          styleListLevelPropertiesElement.setTextListLevelPositionAndSpaceModeAttribute(
              "label-alignment");
          ...
          StyleListLevelLabelAlignmentElement styleListLevelLabelAlignmentElement =
              styleListLevelPropertiesElement.newStyleListLevelLabelAlignmentElement("listtab");
          styleListLevelLabelAlignmentElement.setTextListTabStopPositionAttribute(
              DEFAULT_MARGIN_LEFT_ATTRIBUTES[i]);
          styleListLevelLabelAlignmentElement.setFoTextIndentAttribute("-0.741cm");
          styleListLevelLabelAlignmentElement.setFoMarginLeftAttribute(
              DEFAULT_MARGIN_LEFT_ATTRIBUTES[i]);
        }
  ...
  private OdfStyle getOrCreateStyleByName(
