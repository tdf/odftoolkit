...
/**
 * SquareDecorator is an implementation of the ListDecorator interface,
 * decorates a given List as square list. User can extend this class and realize
 * their own list and list item style. For example, set a specifies list item
 * with red color.
 * <p>
 * A SquareDecorator can be reused in the same Document.
 *
 * @since 0.4
 */
