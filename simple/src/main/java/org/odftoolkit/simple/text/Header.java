...
/**
 * This class represents header definition in text document. It provides methods to manipulate
 * header in text document, such as, set text, add table.
 *
 * @since 0.4.5
 */
public class Header extends Component implements TableContainer, VariableContainer {
   ...
   *
   * @param element - an object of <code>StyleHeaderElement</code>
   */
  ...
  /**
   * Return an instance of <code>StyleHeaderElement</code> which represents this feature.
   *
   ...
   *
   * @return If this header is visible return <code>true</code>, otherwise return <code>false</code>
   *     .
   * @since 0.5.5
   */
   ...
   *
   * @param isVisible If <code>isVisible</code> is true, the header of this document is visible,
  ...
  public Section appendSection(String name) {
    ...
    try {
      Document doc = (Document) ((OdfFileDom) headerEle.getOwnerDocument()).getDocument();
