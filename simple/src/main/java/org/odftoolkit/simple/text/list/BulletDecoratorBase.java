...
public abstract class BulletDecoratorBase implements ListDecorator {
  ...
  private static final String[] DEFAULT_TEXT_SPACE_BEFORE_ATTRIBUTES = {
    null, "0.401cm", "0.799cm", "1.2cm", "1.6cm", "2.001cm", "2.399cm", "2.8cm", "3.2cm", "3.601cm"
  };
   ...
   * @param listCharacter listing character: (i.e. BulletDecorator:
   *     BulletDecorator.DEFAULT_BULLET_CHAR)
   */
  public BulletDecoratorBase(
      Document doc, String styleName, String styleNameIntern, String listCharacter) {
    ...
    try {
      ...
      if (listStyle == null) {
        ...
        for (int i = 0; i < 10; i++) {
          TextListLevelStyleBulletElement listLevelElement =
              listStyle.newTextListLevelStyleBulletElement(listCharacter, i + 1);
