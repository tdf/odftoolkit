...
/**
 * AbstractParagraphContainer is an abstract class to present paragraph container. It contains the
 * default implementation to add/get/remove paragraph. Each subclass needs to implement
...
public abstract class AbstractParagraphContainer implements ParagraphContainer {
  ...
  private class SimpleParagraphIterator implements Iterator<Paragraph> {
    ...
    private Paragraph findNext(Paragraph thisBox) {
      ...
      if (thisBox == null) {
        nextParagraph =
            OdfElement.findFirstChildNode(TextParagraphElementBase.class, containerElement);
      } else {
        nextParagraph =
            OdfElement.findNextChildNode(TextParagraphElementBase.class, thisBox.getOdfElement());
      }
