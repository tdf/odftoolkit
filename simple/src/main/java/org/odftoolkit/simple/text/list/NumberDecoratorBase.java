      ...
      if (listStyle == null) {
        ...
        for (int i = 0; i < 10; i++) {
          TextListLevelStyleNumberElement listLevelElement =
              listStyle.newTextListLevelStyleNumberElement(numberingFormat, i + 1);
