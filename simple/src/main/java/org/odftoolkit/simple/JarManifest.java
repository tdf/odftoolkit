...
/**
 * Provides meta data about the Simple ODF library as build date, version number. Its main() method
 * is the start method of the library, enabling the access of version methods from command line:
 * "java -jar simple-odf.jar".
 */
public class JarManifest {

  private static final String CURRENT_CLASS_RESOURCE_PATH =
      "org/odftoolkit/simple/JarManifest.class";
   ...
   * simple-odf.jar" and provides version information:
   *
   * <p>simple-odf 0.3 (build 20110201-1729) from http://odftoolkit.org supporting ODF 1.2
   *
   * <p>Allowing version access from the JAR without the need to unzip the JAR nor naming the JAR
   * (requiring the change of class path for every version due to JAR naming change).
   */
   ...
   *
   * @return A string containing both the name and the version of the Simple ODF library.
   */
