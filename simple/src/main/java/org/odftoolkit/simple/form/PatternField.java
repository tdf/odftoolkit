...
public class PatternField extends Field {
  ...
  /**
   * Get an instance of pattern field by an instance of FormFormattedTextElement, while searching
  ...
  public static PatternField getInstanceOf(FormFormattedTextElement element) {
    ...
    try {
      ...
      Logger.getLogger(PatternField.class.getName())
  ...
  public void setEditMask(String mask) {
    this.setFormProperty(
        OOFormProvider.FORM_PROPERTY_NAME_EDITMASK, "string", mask, null, null, null, null, null);
  }

  public void setLiteralMask(String mask) {
    this.setFormProperty(
        OOFormProvider.FORM_PROPERTY_NAME_LITERALMASK,
        "string",
        mask,
        null,
        null,
