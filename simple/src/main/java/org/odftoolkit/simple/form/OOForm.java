...
public class OOForm extends Component implements Form {
  ...
  static OOForm createForm(String name, OfficeFormsElement parent) {
    ...
    if (parent != null) {
      ...
      form.setControlImplementation(OOFormProvider.OO_CONTROL_IMPLEMENTATION_FORM);
  ...
  public Button createButton(
      ControlContainer parent, FrameRectangle rectangle, String name, String label) {
    FormButtonElement btnElement =
        mElement.newFormButtonElement(FormImageLocation.CENTER.toString(), generateFormId());
    ...
    btnForm.setControlImplementation(OOFormProvider.OO_CONTROL_IMPLEMENTATION_COMMANDBUTTON);
    btnForm.setLabel(label);
    btnForm.setFormProperty(
        OOFormProvider.FORM_PROPERTY_NAME_DEFAULTCONTROL,
        "string",
        OOFormProvider.FORM_PROPERTY_VALUE_COMMANDBUTTON,
        null,
        null,
        null,
        null,
  ...
  public FormControl createLabel(
      ControlContainer parent, FrameRectangle rectangle, String name, String text) {
    FormFixedTextElement fixedTElement = mElement.newFormFixedTextElement(generateFormId());
    // set default control properties
    ...
    labelForm.setControlImplementation(OOFormProvider.OO_CONTROL_IMPLEMENTATION_FIXEDTEXT);
  ...
  public FormControl createTextBox(
    ...
    textBoxForm.setControlImplementation(OOFormProvider.OO_CONTROL_IMPLEMENTATION_TEXTFEILD);
    textBoxForm.setValue(defaultText);
    textBoxForm.setCurrentValue(defaultText);
    textBoxForm.setFormProperty(
        OOFormProvider.FORM_PROPERTY_NAME_DEFAULTCONTROL,
        "string",
        OOFormProvider.FORM_PROPERTY_VALUE_TEXTFEILD,
        null,
        null,
        null,
        null,
    ...
    if (isMultipleLine)
      textBoxForm.setFormProperty(
          OOFormProvider.FORM_PROPERTY_NAME_MULTILINE,
          "boolean",
          null,
          true,
          null,
          ...
          null);
    textBoxForm.setFormProperty(
        OOFormProvider.FORM_PROPERTY_NAME_OBJIDINMSO, "float", null, null, null, null, 0.0, null);
  ...
  public FormControl createListBox(
      ControlContainer parent,
      FrameRectangle rectangle,
      String name,
      ...
      boolean isDropDown) {
    String formId = generateFormId();
    FormListboxElement listBoxElement = mElement.newFormListboxElement(generateFormId());
    // set default control properties
    ...
    listBoxForm.setControlImplementation(OOFormProvider.OO_CONTROL_IMPLEMENTATION_LISTBOX);
    ...
    listBoxForm.setFormProperty(
        OOFormProvider.FORM_PROPERTY_NAME_DEFAULTCONTROL,
        "string",
        OOFormProvider.FORM_PROPERTY_VALUE_LISTBOX,
        null,
        null,
        null,
        null,
        null);
    listBoxForm.setFormProperty(
        OOFormProvider.FORM_PROPERTY_NAME_CONTROLTYPEINMSO,
        "float",
        null,
        null,
        null,
        ...
        null);
    listBoxForm.setFormProperty(
        OOFormProvider.FORM_PROPERTY_NAME_FOCUSEDITEM, "float", null, null, null, null, 0.0, null);
    listBoxForm.setFormProperty(
        OOFormProvider.FORM_PROPERTY_NAME_EXTMULTISELECTION,
        "float",
        null,
        null,
        null,
  ...
  public FormControl createComboBox(
      ControlContainer parent,
      FrameRectangle rectangle,
      String name,
      String defaultText,
      boolean isDropDown) {
    String formId = generateFormId();
    FormComboboxElement comboElement = mElement.newFormComboboxElement(formId);
    // set default control properties
    ...
    comboBoxForm.setControlImplementation(OOFormProvider.OO_CONTROL_IMPLEMENTATION_COMBOBOX);
    ...
    comboBoxForm.setFormProperty(
        OOFormProvider.FORM_PROPERTY_NAME_DEFAULTCONTROL,
        "string",
        OOFormProvider.FORM_PROPERTY_VALUE_COMBOBOX,
        null,
        null,
        null,
        null,
  ...
  public FormControl createRadioButton(
      ControlContainer parent, FrameRectangle rectangle, String name, String label, String value) {
    String formId = generateFormId();
    FormRadioElement radioElement = mElement.newFormRadioElement("center", formId);
    // set default control properties
    ...
    radioBtnForm.setControlImplementation(OOFormProvider.OO_CONTROL_IMPLEMENTATION_RADIOBUTTON);
    ...
    radioBtnForm.setFormProperty(
        OOFormProvider.FORM_PROPERTY_NAME_DEFAULTCONTROL,
        "string",
        OOFormProvider.FORM_PROPERTY_VALUE_RADIOBUTTON,
        null,
        null,
        null,
        null,
  ...
  public FormControl createCheckBox(
      ControlContainer parent, FrameRectangle rectangle, String name, String label, String value) {
    String formId = generateFormId();
    FormCheckboxElement checkboxElement = mElement.newFormCheckboxElement("center", formId);
    // set default control properties
    ...
    checkboxForm.setControlImplementation(OOFormProvider.OO_CONTROL_IMPLEMENTATION_CHECKBOX);
    ...
    checkboxForm.setFormProperty(
        OOFormProvider.FORM_PROPERTY_NAME_DEFAULTCONTROL,
        "string",
        OOFormProvider.FORM_PROPERTY_VALUE_CHECKBOX,
        null,
        null,
        null,
        null,
   ...
   *
   * @param parent - the element that contains this form control
   * @param rectangle - the bounding rectangle used by this button
   * @param name - the name of the control
   * @param defaultValue - the default value of this input field. It's a 6 digits number, e.g.
   *     20121015 represents 2012-10-15.
   * @return an instance of time field
   */
  public FormControl createDateField(
      ControlContainer parent, FrameRectangle rectangle, String name, String defaultValue) {
    return createField(FieldType.DATE_FIELD, parent, rectangle, name, defaultValue);
  }
   ...
   * @param name - the name of the control
   * @param defaultValue - the default value of this input field. It's a 6 digits number, e.g.
   *     15304000 represents 15:30:40.
   * @return an instance of time field
   */
  public FormControl createTimeField(
      ControlContainer parent, FrameRectangle rectangle, String name, String defaultValue) {
    return createField(FieldType.TIME_FIELD, parent, rectangle, name, defaultValue);
  }

  public FormControl createNumericField(
      ControlContainer parent, FrameRectangle rectangle, String name, String defaultValue) {
    return createField(FieldType.NUMERIC_FIELD, parent, rectangle, name, defaultValue);
  }

  public FormControl createPatternField(
      ControlContainer parent, FrameRectangle rectangle, String name, String defaultValue) {
    return createField(FieldType.PATTERN_FIELD, parent, rectangle, name, defaultValue);
  }

  public FormControl createCurrencyField(
      ControlContainer parent, FrameRectangle rectangle, String name, String defaultValue) {
    return createField(FieldType.CURRENCY_FIELD, parent, rectangle, name, defaultValue);
  }

  private FormControl createField(
      FieldType type,
      ControlContainer parent,
      FrameRectangle rectangle,
      String name,
      String defaultValue) {
    String formId = generateFormId();
    FormFormattedTextElement formattedTextElement = mElement.newFormFormattedTextElement(formId);
    ...
    if (fieldForm == null) throw new RuntimeException("Fail to create a field.");
  ...
  public FormCommandType getCommandType() {
    return FormCommandType.enumValueOf(mElement.getFormCommandTypeAttribute());
  }
