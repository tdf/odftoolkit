...
public class FormTypeDefinition {
   ...
   *
   * <p>This attibute specifies the location of an image relative to the text of a control.
   */
   ...
   *
   * <p>This attibute specifies the type of command to execute on a data source.
   */
   ...
   *
   * <p>This attibutes pecifies how to populate the entry list in a combo box or list box control.
   */
   ...
   *
   * <p>This attibutes pecifies the default state of a check box control.
   */
