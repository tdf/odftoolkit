...
public interface FormContainer {
  ...
  /**
   * Get the ODF element <code>OfficeFormsElement</code> which can have <code>FormFormElement</code>
   * as child element directly according to ODF specification. This element will help to find the
   * position to insert a new <code>FormFormElement</code> element.
   *
   ...
   *
   * @param name - form name, represents attribute <code>form:name</code>
  ...
  /**
   * Get the attribute <code>form:apply-design-mode</code> which specifies whether forms are
   * presented in editable or non-editable state.
   *
   * @return true if forms in document are presented in editable state;false if forms in document
   *     are presented in completed state
   */
  public boolean getApplyDesignMode();

  /**
   * Get the attribute <code>form:automatic-focus</code> which specifies whether the consumer
   * loading the document should set the focus to a form control.
   *
   * @return true if sets the focus to a form control after loading the document; false if else.
   */
  public boolean getAutomaticFocus();

  /**
   * Set the attribute <code>form:apply-design-mode</code> which specifies whether forms are
   * presented in editable or non-editable state.
   *
   * @param isDesignMode - true if forms in document are presented in editable state; false if forms
   *     in document are presented in completed state
   */
  public void setApplyDesignMode(boolean isDesignMode);

  /**
   * Set the attribute <code>form:automatic-focus</code> which specifies whether the consumer
   * loading the document should set the focus to a form control.
   *
   * @param isAutoFocus -true if sets the focus to a form control after loading the document; false
   *     if else.
   */
