...
public class CurrencyField extends Field {
  ...
  public static CurrencyField getInstanceOf(FormFormattedTextElement element) {
    ...
    try {
      ...
      Logger.getLogger(CurrencyField.class.getName())
  ...
  public void setCurrencySymbol(String symbol) {
    this.setFormProperty(
        OOFormProvider.FORM_PROPERTY_NAME_CURRENCYSYMBOL,
        "string",
        symbol,
        null,
        null,
  ...
  public void setDecimalAccuracy(double value) {
    this.setFormProperty(
        OOFormProvider.FORM_PROPERTY_NAME_DECIMALACCURACY,
        "float",
        null,
        null,
        null,
  ...
  public void setStepValue(double value) {
    this.setFormProperty(
        OOFormProvider.FORM_PROPERTY_NAME_VALUESTEP, "float", null, null, null, null, value, null);
  }

  public void setCurrencySymbolVisible(boolean visible) {
    this.setFormProperty(
        OOFormProvider.FORM_PROPERTY_NAME_PREPENDCURRENCYSYMBOL,
        "boolean",
        null,
        visible,
        null,
