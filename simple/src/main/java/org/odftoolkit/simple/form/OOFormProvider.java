...
public class OOFormProvider implements FormProvider {
  ...
  static final String OO_CONTROL_IMPLEMENTATION_COMMANDBUTTON =
      "ooo:com.sun.star.form.component.CommandButton";
  static final String OO_CONTROL_IMPLEMENTATION_FIXEDTEXT =
      "ooo:com.sun.star.form.component.FixedText";
  static final String OO_CONTROL_IMPLEMENTATION_TEXTFEILD =
  ...
  static final String OO_CONTROL_IMPLEMENTATION_GROUPBOX =
      "ooo:com.sun.star.form.component.GroupBox";
  static final String OO_CONTROL_IMPLEMENTATION_COMBOBOX =
      "ooo:com.sun.star.form.component.ComboBox";
  static final String OO_CONTROL_IMPLEMENTATION_RADIOBUTTON =
      "ooo:com.sun.star.form.component.RadioButton";
  static final String OO_CONTROL_IMPLEMENTATION_CHECKBOX =
      "ooo:com.sun.star.form.component.CheckBox";
  static final String OO_CONTROL_IMPLEMENTATION_DATEFIELD =
      "ooo:com.sun.star.form.component.DateField";
  static final String OO_CONTROL_IMPLEMENTATION_TIMEFIELD =
      "ooo:com.sun.star.form.component.TimeField";
  static final String OO_CONTROL_IMPLEMENTATION_NUMERICFIELD =
      "ooo:com.sun.star.form.component.NumericField";
  static final String OO_CONTROL_IMPLEMENTATION_PATTERNFIELD =
      "ooo:com.sun.star.form.component.PatternField";
  static final String OO_CONTROL_IMPLEMENTATION_CURRENCYFIELD =
      "ooo:com.sun.star.form.component.CurrencyField";
