...
/**
 * AbstractFrameContainer is an abstract implementation of the FrameContainer interface, with a
 * default implementation for every method defined in FrameContainer, except
...
public abstract class AbstractFrameContainer implements FrameContainer {
   ...
   *
   * @param rectangle - the rectangle (position and size) of this frame
   ...
   *
   * <p>Null will be returned if the owner document is not a presentation document.
   *
   * @param usage - the usage value
   * @return a list of frame whose usage is a given value. Null will be returned if the owner
   *     document is not a presentation document.
