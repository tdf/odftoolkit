...
public class Textbox extends Frame implements ListContainer, ParagraphContainer {
   ...
   *
   * @param element - the instance of DrawTextBoxElement
   ...
   *
   * <p>This method will clear the content at first, and then create a paragraph with the given
   * content.
   *
  ...
  /**
   * Get the instance of <code>DrawTextBoxElement</code> which represents this frame.
   *
