...
public class FrameStyleHandler extends DefaultStyleHandler {
  ...
  public void setStroke(
      StyleTypeDefinitions.OdfDrawStroke stroke,
      Color color,
      String widthDesc,
  ...
  public void setBackgroundColor(Color color) {
    if (color == null) getGraphicPropertiesForWrite().setFill(OdfDrawFill.NONE, null);
    else getGraphicPropertiesForWrite().setFill(OdfDrawFill.SOLID, color);
  }

  /**
   * Set whether the content of a frame is displayed in the background or foreground. If it's
   * displayed in the background, the content wouldn't be selected or moved.
   *
   * @param isBackgroundFrame If <code>true</code>, the frame is displayed in the background.
   * @since 0.5.5
   */
  ...
  /**
   * Set how a frame is bound to a text document. Default position relative and alignment will be
   * set.
   *
