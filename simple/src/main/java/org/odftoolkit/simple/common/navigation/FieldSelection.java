...
public class FieldSelection extends Selection {
   ...
   * and so on.
   *
   * @param fieldType the simple field type to replace.
   */
  public Field replaceWithSimpleField(Field.FieldType fieldType) {
    ...
    search
        .mDocument
        .getSelectionManager()
        .refresh(textSelection.getContainerElement(), offset, index + textLength);
    return field;
  }
   ...
   *
   * @param field the reference field to replace.
   */
   ...
   *
   * @param field the variable field to replace.
   */
   ...
   */
  public ConditionField replaceWithConditionField(
      String condition, String trueText, String falseText) {
    int leftLength = textSelection.getText().length();
    int index = textSelection.getIndex();
    prepareSpanContainer(leftLength, index);
    ...
    search
        .mDocument
        .getSelectionManager()
        .refresh(textSelection.getContainerElement(), offset, index);
