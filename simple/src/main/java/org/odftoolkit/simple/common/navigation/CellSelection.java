...
/**
 * Based on <code>TextSelection</code>, <code>CellSelection</code> updates table cell value and
 * value type when the cell text is replaced by other content. This is a more complete realization
 * than TextSelection for cell content replacement, which keeps the synchronization among cell
 * value, value type and display text.
 *
 * @see TextSelection
...
public class CellSelection extends TextSelection {
   ...
   */
  CellSelection(Navigation search, String text, OdfElement containerElement, int index, Cell cell) {
    super(search, text, containerElement, index);
    mCell = cell;
  }

  /**
   * Replace the text content of selection with a new string. The cell value and value type will be
   * updated follow by the rules which are designed in the {@link
   * org.odftoolkit.simple.table.CellValueAdapter <code>CellValueAdapter</code>}.
   *
   ...
   * @see org.odftoolkit.simple.table.CellValueAdapter
   */
  public void advancedReplaceWith(String newText, CellValueAdapter adapter)
