...
/**
 * It's a sub class of TextExtractor, which provides a method <code>getText()</code> to return all
...
public class EditableTextExtractor extends TextExtractor {
   ...
   * specified document.
   *
   * @param doc the document whose text will be extracted.
   ...
   *
   * @param doc the document whose editable text would be extracted.
   */
   ...
   *
   * @see
   *     org.odftoolkit.odfdom.dom.DefaultElementVisitor#visit(org.odftoolkit.odfdom.dom.element.draw.DrawObjectElement)
   */
  @Override
  public void visit(DrawObjectElement element) {
    String embedDocPath = element.getXlinkHrefAttribute();
    Document embedDoc =
        ((Document) (((OdfContentDom) element.getOwnerDocument()).getDocument()))
   ...
   *
   * @see
   *     org.odftoolkit.odfdom.dom.DefaultElementVisitor#visit(org.odftoolkit.odfdom.dom.element.text.TextTrackedChangesElement)
   */
  @Override
   ...
   *
   * @see
   *     org.odftoolkit.odfdom.dom.DefaultElementVisitor#visit(org.odftoolkit.odfdom.dom.element.text.TextAElement)
   */
  @Override
   ...
   *
   * @see
   *     org.odftoolkit.odfdom.dom.DefaultElementVisitor#visit(org.odftoolkit.odfdom.dom.element.text.TextTabElement)
   */
  @Override
  ...
  private String getDocumentText() {
    ...
    try {
      ...
      EditableTextExtractor contentDomExtractor =
