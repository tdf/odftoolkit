...
/**
 * A <tt>SubjectField</tt> displays the subject value contained by the document meta data.
 *
 * @since 0.5
 */
public class SubjectField extends Field {
  ...
  /**
   * Return an instance of <code>TextSubjectElement</code> which represents this feature.
   *
