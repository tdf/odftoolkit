...
public class WhitespaceProcessor {
   ...
   * @deprecated As of Simple version 0.3.5, replaced by <code>TextExtractor.getText(OdfElement)
   *     </code>
   ...
   * that creates its own WhitespaceProcessor, so that you don't have to.
   *
   * @param element the element to which content is being added
   * @param content text content including whitespace
   */
