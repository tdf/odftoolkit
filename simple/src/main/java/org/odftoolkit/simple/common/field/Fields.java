...
public class Fields {
   ...
   * date.
   *
   * @param odfElement the OdfElement which owns this field.
  ...
  /**
   * Declare a simple variable field. Simple variables, can take different values at different
   * positions throughout a document.
   *
   * <p>Simple variables can be used to display different text in recurring elements, such as
   * headers or footers.
   *
   * @param container the container which this variable field is contained.
   * @param name the name of this variable field.
  ...
  /**
   * Declare a user variable field. User variables have the same value throughout a document. If a
   * user variable is set anywhere within the document, all fields in the document that display the
   * user variable have the same value.
   *
   * @param container the container which this variable field is contained.
   * @param name the name of this variable field.
   * @param value the initial value of this variable field.
   * @return the created variable field.
   */
  public static VariableField createUserVariableField(
      VariableContainer container, String name, String value) {
   ...
   * another. If the condition is true, one of the text strings is displayed. If the condition is
   * false, the other text string is displayed.
   *
   * @param odfElement the OdfElement which owns this field.
   * @param condition the condition that determines which of the two text strings is displayed.
   * @param trueText the text string to display if a <code>condition</code> is true.
   * @param falseText the text string to display if a <code>condition</code> is false.
   * @return the created condition field.
   */
  public static ConditionField createConditionField(
      OdfElement odfElement, String condition, String trueText, String falseText) {
   ...
   *
   * @param odfElement the OdfElement which owns this field.
   * @param condition the condition that determines whether the text string is displayed or not.
   * @param text the text string to display.
   * @return the created condition field.
   */
  public static ConditionField createHiddenTextField(
      OdfElement odfElement, String condition, String text) {
