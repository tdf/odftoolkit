...
/**
 * AbstractVariableContainer is an abstract implementation of the VariableContainer interface, with
 * a default implementation for every method defined in VariableContainer , except
 * getVariableContainerElement(). A subclass must implement the abstract method
...
public abstract class AbstractVariableContainer implements VariableContainer {
  ...
  public VariableField getVariableFieldByName(String name) {
    ...
    TextVariableDeclsElement simpleVariableElements =
        OdfElement.findFirstChildNode(TextVariableDeclsElement.class, containerElement);
    if (simpleVariableElements != null) {
      TextVariableDeclElement simpleVariableElement =
          (TextVariableDeclElement) simpleVariableElements.getFirstChild();
    ...
    if (userVariableElements != null) {
      TextUserFieldDeclElement userVariableElement =
          (TextUserFieldDeclElement) userVariableElements.getFirstChild();
