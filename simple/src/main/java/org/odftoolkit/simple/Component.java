...
public abstract class Component {
   ...
   * @param element the instance of OdfElement which presents this component.
  ...
  /**
   * Get the component instance by the element instance. Return null if there is no such element
   * registered.
   *
   * @param element the instance of OdfElement which presents this component.
