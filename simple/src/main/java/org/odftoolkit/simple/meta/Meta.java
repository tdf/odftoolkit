...
public class Meta {
  ...
  public Meta(OdfFileDom metaDom) {
    OfficeDocumentMetaElement metaEle =
        OdfElement.findFirstChildNode(OfficeDocumentMetaElement.class, metaDom);
  ...
  /**
   * Receives the value of the odf dom element representation <code>MetaGeneratorElement</code>.
   *
  ...
  public String getGenerator() {
    MetaGeneratorElement metaGenerator =
        OdfElement.findFirstChildNode(MetaGeneratorElement.class, mOfficeMetaElement);
  ...
  /**
   * Sets the value of the odf dom element representation <code>MetaGeneratorElement</code>.
   *
  ...
  /**
   * Receives the value of the odf dom element representation <code>DcTitleElement</code>.
   *
  ...
  public String getTitle() {
    ...
    DcTitleElement titleEle =
        OdfElement.findFirstChildNode(DcTitleElement.class, mOfficeMetaElement);
    if (titleEle != null) {
  ...
  /**
   * Sets the value of the odf dom element representation <code>DcTitleElement</code>.
   *
  ...
  /**
   * Receives the value of the odf dom element representation <code>DcDescriptionElement</code>.
   *
  ...
  public String getDescription() {
    DcDescriptionElement descEle =
        OdfElement.findFirstChildNode(DcDescriptionElement.class, mOfficeMetaElement);
    if (descEle != null) {
  ...
  /**
   * Sets the value of the odf dom element representation <code>DcDescriptionElement</code>.
   *
  ...
  /**
   * Receives the value of the odf dom element representation <code>DcSubjectElement</code>.
   *
  ...
  public String getSubject() {
    DcSubjectElement subjectEle =
        OdfElement.findFirstChildNode(DcSubjectElement.class, mOfficeMetaElement);
    if (subjectEle != null) {
  ...
  /**
   * Sets the value of the odf dom element representation <code>DcSubjectElement</code>.
   *
  ...
  /**
   * Receives the list value of the odf dom element representation <code>MetaKeywordElement</code>.
   *
  ...
  public List<String> getKeywords() {
    ...
    if (keywordEle != null) {
      ...
      while ((keywordNext = OdfElement.findNextChildNode(MetaKeywordElement.class, keywordEle))
          != null) {
  ...
  /**
   * Sets the list value of the odf dom element representation <code>MetaKeywordElement</code>.
   *
  ...
  public void setKeywords(List<String> keyList) {
    ...
    if (keywordEle != null) {
      ...
      while ((keywordTmp = OdfElement.findNextChildNode(MetaKeywordElement.class, keywordEle))
          != null) {
  ...
  /**
   * Add the keyword to the current document. Create child element <code>MetaKeywordElement</code>.
   *
  ...
  /**
   * Receives the list value of the odf dom element representation <code>MetaUserDefinedElement
   * </code>.
   *
  ...
  public List<String> getUserDefinedDataNames() {
    ...
    if (definedEle != null) {
      ...
      while ((definedNext = OdfElement.findNextChildNode(MetaUserDefinedElement.class, definedEle))
          != null) {
  ...
  /**
   * Receives the odf dom element representation <code>MetaUserDefinedElement</code> by attribute
   * name.
   *
  ...
  /**
   * Receives the value of the odf dom element representation <code>MetaUserDefinedElement</code> by
   * attribute name.
   *
   * @param name the name of the user-defined metadata
  ...
  /**
   * Receives the data type of the odf dom element representation <code>MetaUserDefinedElement
   * </code> by attribute name.
   *
   * @param name the name of the user-defined metadata
  ...
  /**
   * Remove the odf dom element representation <code>MetaUserDefinedElement</code> by attribute
   * name.
   *
   * @param name the name of the user-defined metadata
   * @see org.odftoolkit.odfdom.dom.element.meta.MetaUserDefinedElement.
  ...
  /**
   * Sets the value of the odf dom element representation <code>MetaUserDefinedElement</code> by
   * attribute name.
   *
  ...
  /**
   * Sets the data type of the odf dom element representation <code>MetaUserDefinedElement</code> by
   * attribute name.
   *
   * @param name the name need to set for the user-defined metadata
   * @param value the value need to set for the user-defined metadata
  ...
  /**
   * Sets the odf dom element representation <code>MetaUserDefinedElement</code>, if the element
  ...
  public void setUserDefinedData(String name, String type, String value) {
    ...
    if (definedElement != null) {
      ...
      // if not exists, add
      definedElement = mOfficeMetaElement.newMetaUserDefinedElement(name, type);
      definedElement.setTextContent(value);
    }
  }

  /**
   * Receives the value of the odf dom element representation <code>MetaInitialCreatorElement</code>
   * .
   *
  ...
  public String getInitialCreator() {
    MetaInitialCreatorElement iniCreatorEle =
        OdfElement.findFirstChildNode(MetaInitialCreatorElement.class, mOfficeMetaElement);
  ...
  /**
   * Sets the value of the odf dom element representation <code>MetaInitialCreatorElement</code>.
   *
  ...
  /**
   * Receives the value of the odf dom element representation <code>DcCreatorElement</code>.
   *
  ...
  public String getCreator() {
    DcCreatorElement creatorEle =
        OdfElement.findFirstChildNode(DcCreatorElement.class, mOfficeMetaElement);
    if (creatorEle != null) {
  ...
  /**
   * Sets the value of the odf dom element representation <code>DcCreatorElement</code>.
   *
  ...
  /**
   * Receives the value of the odf dom element representation <code>MetaPrintedByElement</code>
   *
  ...
  public String getPrintedBy() {
    MetaPrintedByElement printedByEle =
        OdfElement.findFirstChildNode(MetaPrintedByElement.class, mOfficeMetaElement);
  ...
  /**
   * Sets the value of the odf dom element representation <code>MetaPrintedByElement</code>.
   *
  ...
  /**
   * Receives the value of the odf dom element representation <code>MetaCreationDateElement</code>
   *
  ...
  /**
   * Sets the value of the odf dom element representation <code>MetaCreationDateElement</code> .
   *
  ...
  /**
   * Receives the value of the odf dom element representation <code>DcDateElement</code>.
   *
  ...
  /**
   * Sets the value of the odf dom element representation <code>DcDateElement</code>.
   *
  ...
  /**
   * Receives the value of the odf dom element representation <code>MetaPrintDateElement</code>.
   *
  ...
  /**
   * Sets the value of the odf dom element representation <code>MetaPrintDateElement</code>.
   *
  ...
  /**
   * Receives the value of the odf dom element representation <code>DcLanguageElement</code>.
   *
  ...
  public String getLanguage() {
    DcLanguageElement languageEle =
        OdfElement.findFirstChildNode(DcLanguageElement.class, mOfficeMetaElement);
    if (languageEle != null) {
  ...
  /**
   * Sets the value of the odf dom element representation <code>DcLanguageElement</code>.
   *
  ...
  /**
   * Receives the value of the odf dom element representation <code>MetaEditingCyclesElement</code>
   * .
   *
  ...
  public Integer getEditingCycles() {
    MetaEditingCyclesElement editingCyclesEle =
        OdfElement.findFirstChildNode(MetaEditingCyclesElement.class, mOfficeMetaElement);
  ...
  /**
   * Sets the value of the odf dom element representation <code>MetaEditingCyclesElement</code> .
   *
  ...
  /**
   * Receives the value of the odf dom element representation <code>MetaEditingDurationElement
   * </code>.
   *
  ...
  public Duration getEditingDuration() {
    MetaEditingDurationElement editiingDurationEle =
        OdfElement.findFirstChildNode(MetaEditingDurationElement.class, mOfficeMetaElement);
  ...
  /**
   * Sets the value of the odf dom element representation <code>MetaEditingDurationElement</code>.
   *
   ...
   *
   * @return the statistics about the document which can be represented by <code>DocumentStatistic
   *     </code> feature;
  ...
  private MetaDocumentStatisticElement getDocumentStatisticElement() {
    return OdfElement.findFirstChildNode(MetaDocumentStatisticElement.class, mOfficeMetaElement);
  }
