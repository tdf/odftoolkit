 ...
 *
 * <p>Row provides methods to get table cells that belong to this table row.
 */
public class Row extends Component {
   ...
   *
   * <p>Each <code>TableTableRowElement</code> instance has a one-to-one relationship to a <code>Row
   * </code> instance.
   *
   ...
   *
   * <ul>
   *   <li>true sets to keep always together
   *   <li>false sets to keep together auto
   * </ul>
   *
   * @param keepTogether
   */
  public void setKeepTogether(boolean keepTogether) {
    maRowElement.setProperty(
        ...
        keepTogether
            ? FoKeepTogetherAttribute.Value.ALWAYS.toString()
            : FoKeepTogetherAttribute.Value.AUTO.toString());
  }
  ...
  public void setHeight(double height, boolean isMinHeight) {
    ...
    OdfStyleProperty rowHeightProp =
        isMinHeight ? OdfTableRowProperties.MinRowHeight : OdfTableRowProperties.RowHeight;
    // TODO:need refactor to PositiveLength.
    double inValue =
        Math.round(roundingFactor * height / Unit.INCH.unitInMillimiter()) / roundingFactor;
  ...
  void splitRepeatedRows() {
    ...
    if (repeateNum > 1) {
      ...
      List<TableTableCellElementBase> newBeforeCellElements =
          new ArrayList<TableTableCellElementBase>();
      List<TableTableCellElementBase> newCurrentCellElements =
          new ArrayList<TableTableCellElementBase>();
      List<TableTableCellElementBase> newAfterCellElements =
          new ArrayList<TableTableCellElementBase>();
  ...
  public OdfStyle getDefaultCellStyle() {
    ...
    OdfStyle style =
        maRowElement.getAutomaticStyles().getStyle(styleName, OdfStyleFamily.TableCell);
    ...
    for (int i = 0; i < table.getColumnCount(); ) {
      ...
      if (cell == null) {
        ...
        if (cell.isCoveredElement()) {
          ...
          if (coverCell != null) {
            coverCell.setRowSpannedNumber(
                coverCell.getRowSpannedNumber() - getRowsRepeatedNumber());
          }
