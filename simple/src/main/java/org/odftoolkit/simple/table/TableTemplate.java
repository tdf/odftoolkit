 ...
 *
 * <p>Besides the seven types of style (first row, first column, last row, last column, even/odd
 * rows,even/odd columns and body) defined by <code>table:table-template</code> in ODF 1.2,
 ...
 *
 * <p>TableTemplate provide method to get/set a set of references to table cell styles that specify
 * the formatting to be used on a table.
 */
public class TableTemplate {
   ...
   *
   * <p>Null will be returned if there is no table template name setting.
   *
   ...
   *
   * <p>If the parameter <code>tableNameValue</code> is null, the table template name definition
   * will be removed.
   *
   * @param tableNameValue - the table template name
   */
   ...
   * <p>Null will be returned if there is no such extended style type setting.
   *
   * @param type - extended style type
   * @return the style name referenced by this style type
   */
  public String getExtendedParagraphStyleByType(ExtendedStyleType type) {
    if (extendedParagraphStyleMap == null) return null;
   ...
   *
   * @param type - extended style type
   * @param tableStyle - table style name
   * @param paraStyle - paragraph style name
   */
  public void setExtendedStyleByType(ExtendedStyleType type, String tableStyle, String paraStyle) {
    ...
    if (extendedParagraphStyleMap == null) {
      extendedParagraphStyleMap = new HashMap<ExtendedStyleType, String>(5);
    }
   ...
   *
   * <p>Null will be returned if there is no such style setting.
   *
   * @return the style name referenced by table style of body.
   */
  public String getTableBodyTableStyle() {
    NodeList elements = mElement.getElementsByTagName(TableBodyElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      return ((TableBodyElement) elements.item(0)).getTableStyleNameAttribute();
    }
    return null;
  }
  ...
  public String getTableBodyParagraphStyle() {
    NodeList elements = mElement.getElementsByTagName(TableBodyElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      return ((TableBodyElement) elements.item(0)).getTableParagraphStyleNameAttribute();
    }
    return null;
  }
  ...
  public String getTableEvenColumnsTableStyle() {
    NodeList elements =
        mElement.getElementsByTagName(TableEvenColumnsElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      return ((TableEvenColumnsElement) elements.item(0)).getTableStyleNameAttribute();
    }
    return null;
  }
  ...
  public String getTableEvenRowsTableStyle() {
    NodeList elements = mElement.getElementsByTagName(TableEvenRowsElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      return ((TableEvenRowsElement) elements.item(0)).getTableStyleNameAttribute();
    }
    return null;
  }
  ...
  public String getTableEvenRowsParagraphStyle() {
    NodeList elements = mElement.getElementsByTagName(TableEvenRowsElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      return ((TableEvenRowsElement) elements.item(0)).getTableParagraphStyleNameAttribute();
    }
    return null;
  }
  ...
  public String getTableFirstColumnTableStyle() {
    NodeList elements =
        mElement.getElementsByTagName(TableFirstColumnElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      return ((TableFirstColumnElement) elements.item(0)).getTableStyleNameAttribute();
    }
    return null;
  }
  ...
  public String getTableFirstColumnParagraphStyle() {
    NodeList elements =
        mElement.getElementsByTagName(TableFirstColumnElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      return ((TableFirstColumnElement) elements.item(0)).getTableParagraphStyleNameAttribute();
    }
    return null;
  }
  ...
  public String getTableFirstRowTableStyle() {
    NodeList elements = mElement.getElementsByTagName(TableFirstRowElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      return ((TableFirstRowElement) elements.item(0)).getTableStyleNameAttribute();
    }
    return null;
  }
  ...
  public String getTableFirstRowParagraphStyle() {
    NodeList elements = mElement.getElementsByTagName(TableFirstRowElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      return ((TableFirstRowElement) elements.item(0)).getTableParagraphStyleNameAttribute();
    }
    return null;
  }
  ...
  public String getTableLastColumnTableStyle() {
    NodeList elements =
        mElement.getElementsByTagName(TableLastColumnElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      return ((TableLastColumnElement) elements.item(0)).getTableStyleNameAttribute();
    }
    return null;
  }
  ...
  public String getTableLastColumnParagraphStyle() {
    NodeList elements =
        mElement.getElementsByTagName(TableLastColumnElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      return ((TableLastColumnElement) elements.item(0)).getTableParagraphStyleNameAttribute();
    }
    return null;
  }
  ...
  public String getTableLastRowTableStyle() {
    NodeList elements = mElement.getElementsByTagName(TableLastRowElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      return ((TableLastRowElement) elements.item(0)).getTableStyleNameAttribute();
    }
    return null;
  }
  ...
  public String getTableLastRowParagraphStyle() {
    NodeList elements = mElement.getElementsByTagName(TableLastRowElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      return ((TableLastRowElement) elements.item(0)).getTableParagraphStyleNameAttribute();
    }
    return null;
  }
  ...
  public String getTableOddColumnsTableStyle() {
    NodeList elements =
        mElement.getElementsByTagName(TableOddColumnsElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      return ((TableOddColumnsElement) elements.item(0)).getTableStyleNameAttribute();
    }
    return null;
  }
  ...
  public String getTableOddColumnsParagraphStyle() {
    NodeList elements =
        mElement.getElementsByTagName(TableOddColumnsElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      return ((TableOddColumnsElement) elements.item(0)).getTableParagraphStyleNameAttribute();
    }
    return null;
  }
  ...
  public String getTableOddRowsTableStyle() {
    NodeList elements = mElement.getElementsByTagName(TableOddRowsElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      return ((TableOddRowsElement) elements.item(0)).getTableStyleNameAttribute();
    }
    return null;
  }
  ...
  public String getTableOddRowsParagraphStyle() {
    NodeList elements = mElement.getElementsByTagName(TableOddRowsElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      return ((TableOddRowsElement) elements.item(0)).getTableParagraphStyleNameAttribute();
    }
    return null;
  }
   ...
   *
   * <p>If the parameter <code>tableStyleNameValue</code> is null, the table style name definition
   * in body will be removed. If the parameter <code>tableParagraphStyleNameValue</code> is null,
   * the paragraph style name definition in body will be removed.
   *
   * @param tableStyleNameValue - table style name referenced by body
   * @param tableParagraphStyleNameValue - paragraph style name referenced by body
   */
  public void setTableBodyStyle(String tableStyleNameValue, String tableParagraphStyleNameValue) {
    ...
    if (elements != null && elements.getLength() > 0) {
      ...
      ele.setTableParagraphStyleNameAttribute(tableParagraphStyleNameValue);
    } else {
      TableBodyElement ele = mElement.newTableBodyElement(tableStyleNameValue);
      ele.setTableParagraphStyleNameAttribute(tableParagraphStyleNameValue);
    }
  }
   ...
   *
   * <p>If the parameter <code>tableStyleNameValue</code> is null, the table style name definition
   * in even columns will be removed. If the parameter <code>tableParagraphStyleNameValue</code> is
   * null, the paragraph style name definition in even columns will be removed.
   *
   * @param tableStyleNameValue - table style name referenced by even columns
   * @param tableParagraphStyleNameValue - paragraph style name referenced by even columns
   */
  public void setTableEvenColumnsStyle(
      String tableStyleNameValue, String tableParagraphStyleNameValue) {
    NodeList elements =
        mElement.getElementsByTagName(TableEvenColumnsElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      TableEvenColumnsElement ele = (TableEvenColumnsElement) elements.item(0);
      ele.setTableStyleNameAttribute(tableStyleNameValue);
      ele.setTableParagraphStyleNameAttribute(tableParagraphStyleNameValue);
    } else {
      TableEvenColumnsElement ele = mElement.newTableEvenColumnsElement(tableStyleNameValue);
      ele.setTableParagraphStyleNameAttribute(tableParagraphStyleNameValue);
    }
  }
   ...
   *
   * <p>If the parameter <code>tableStyleNameValue</code> is null, the table style name definition
   * in even rows will be removed. If the parameter <code>tableParagraphStyleNameValue</code> is
   * null, the paragraph style name definition in even rows will be removed.
   *
   * @param tableStyleNameValue - table style name referenced by even rows
   * @param tableParagraphStyleNameValue - paragraph style name referenced by even rows
   */
  public void setTableEvenRowsStyle(
      String tableStyleNameValue, String tableParagraphStyleNameValue) {
    NodeList elements = mElement.getElementsByTagName(TableEvenRowsElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      ...
      TableEvenRowsElement ele = mElement.newTableEvenRowsElement(tableStyleNameValue);
      ele.setTableParagraphStyleNameAttribute(tableParagraphStyleNameValue);
    }
  }
   ...
   *
   * <p>If the parameter <code>tableStyleNameValue</code> is null, the table style name definition
   * in first column will be removed. If the parameter <code>tableParagraphStyleNameValue</code> is
   * null, the paragraph style name definition in first column will be removed.
   *
   * @param tableStyleNameValue - table style name referenced by first column
   * @param tableParagraphStyleNameValue - paragraph style name referenced by first column
   */
  public void setTableFirstColumnStyle(
      String tableStyleNameValue, String tableParagraphStyleNameValue) {
    NodeList elements =
        mElement.getElementsByTagName(TableFirstColumnElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      TableFirstColumnElement ele = (TableFirstColumnElement) elements.item(0);
      ele.setTableStyleNameAttribute(tableStyleNameValue);
      ele.setTableParagraphStyleNameAttribute(tableParagraphStyleNameValue);
    } else {
      TableFirstColumnElement ele = mElement.newTableFirstColumnElement(tableStyleNameValue);
      ele.setTableParagraphStyleNameAttribute(tableParagraphStyleNameValue);
    }
  }
   ...
   *
   * <p>If the parameter <code>tableStyleNameValue</code> is null, the table style name definition
   * in first row will be removed. If the parameter <code>tableParagraphStyleNameValue</code> is
   * null, the paragraph style name definition in first row will be removed.
   *
   * @param tableStyleNameValue - table style name referenced by first row
   * @param tableParagraphStyleNameValue - paragraph style name referenced by first row
   */
  public void setTableFirstRowStyle(
      String tableStyleNameValue, String tableParagraphStyleNameValue) {
    NodeList elements = mElement.getElementsByTagName(TableFirstRowElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      ...
      TableFirstRowElement ele = mElement.newTableFirstRowElement(tableStyleNameValue);
      ele.setTableParagraphStyleNameAttribute(tableParagraphStyleNameValue);
    }
  }
   ...
   *
   * <p>If the parameter <code>tableStyleNameValue</code> is null, the table style name definition
   * in last column will be removed. If the parameter <code>tableParagraphStyleNameValue</code> is
   * null, the paragraph style name definition in last column will be removed.
   *
   * @param tableStyleNameValue - table style name referenced by last column
   * @param tableParagraphStyleNameValue - paragraph style name referenced by last column
   */
  public void setTableLastColumnStyle(
      String tableStyleNameValue, String tableParagraphStyleNameValue) {
    NodeList elements =
        mElement.getElementsByTagName(TableLastColumnElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      TableLastColumnElement ele = (TableLastColumnElement) elements.item(0);
      ele.setTableStyleNameAttribute(tableStyleNameValue);
      ele.setTableParagraphStyleNameAttribute(tableParagraphStyleNameValue);
    } else {
      TableLastColumnElement ele = mElement.newTableLastColumnElement(tableStyleNameValue);
      ele.setTableParagraphStyleNameAttribute(tableParagraphStyleNameValue);
    }
  }
   ...
   *
   * <p>If the parameter <code>tableStyleNameValue</code> is null, the table style name definition
   * in last row will be removed. If the parameter <code>tableParagraphStyleNameValue</code> is
   * null, the paragraph style name definition in last row will be removed.
   *
   * @param tableStyleNameValue - table style name referenced by last row
   * @param tableParagraphStyleNameValue - paragraph style name referenced by last row
   */
  public void setTableLastRowStyle(
      String tableStyleNameValue, String tableParagraphStyleNameValue) {
    NodeList elements = mElement.getElementsByTagName(TableLastRowElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      ...
      TableLastRowElement ele = mElement.newTableLastRowElement(tableStyleNameValue);
      ele.setTableParagraphStyleNameAttribute(tableParagraphStyleNameValue);
    }
  }
   ...
   *
   * <p>If the parameter <code>tableStyleNameValue</code> is null, the table style name definition
   * in odd columns will be removed. If the parameter <code>tableParagraphStyleNameValue</code> is
   * null, the paragraph style name definition in odd columns will be removed.
   *
   * @param tableStyleNameValue - table style name referenced by odd columns
   * @param tableParagraphStyleNameValue - paragraph style name referenced by odd columns
   */
  public void setTableOddColumnsStyle(
      String tableStyleNameValue, String tableParagraphStyleNameValue) {
    NodeList elements =
        mElement.getElementsByTagName(TableOddColumnsElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      TableOddColumnsElement ele = (TableOddColumnsElement) elements.item(0);
      ele.setTableStyleNameAttribute(tableStyleNameValue);
      ele.setTableParagraphStyleNameAttribute(tableParagraphStyleNameValue);
    } else {
      TableOddColumnsElement ele = mElement.newTableOddColumnsElement(tableStyleNameValue);
      ele.setTableParagraphStyleNameAttribute(tableParagraphStyleNameValue);
    }
  }
   ...
   *
   * <p>If the parameter <code>tableStyleNameValue</code> is null, the table style name definition
   * in odd rows will be removed. If the parameter <code>tableParagraphStyleNameValue</code> is
   * null, the paragraph style name definition in odd rows will be removed.
   *
   * @param tableStyleNameValue - table style name referenced by odd rows
   * @param tableParagraphStyleNameValue - paragraph style name referenced by odd rows
   */
  public void setTableOddRowsStyle(
      String tableStyleNameValue, String tableParagraphStyleNameValue) {
    NodeList elements = mElement.getElementsByTagName(TableOddRowsElement.ELEMENT_NAME.getQName());
    if (elements != null && elements.getLength() > 0) {
      ...
      TableOddRowsElement ele = mElement.newTableOddRowsElement(tableStyleNameValue);
      ele.setTableParagraphStyleNameAttribute(tableParagraphStyleNameValue);
    }
  }
}
