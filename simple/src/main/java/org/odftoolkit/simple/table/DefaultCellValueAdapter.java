...
/**
 * This is a default realization of {@link CellValueAdapter CellValueAdapter}. It will adapt cell
 * string content as common rule.
 *
  ...
  public void adaptValue(Cell cell, String value) {
    ...
    if ("boolean".equals(type)) {
      ...
      if ("true".equalsIgnoreCase(value)) {
        ...
        // adapt time
        String[] timeFormats = {
          "MM/dd/yyyy HH:mm:ss", "yyyy-MM-dd HH:mm:ss", "HH:mm:ss", "HH:mm a", "HH:mm"
        };
