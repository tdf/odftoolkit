...
/**
 * AbstractTableContainer is an abstract implementation of the TableContainer interface, with a
 * default implementation for every method defined in TableContainer , except
 * getTableContainerElement(). Each subclass must implement the abstract method
...
public abstract class AbstractTableContainer implements TableContainer {
  ...
  public Table getTableByName(String name) {
    try {
      ...
      NodeList nodeList =
          containerEle.getElementsByTagName(TableTableElement.ELEMENT_NAME.getQName());
  ...
  /**
   * Return the table builder of this container. Every container has a table builder, which supplies
   * all of the table creation realization, for example newTable().
   *
