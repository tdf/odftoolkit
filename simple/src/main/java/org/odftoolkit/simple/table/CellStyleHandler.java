 ...
 *
 * <p>This class provides functions to handle the border settings, font settings, text alignment
 * settings and so on.
 *
 * @since 0.3
 */
public class CellStyleHandler extends DefaultStyleHandler {
   ...
   *
   * <p>The country information in its parent style and default style will be taken into considered.
   *
   ...
   *
   * <p>The font definition in its parent style and default style will be taken into considered.
   *
   * <p>A default font definition will be returned if there is no font definition for this script
   * type at all.
   *
   * @param type - script type
   * @return the font definition for a specific script type
   ...
   *
   * <p>The language definition in its parent style and default style will be taken into considered.
   *
   * <p>Null will be returned if there is no language information for this script type at all.
   *
   * @param type - script type
   * @return the language information for a specific script type
   */
  ...
  /**
   * Set the font definition. The locale information in font definition will be used to justify the
   * script type.
   *
   ...
   *
   * <p>Color WHITE will be returned if there is no the background color definition or the
   * background color definition is not valid.
   *
   * @return the background color
   */
  public Color getBackgroundColor() {
    ...
    if (!isDefault) {
      OdfDefaultStyle defaultStyle = getCellDefaultStyle();
      TableCellProperties defaultStyleSetting =
          TableCellProperties.getTableCellProperties(defaultStyle);
   ...
   *
   * <p>The accepted parameter can be TOP,BOTTOM,LEFT,RIGHT,DIAGONALBLTR and DIAGONALTLBR.
   *
   * <p>The border type with a collection of borders, e.g. ALL_FOUR, LEFT_RIGHT, are not legal
   * arguments
   *
   * <p>The border definition in its parent style and default style will be taken into considered.
   *
   * <p><code>Border.NONE</code> will be returned if there is no the border definition for a
   * specific border.
   *
   ...
   *
   * <p>If there is no vertical alignment definition, DEFAULT will be returned.
   *
   * <p>The vertical alignment definition in its parent style and default style will be taken into
   * considered.
   *
   * @return the vertical alignment
   */
   ...
   *
   * <p>The wrap option definition in its parent style and default style will be taken into
   * considered.
   *
   * @return <code>true</code> if the cell content can be wrapped;
   *     <p><code>false</code> if the cell content cannot be wrapped.
   */
   ...
   *
   * @param color - the background color that need to set. If <code>color</code> is null, background
   *     color setting will be removed.
   */
  ...
  /**
   * Set the border style of this cell. You can set the border style for a single border or a border
   * collection.
   *
   * <p>The second parameter <code>bordersType</code> describes which borders you want to apply the
   ...
   * removed.
   *
   * @param alignType - the vertical alignment setting.
   */
   ...
   *
   * @param isWrapped - whether the cell content can be wrapped or not
   */
