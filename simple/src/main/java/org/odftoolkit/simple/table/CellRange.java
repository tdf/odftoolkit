 ...
 *
 * <p>CellRange provides methods to get/set/modify the properties of cell range.
 */
public class CellRange {
  ...
  CellRange(Table table, int startColumn, int startRow, int endColumn, int endRow) {
    ...
    Document doc =
        (Document) ((OdfFileDom) maOwnerTable.getOdfElement().getOwnerDocument()).getDocument();
