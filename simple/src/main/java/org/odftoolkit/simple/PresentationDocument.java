...
public class PresentationDocument extends Document {
	 ...
	 * read access needed by PresentationDocument, the InputStream is cached. This usually
	 ...
	 *
	 * <p>PresentationDocument relies on the file being available for read access over
	 * the whole lifecycle of PresentationDocument.</p>
	 *
	 * <p>If the resource stream is not a ODF presentation document, ClassCastException might be thrown.</p>
	 * 
...
//	private HashMap<String, String> objectRenameMap = new HashMap<String, String>();
	 ...
	 * @param srcDoc	the specified <code>PresentationDocument</code> that need to be appended
	 */
	...
	public Slide copyForeignSlide(int destIndex,
			PresentationDocument srcDoc, int srcIndex) {
		checkAllSlideName();
		OfficePresentationElement contentRoot = null;
		OdfFileDom contentDom = null;
		try {
