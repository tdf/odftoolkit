...
/**
 * This class represents the table cell style settings. It provides methods to access borders
 * styles. More functions will be added latter.
 *
 * <p>This class is a corresponded high level class for element "style:table-cell-properties". It
 * provides methods to access the attributes and children of "style:table-cell-properties".
 *
 * @since 0.3
 */
public class TableCellProperties {
   ...
   *
   * @param properties - the element of style:table-cell-properties
   */
   ...
   *
   * <p>Null will be returned if there is no border setting for the diagonal from bottom left to top
   * right.
   *
   * @return the border setting
   */
  public Border getDiagonalBlTr() {
    ...
    if (borderAttr == null || borderAttr.length() == 0) return null;
   ...
   *
   * <p>Null will be returned if there is no border setting for the diagonal from top left to bottom
   * right.
   *
   * @return the border setting
   */
   ...
   *
   * <p>If the parameter <code>border</code> is null, the border definition for the diagonal from
   * bottom left to top right will be removed.
   *
   * <p>If the line type in the border definition is NONE, the border definition for the diagonal
   * from bottom left to top right will be removed.
   *
   * @param border - the border setting
   */
   ...
   *
   * <p>If the parameter <code>border</code> is null, the border definition for the diagonal from
   * top left to bottom right will be removed.
   *
   * <p>If the line type in the border definition is NONE, the border definition for the diagonal
   * from top left to bottom right will be removed.
   *
   * @param border - the border setting
   */
   ...
   *
   * <p>If the parameter <code>aColor</code> is null, the background color definition will be
   * removed.
   *
   ...
   *
   * <p>Null will be returned if there is no the background color definition or the background color
   ...
   *
   * <p>If the parameter <code>isWrapped</code> is true, the text will be allowed to be wrapped. Or
   * else, the text is not allowed to be wrapped.
   *
   * @param isWrapped - the wrapped option
   */
   ...
   *
   * <p>If the parameter <code>alignType</code> is null or DEFAULT, the vertical alignment
   * definition will be removed.
   *
   * @param alignType - the vertical alignment
   */
  public void setVerticalAlignment(StyleTypeDefinitions.VerticalAlignmentType alignType) {
    ...
    else mElement.setStyleVerticalAlignAttribute(alignType.toString());
  }
   ...
   *
   * <p>If there is no vertical alignment definition, null will be returned.
   *
   * @return the vertical alignment
   */
  public StyleTypeDefinitions.VerticalAlignmentType getVerticalAlignment() {
    ...
    if ((alignType == null) || (alignType.length() == 0)) return null;

    StyleVerticalAlignAttribute.Value value =
        StyleVerticalAlignAttribute.Value.enumValueOf(alignType);
   ...
   *
   * <p>Return true if the text is allowed to be wrapped. Or else, return false.
   *
   * @return a boolean value to indicate whether the text is allowed to be wrapped
   */
  ...
  public static TableCellProperties getTableCellProperties(OdfStyleBase style) {
    OdfStylePropertiesBase properties =
        style.getPropertiesElement(OdfStylePropertiesSet.TableCellProperties);
    if (properties != null)
      return new TableCellProperties((StyleTableCellPropertiesElement) properties);
    else return null;
  }
...
class BorderPropertiesImpl {
  ...
  public void setBottomBorder(Border border) {
    if (border == null) {
      borderPropertiesElement.removeAttribute(
          StyleBorderLineWidthBottomAttribute.ATTRIBUTE_NAME.getQName());
      borderPropertiesElement.removeAttribute(FoBorderBottomAttribute.ATTRIBUTE_NAME.getQName());
      return;
    }
    switch (border.lineStyle) {
      case DOUBLE:
        borderPropertiesElement.setAttributeNS(
            OdfDocumentNamespace.STYLE.getUri(),
            "style:border-line-width-bottom",
            border.getDoubleLineWidthDescription());
        borderPropertiesElement.setAttributeNS(
            OdfDocumentNamespace.FO.getUri(), "fo:border-bottom", border.getBorderDescription());
        break;
      case SINGLE:
        borderPropertiesElement.setAttributeNS(
            OdfDocumentNamespace.FO.getUri(), "fo:border-bottom", border.getBorderDescription());
  ...
  public void setTopBorder(Border border) {
    if (border == null) {
      borderPropertiesElement.removeAttribute(
          StyleBorderLineWidthTopAttribute.ATTRIBUTE_NAME.getQName());
    ...
    switch (border.lineStyle) {
      case DOUBLE:
        borderPropertiesElement.setAttributeNS(
            ...
            border.getDoubleLineWidthDescription());
        borderPropertiesElement.setAttributeNS(
            OdfDocumentNamespace.FO.getUri(), "fo:border-top", border.getBorderDescription());
        break;
      case SINGLE:
        borderPropertiesElement.setAttributeNS(
            OdfDocumentNamespace.FO.getUri(), "fo:border-top", border.getBorderDescription());
  ...
  public void setLeftBorder(Border border) {
    if (border == null) {
      borderPropertiesElement.removeAttribute(
          StyleBorderLineWidthLeftAttribute.ATTRIBUTE_NAME.getQName());
    ...
    switch (border.lineStyle) {
      case DOUBLE:
        borderPropertiesElement.setAttributeNS(
            ...
            border.getDoubleLineWidthDescription());
        borderPropertiesElement.setAttributeNS(
            OdfDocumentNamespace.FO.getUri(), "fo:border-left", border.getBorderDescription());
        break;
      case SINGLE:
        borderPropertiesElement.setAttributeNS(
            OdfDocumentNamespace.FO.getUri(), "fo:border-left", border.getBorderDescription());
  ...
  public void setRightBorder(Border border) {
    if (border == null) {
      borderPropertiesElement.removeAttribute(
          StyleBorderLineWidthRightAttribute.ATTRIBUTE_NAME.getQName());
    ...
    switch (border.lineStyle) {
      case DOUBLE:
        borderPropertiesElement.setAttributeNS(
            ...
            border.getDoubleLineWidthDescription());
        borderPropertiesElement.setAttributeNS(
            OdfDocumentNamespace.FO.getUri(), "fo:border-right", border.getBorderDescription());
        break;
      case SINGLE:
        borderPropertiesElement.setAttributeNS(
            OdfDocumentNamespace.FO.getUri(), "fo:border-right", border.getBorderDescription());
  ...
  public void setBorder(Border border) {
    if (border == null) {
      borderPropertiesElement.removeAttribute(
          StyleBorderLineWidthAttribute.ATTRIBUTE_NAME.getQName());
    ...
    switch (border.lineStyle) {
      case DOUBLE:
        borderPropertiesElement.setAttributeNS(
            ...
            border.getDoubleLineWidthDescription());
        borderPropertiesElement.setAttributeNS(
            OdfDocumentNamespace.FO.getUri(), "fo:border", border.getBorderDescription());
        break;
      case SINGLE:
        borderPropertiesElement.setAttributeNS(
            OdfDocumentNamespace.FO.getUri(), "fo:border", border.getBorderDescription());
  ...
  public Border getBorder() {
    Border border = new Border();
    String borderAttr =
        borderPropertiesElement.getAttributeNS(OdfDocumentNamespace.FO.getUri(), "border");
    String borderWidth =
        borderPropertiesElement.getAttributeNS(
            OdfDocumentNamespace.STYLE.getUri(), "border-line-width");
  ...
  public Border getTopBorder() {
    Border border = new Border();
    String borderAttr =
        borderPropertiesElement.getAttributeNS(OdfDocumentNamespace.FO.getUri(), "border-top");
    String borderWidth =
        borderPropertiesElement.getAttributeNS(
            OdfDocumentNamespace.STYLE.getUri(), "border-line-width-top");

    if (borderAttr == null || borderAttr.length() == 0) return getBorder();
  ...
  public Border getLeftBorder() {
    Border border = new Border();
    String borderAttr =
        borderPropertiesElement.getAttributeNS(OdfDocumentNamespace.FO.getUri(), "border-left");
    String borderWidth =
        borderPropertiesElement.getAttributeNS(
            OdfDocumentNamespace.STYLE.getUri(), "border-line-width-left");
  ...
  public Border getRightBorder() {
    Border border = new Border();
    String borderAttr =
        borderPropertiesElement.getAttributeNS(OdfDocumentNamespace.FO.getUri(), "border-right");
    String borderWidth =
        borderPropertiesElement.getAttributeNS(
            OdfDocumentNamespace.STYLE.getUri(), "border-line-width-right");
  ...
  public Border getBottomBorder() {
    Border border = new Border();
    String borderAttr =
        borderPropertiesElement.getAttributeNS(OdfDocumentNamespace.FO.getUri(), "border-bottom");
    String borderWidth =
        borderPropertiesElement.getAttributeNS(
            OdfDocumentNamespace.STYLE.getUri(), "border-line-width-bottom");
