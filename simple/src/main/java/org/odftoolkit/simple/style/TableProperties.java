...
/**
 * This class represents the table style settings. It provides methods to access or modify the
 * formatting properties applied to tables. More functions will be added latter.
 *
 * <p>This class is a corresponded high level class for element "style:table-properties". It
 * provides methods to access the attributes and children of "style:table-properties".
 *
 * @since 0.8
 */
public class TableProperties {
  ...
  /**
   * Create an instance of TableProperties from an element <style:table-properties>
   *
   * @param properties - the element of style:table-properties
   */
   ...
   * Set the break.
   *
   * @param breakPosition the position to insert a break (before or after)
   ...
   *
   * <p>Null will be returned if there is no break setting before the reference.
   *
   ...
   *
   * <p>Null will be returned if there is no break setting after the reference.
   *
   * @return - the break property; null if there is no break setting.
   */
   ...
   *
   * <p>If there is no valid page number, 0 will be returned;
   *
  ...
  public static TableProperties getTableProperties(OdfStyleBase style) {
    OdfStylePropertiesBase properties =
        style.getPropertiesElement(OdfStylePropertiesSet.TableProperties);
    if (properties != null) return new TableProperties((StyleTablePropertiesElement) properties);
    else return null;
  }
}
