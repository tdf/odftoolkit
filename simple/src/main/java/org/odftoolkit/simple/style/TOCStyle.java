...
public class TOCStyle {
  ...
  public void addStyle(String styleName, int level) {
    if ((level >= 1) && (level <= 10)) {
      ...
      Logger.getLogger(TOCStyle.class.getName())
          .log(
              Level.SEVERE,
              "Outline level:" + level + " is out of range[1,10] " + "TOCStyle.addStyle failed.");
  ...
  public String toString() {
    ...
    strBuilder.append(
        "The additional paragraph styles list that you want to include in the TOC.\n");
