...
public class Font {
  ...
  StyleTypeDefinitions.TextLinePosition
      textLinePosition; // style:text-line-through-style and style:text-underline-style
  // fo:font-weight
   ...
   *
   * @param fontFamilyName - the family name
   * @param simpleFontStyle - the font style
   * @param fontSize - the size
   */
  public Font(
      String fontFamilyName, StyleTypeDefinitions.FontStyle simpleFontStyle, double fontSize) {
   ...
   * @param simpleFontStyle - the font style
   * @param fontSize - the size
   * @param textLinePosition - the line position
   */
  public Font(
  ...
  /**
   * Create a font with specific family name, style, size for a specific character. For example, a
   * font style setting for English character.
   *
   * @param fontFamilyName - the family name
   * @param simpleFontStyle - the font style
   * @param fontSize - the font size
   * @param language - the character information
   */
  public Font(
      String fontFamilyName,
      StyleTypeDefinitions.FontStyle simpleFontStyle,
  ...
  /**
   * Create a font with specific family name, style, size, and color for a specific character. For
   * example, a font style setting for English character.
   *
   * @param fontFamilyName - the family name
   * @param simpleFontStyle - the font style
   * @param fontSize - the size
   ...
   * Set the font family.
   *
   * <p>Font family name is what you get from the font list in ODF editors.
   *
   ...
   *
   * <p>Note the font name might be different from font family name. A font family may have
   * different font name definitions.
   *
   * @return the font name
   */
   ...
   *
   * @param textLinePosition - the font text line position
   */
  ...
  public boolean equals(Object o) {
    if (o instanceof Font) {
      Font f = (Font) o;
      if (!this.getFamilyName().equals(f.getFamilyName())) return false;
      if (!(Math.abs(this.getSize() - f.getSize()) < 0.005)) return false;
      if (!(this.getFontStyle() == f.getFontStyle())) return false;
      ...
      if ((this.getColor() != null && f.getColor() == null)
          || (this.getColor() == null && f.getColor() != null)) return false;
      if ((this.getColor() != null && f.getColor() != null)
          && (!this.getColor().toString().equals(f.getColor().toString()))) return false;
      return true;
    }
    return false;
  }
