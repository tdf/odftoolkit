 ...
 *
 * <p>In Open Document Format, there can be different font settings for different script types.
 *
 * <p>This class provides methods to access font style, font size, font name and etc for different
 * script types.
 *
 * <p>Further functions will be provided, such as underline, shadow, background color and etc.
 *
 * <p>This class is a corresponded high level class for element "style:text-properties". It provides
 * methods to access the attributes and children of "style:text-properties".
 *
 * @since 0.3
 */
public class TextProperties {
  ...
  /**
   * Create an instance of TextProperties from an element <style:text-properties>
   *
   * @param textProperties - the element of style:text-properties
   */
   ...
   *
   * <p>Null will be returned if there is no font style setting for western characters
   *
  ...
  public StyleTypeDefinitions.FontStyle getFontStyle() {
    ...
    StyleTypeDefinitions.OdfFontStyle theFontType =
        StyleTypeDefinitions.OdfFontStyle.enumValueOf(fontstyle);
    StyleTypeDefinitions.OdfFontWeight theFontWeight =
        StyleTypeDefinitions.OdfFontWeight.enumValueOf(fontweight);
   ...
   *
   * <p>TextLineStyle.REGULAR will be returned if there is no text line style setting
   *
   * @return the font style
   */
   ...
   *
   * <p>REGULAR will be returned if there is no font style setting for this script type.
   *
   ...
   *
   * <p>If the parameter <code>style</code> is REGULAR, the font style setting for western
   ...
   *
   * <p>If the parameter <code>style</code> is REGULAR, the font text line style setting for
   * characters will be removed.
   *
   * @param style - the font text line style
   */
  public void setTextLineStyle(StyleTypeDefinitions.TextLinePosition style) {
    switch (style) {
      case THROUGH:
        mElement.setStyleTextLineThroughStyleAttribute(
            StyleTypeDefinitions.LineStyle.SOLID.toString());
        mElement.setStyleTextLineThroughColorAttribute("font-color");
        break;
      case UNDER:
        mElement.setStyleTextUnderlineStyleAttribute(
            StyleTypeDefinitions.LineStyle.SOLID.toString());
   ...
   *
   * <p>If the parameter <code>style</code> is REGULAR, the font style setting for this script type
   * will be removed.
   *
      ...
      case CJK:
        switch (style) {
          case BOLD:
            ...
            mElement.setStyleFontWeightAsianAttribute(
                StyleTypeDefinitions.OdfFontWeight.BOLD.toString());
            break;
          case ITALIC:
            mElement.setStyleFontStyleAsianAttribute(
                StyleTypeDefinitions.OdfFontStyle.ITALIC.toString());
      ...
      case CTL:
        switch (style) {
          case BOLD:
            ...
            mElement.setStyleFontWeightComplexAttribute(
                StyleTypeDefinitions.OdfFontWeight.BOLD.toString());
            break;
          case ITALIC:
            mElement.setStyleFontStyleComplexAttribute(
                StyleTypeDefinitions.OdfFontStyle.ITALIC.toString());
   ...
   *
   * <p>Zero will be returned if there is no font size definition for western characters.
   *
   * <p>Zero will be returned if the line measurement is not point(PT).
   *
   ...
   *
   * <p>Zero will be returned if there is no font size definition for this script type.
   *
   * <p>Zero will be returned if the line measurement is not point(PT).
   *
   * @param type - script type
   ...
   *
   * <p>If the font size is less than zero, the font size definition for western characters will be
   * removed.
   *
   ...
   *
   * <p>If the font size is less than zero, the font size definition for this script type will be
   * removed.
   *
   * @param size - font size
   * @param type - script type
   ...
   *
   * <p>Null will be returned if there is no language information for western characters.
   *
   * @return the language information for western characters.
   */
   ...
   *
   * <p>Null will be returned if there is no language information for this script type.
   *
   * @param type - script type
   * @return the language information for a specific script type
   */
   ...
   *
   * <p>If the parameter <code>language</code> is null, the language information for western
   * characters will be removed.
   *
   ...
   *
   * <p>The consistency between country and script type is not verified.
   *
   * <p>If the parameter <code>language</code> is null, the language information for this script
   ...
   *
   * <p>Null will be returned if there is no country information for western characters.
   *
   * @return the country information for western characters.
   */
   ...
   *
   * <p>Null will be returned if there is no country information for this script type.
   *
   * @param type - script type
   * @return the country information for a specific script type
   */
   ...
   *
   * <p>If the parameter <code>country</code> is null, the country information for western character
   * will be removed.
   *
   ...
   * <p>The consistency between country and script type is not verified.
   *
   * <p>If the parameter <code>country</code> is null, the country information for this script type
   * will be removed.
   *
   * @param country - the country information
   * @param type - script type
   ...
   *
   * <p>Null will be returned if there is no font color setting.
   *
   * @return the font color
   */
   ...
   * Set the font color.
   *
   * <p>If the parameter <code>fontColor</code> is null, the font color definition will be removed.
   *
   ...
   *
   * <p>Null will be returned if there is no font name setting for western characters.
   *
   * @return the font style for western characters
   */
   ...
   *
   * <p>Null will be returned if there is no font name setting for this script type.
   *
   * @param type - script type
   * @return the font name for a specific script type
   */
   ...
   *
   * <p>If the parameter <code>fontName</code> is null, the font name for western characters will be
   * removed.
   *
   ...
   *
   * <p>If the parameter <code>fontName</code> is null, the font name for this script type will be
   * removed.
   *
   * @param fontName - font name
   * @param type - script type
   ...
   *
   * <p>Null will be returned if there is no font definition for western characters.
   *
   * @return the font definition for western characters
   */
  public Font getFont() {
   ...
   *
   * <p>Null will be returned if there is no font definition for this script type.
   *
   * @param type - script type
   * @return the font definition for a specific script type
   */
   ...
   *
   * <p>This method can be used to set font for different script type, such as western characters,
   * CJK characters, and CTL characters. The second parameter will be used to determine the script
   * type.
   *
   * <p>If the parameter <code>font</code> is null, nothing will be happened.
   *
   ...
   *
   * <p>Null will be returned if there is no font family name definition for this script type.
   *
   * @param type - script type
   * @return the font family name for a specific script type
   */
  ...
  private String getFontFamilyNameFromFontName(String aFontName) {
    try {
      ...
      OfficeFontFaceDeclsElement fontfaceDecls =
          OdfElement.findFirstChildNode(
              OfficeFontFaceDeclsElement.class, contentDom.getRootElement());
      if (fontfaceDecls == null) {
        // find <office:font-face-decls> in style dom
        OdfStylesDom styleDom = mDocument.getStylesDom();
        fontfaceDecls =
            OdfElement.findFirstChildNode(
                OfficeFontFaceDeclsElement.class, styleDom.getRootElement());
      }
      if (fontfaceDecls == null) {
        return null;
      }
  ...
  /**
   * Return an instance of <code>TextProperties</p> to represent the
   * "style:text-properties" in a style element.
   * <p>
   * If there is no "style:text-properties" defined in the style element, a
   * new "style:text-properties" element will be created.
   *
   ...
   * "style:text-properties" in a style element.
   * <p>
   * If there is no "style:text-properties" defined in the style element, null
   * will be returned.
   *
   * @param style - a style element
  ...
  public static TextProperties getTextProperties(OdfStyleBase style) {
    OdfStylePropertiesBase properties =
        style.getPropertiesElement(OdfStylePropertiesSet.TextProperties);
    if (properties != null) {
      return new TextProperties((StyleTextPropertiesElement) properties);
    } else {
      return null;
  ...
  /** @return the percentage value of subscription or null */
  public Integer getSubscripted() {

    String posAtt = mElement.getStyleTextPositionAttribute();
    if (posAtt != null && posAtt.startsWith("sub")) {
  ...
  /** @return the percentage value of superscription or null */
  public Integer getSuperscripted() {

    String posAtt = mElement.getStyleTextPositionAttribute();
    if (posAtt != null && posAtt.startsWith("super")) {
  ...
  /**
   * Sets backgroundColor represented by the OpenDocument format used data type {@odf.datatype
   * color} See <a href="http://www.w3.org/TR/CSS21/syndata.html#value-def-color">W3C CSS
  ...
  /**
   * Gets backgroundColor represented by the OpenDocument format used data type {@odf.datatype
   * color} See <a href="http://www.w3.org/TR/CSS21/syndata.html#value-def-color">W3C CSS
   * specification</a> for further details.
   *
