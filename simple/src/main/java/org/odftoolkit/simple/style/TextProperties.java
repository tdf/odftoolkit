...
public class TextProperties {
     ...
     * <p>
     * TextLineStyle.REGULAR will be returned if there is no text line style
     * setting
     *
     * @return the font style
     */
    ...
    private String getFontFamilyNameFromFontName(String aFontName) {
        try {
            ...
            OfficeFontFaceDeclsElement fontfaceDecls = OdfElement.findFirstChildNode(OfficeFontFaceDeclsElement.class, contentDom.getRootElement());
            if (fontfaceDecls == null) {
                // find <office:font-face-decls> in style dom
                OdfStylesDom styleDom = mDocument.getStylesDom();
                fontfaceDecls = OdfElement.findFirstChildNode(OfficeFontFaceDeclsElement.class, styleDom.getRootElement());
            }
            if (fontfaceDecls == null) {
                return null;
            }
     ...
     *
     * @param fontsizePercent font size in per cent for superscripted text. If
     * null default is 58 %
     */
