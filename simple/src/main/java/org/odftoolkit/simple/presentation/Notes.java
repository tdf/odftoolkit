...
/**
 * <code>Notes</code> represents the presentation notes feature of the ODF document. <code>Notes
 * </code> provides methods to creates notes, add content, add list, etc.
 */
public class Notes extends Component implements ListContainer {
  ...
  public static class NotesBuilder {
    ...
    private final IdentityHashMap<PresentationNotesElement, Notes> maNotesRepository =
        new IdentityHashMap<PresentationNotesElement, Notes>();

    /**
     * NotesBuilder constructor. This constructor should only be use in owner {@link
     ...
     * @throws IllegalStateException if new NotesBuilder out of owner PresentationDocument
    ...
    /**
     * Get a presentation notes page instance by an instance of <code>PresentationNotesElement
     * </code>.
     *
     * @param noteElement an instance of <code>PresentationNotesElement</code>
     * @return an instance of <code>Notes</code> that can represent <code>PresentationNotesElement
     *     </code>
     */
    public synchronized Notes getNotesInstance(PresentationNotesElement noteElement) {
      if (maNotesRepository.containsKey(noteElement)) return maNotesRepository.get(noteElement);
      else {
  ...
  public static Notes getInstance(PresentationNotesElement noteElement) {
    PresentationDocument ownerDocument =
        (PresentationDocument) ((OdfFileDom) (noteElement.getOwnerDocument())).getDocument();
    return ownerDocument.getNotesBuilder().getNotesInstance(noteElement);
  }

  /**
   * Return an instance of <code>PresentationNotesElement</code> which represents presentation notes
   * page feature.
   *
  ...
  public void addText(String text) {
    NodeList frameList =
        maNoteElement.getElementsByTagNameNS(OdfDocumentNamespace.DRAW.getUri(), "frame");
