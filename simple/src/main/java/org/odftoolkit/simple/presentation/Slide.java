...
/**
 * <code>Slide</code> represents the presentation slide feature of the ODF document. <code>Slide
 * </code> provides methods to get the slide index,get the content of the current slide, etc.
 */
public class Slide extends Component
  ...
  public static class SlideBuilder {
    ...
    private final IdentityHashMap<DrawPageElement, Slide> maSlideRepository =
        new IdentityHashMap<DrawPageElement, Slide>();

    /**
     * SlideBuilder constructor. This constructor should only be use in owner {@link
     * org.odftoolkit.simple.PresentationDocument PresentationDocument} constructor. The end user
     * isn't allowed to call it directly, otherwise an <code>IllegalStateException</code> will be
     * thrown.
     *
     * @param doc the owner <code>PresentationDocument</code>.
     * @throws IllegalStateException if new SlideBuilder out of owner PresentationDocument
  ...
  public static Slide getInstance(DrawPageElement pageElement) {
    PresentationDocument ownerDocument =
        (PresentationDocument) ((OdfFileDom) (pageElement.getOwnerDocument())).getDocument();
  ...
  public int getSlideIndex() {
    ...
    NodeList slideNodes =
        contentDom.getElementsByTagNameNS(OdfDocumentNamespace.DRAW.getUri(), "page");
  ...
  public Notes getNotesPage() {
    NodeList notesList =
        maSlideElement.getElementsByTagNameNS(OdfDocumentNamespace.PRESENTATION.getUri(), "notes");
  ...
  private String makeUniqueSlideName() {
    ...
    String slideName =
        "page" + (index + 1) + "-" + String.format("a%06x", (int) (Math.random() * 0xffffff));
    return slideName;
  }
   ...
   *
   * <ul>
   *   <li>"BLANK" template is a slide without any filled element.
   *   <li>"TITLE_ONLY" template is a slide with a title only.
   *   <li>"TITLE_SUBTITLE" template is a slide with a title and a subtitle.
   *   <li>"TITLE_OUTLINE" template is a slide with a title and an outline block.
   *   <li>"TITLE_PLUS_TEXT" template is a slide with a title and a text block.
   *   <li>"TITLE_PLUS_CHART" template is a slide with a title and a chart block.
   *   <li>"TITLE_PLUS_2_TEXT_BLOCK" template is a slide with a title and two text blocks.
   *   <li>"TITLE_PLUS_2_CHART" template is a slide with a title and two chart blocks.
   *   <li>"TITLE_LEFT_CHART_RIGHT_OUTLINE" template is a slide with a title, a chart block on the
   *       left and an outline block on the right.
   *   <li>"TITLE_PLUS_3_OBJECT" template is a slide with a title, an outline block and two chart
   *       blocks.
   *   <li>"TITLE_PLUS_4_OBJECT" template is a slide with a title, an outline block and three chart
   *       blocks.
   *       <ul>
   */
  public enum SlideLayout {
    ...
    TITLE_SUBTITLE("title_subtitle") {
      ...
      public void apply(DrawPageElement page) {
        ...
        try {
          ...
          StylePresentationPageLayoutElement layout =
              styles.newStylePresentationPageLayoutElement(layoutName);
          // String presentationObjectValue, String svgHeightValue, String svgWidthValue, String
          // svgXValue, String svgYValue
          layout.newPresentationPlaceholderElement(
              "title", "3.507cm", "23.912cm", "2.058cm", "1.743cm");
          layout.newPresentationPlaceholderElement(
              "subtitle", "13.23cm", "23.912cm", "2.058cm", "5.838cm");
    ...
    TITLE_LEFT_CHART_RIGHT_OUTLINE("title_left_chart_right_outline") {
      ...
      public void apply(DrawPageElement page) {
        ...
        try {
          ...
          // svgXValue, String svgYValue
          layout.newPresentationPlaceholderElement(
              "title", "3.507cm", "25.199cm", "1.4cm", "0.837cm");
          layout.newPresentationPlaceholderElement(
              "chart", "13.86cm", "12.296cm", "1.4cm", "4.914cm");
          layout.newPresentationPlaceholderElement(
              "outline", "13.86cm", "12.296cm", "14.311cm", "4.914cm");
        } catch (Exception e1) {
          Logger.getLogger(SlideLayout.class.getName()).log(Level.SEVERE, null, e1);
        }
        page.setPresentationPresentationPageLayoutNameAttribute(layoutName);
      ...
      public void apply(DrawPageElement page) {
        ...
        try {
          ...
          layout.newPresentationPlaceholderElement(
              "title", "3.507cm", "25.199cm", "1.4cm", "0.837cm");
          layout.newPresentationPlaceholderElement(
              "chart", "13.86cm", "25.199cm", "1.4cm", "4.914cm");
        } catch (Exception e1) {
          Logger.getLogger(SlideLayout.class.getName()).log(Level.SEVERE, null, e1);
        }
        page.setPresentationPresentationPageLayoutNameAttribute(layoutName);
      ...
      public void apply(DrawPageElement page) {
        ...
        try {
          ...
          layout.newPresentationPlaceholderElement(
              "title", "3.507cm", "25.199cm", "1.4cm", "0.837cm");
          layout.newPresentationPlaceholderElement(
              "chart", "6.61cm", "25.199cm", "1.4cm", "4.914cm");
          layout.newPresentationPlaceholderElement(
              "chart", "6.61cm", "25.199cm", "1.4cm", "12.153cm");
        } catch (Exception e1) {
          Logger.getLogger(SlideLayout.class.getName()).log(Level.SEVERE, null, e1);
        }
        page.setPresentationPresentationPageLayoutNameAttribute(layoutName);
      ...
      public void apply(DrawPageElement page) {
        ...
        try {
          ...
          layout.newPresentationPlaceholderElement(
              "title", "3.507cm", "25.199cm", "1.4cm", "0.837cm");
          layout.newPresentationPlaceholderElement(
              "chart", "6.61cm", "12.296cm", "1.4cm", "4.914cm");
          layout.newPresentationPlaceholderElement(
              "outline", "6.61cm", "12.296cm", "14.311cm", "4.914cm");
          layout.newPresentationPlaceholderElement(
              "chart", "6.61cm", "25.199cm", "1.4cm", "12.153cm");
        } catch (Exception e1) {
          Logger.getLogger(SlideLayout.class.getName()).log(Level.SEVERE, null, e1);
      ...
      public void apply(DrawPageElement page) {
        ...
        try {
          ...
          layout.newPresentationPlaceholderElement(
              "outline", "6.61cm", "12.296cm", "14.311cm", "4.914cm");
          layout.newPresentationPlaceholderElement(
              "chart", "6.61cm", "12.296cm", "1.4cm", "12.153cm");
          layout.newPresentationPlaceholderElement(
              "chart", "6.61cm", "12.296cm", "14.311cm", "12.153cm");
        } catch (Exception e1) {
          Logger.getLogger(SlideLayout.class.getName()).log(Level.SEVERE, null, e1);
        }
        page.setPresentationPresentationPageLayoutNameAttribute(layoutName);
     ...
     *
     * @param page the slide element which this layout is applied on.
     * @since 0.6
     */
  ...
  private class ListContainerImpl extends AbstractListContainer {
    ...
    public OdfElement getListContainerElement() {
      ...
      NodeList frameList =
          maSlideElement.getElementsByTagNameNS(OdfDocumentNamespace.DRAW.getUri(), "frame");
      if (frameList.getLength() > 0) {
        ...
        while (index >= 0) {
          ...
          if (presentationClass == null
              || "outline".equals(presentationClass)
              || "text".equals(presentationClass)
              || "subtitle".equals(presentationClass)) {
            break;
          } else {
            index--;
          }
      ...
      NodeList textBoxList =
          frame.getElementsByTagNameNS(OdfDocumentNamespace.DRAW.getUri(), "text-box");
    ...
    protected DrawFrameElement getChartFrame() throws Exception {
      ...
      while (element != null) {
        if ("chart".equals(element.getPresentationClassAttribute())) {
          DrawObjectElement chartEle =
              OdfElement.findFirstChildNode(DrawObjectElement.class, element);
          if (chartEle == null) {
            return element;
          } else {
