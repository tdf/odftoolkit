...
public class GraphicsDocument extends Document {
	 ...
	 * read access needed by GraphicsDocument, the InputStream is cached. This usually
	 ...
	 *
	 * <p>GraphicsDocument relies on the file being available for read access over
	 * the whole lifecycle of GraphicsDocument.</p>
	 *
	 * <p>If the resource stream is not a ODF graphics document, ClassCastException might be thrown.</p>
	 * 
