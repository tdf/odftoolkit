...
public class ChartDocument extends Document {
	 ...
	 * read access needed by ChartDocument, the InputStream is cached. This usually
	 ...
	 *
	 * <p>ChartDocument relies on the file being available for read access over
	 * the whole lifecycle of ChartDocument.</p>
	 *
	 * <p>If the resource stream is not a ODF chart document, ClassCastException might be thrown.</p>
	 * 
