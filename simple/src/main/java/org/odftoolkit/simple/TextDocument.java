...
public class TextDocument extends Document {
	 ...
	 * read access needed by TextDocument, the InputStream is cached. This usually
	 ...
	 *
	 * <p>TextDocument relies on the file being available for read access over
	 * the whole lifecycle of TextDocument.</p>
	 *
	 * <p>If the resource stream is not a ODF text document, ClassCastException might be thrown.</p>
	 * 
