...
public class ListItemTest {
  ...
  public void testAddRemoveIterateSubList() {
    try {
      ...
      ListDecorator imageDecorator =
          new ImageDecorator(odtdoc, ResourceUtilities.getURI("image_list_item.png"));
      Iterator<List> listIterator = odtdoc.getListIterator();
  ...
  public void testListIterator() {
    try {
      ...
      TextDocument odtdoc =
          TextDocument.loadDocument(
              ResourceUtilities.getTestResourceAsStream(SAMPLE_LIST_DOCUMENT_2));
      Iterator<List> listIterator = odtdoc.getListIterator();
      ...
      Assert.assertTrue(
          "iterator should have 1 more list (in the Section)", listIterator.hasNext());
