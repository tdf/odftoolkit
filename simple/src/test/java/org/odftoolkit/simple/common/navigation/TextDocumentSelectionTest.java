...
/** Test the method of class org.odftoolkit.simple.common.navigation.TextDocumentSelection */
public class TextDocumentSelectionTest {
  ...
  public void setUp() {
    try {
      ...
      Logger.getLogger(TextDocumentSelectionTest.class.getName())
   ...
   * org.odftoolkit.simple.common.navigation.TextDocumentSelection replace "Featured Text" to
   * TextDocument, all Styles be included.
   */
  @Test
