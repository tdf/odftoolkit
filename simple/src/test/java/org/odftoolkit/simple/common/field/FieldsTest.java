    ...
    try {
      ...
      ConditionField conditionField =
          Fields.createConditionField(
              newParagraph, "test_con_variable == \"true\"", "trueText", "falseText");
      Assert.assertNotNull(conditionField);

      // test hide field
      newParagraph = doc.newParagraph("Hide Text Field Test:");
      conditionField =
          Fields.createHiddenTextField(newParagraph, "test_con_variable == \"true\"", "hiddenText");
      Assert.assertNotNull(conditionField);
    } catch (Exception e) {
  ...
  public void testCreateVariableField() {
    try {
      ...
      VariableField userVariableField =
          Fields.createUserVariableField(doc, "test_user_variable", "test");
  ...
  public void testCreateReferenceField() {
    try {
      TextDocument doc =
          TextDocument.loadDocument(ResourceUtilities.getTestResourceAsStream(TEST_DOCUMENT));
      TextSpanElement newTextSpanElement =
          doc.newParagraph("Reference Content:").newTextSpanElement();
      ...
      referenceField.appendReferenceTo(
          doc.newParagraph("User Reference Field:"), ReferenceField.DisplayType.TEXT);
    } catch (Exception e) {
      Logger.getLogger(FieldsTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail(e.getMessage());
    }
  ...
  public void testAddAuthorField() {
    try {
      ...
      AuthorField authorField =
          Fields.createAuthorInitialsField(doc.newParagraph("The initials of the author :"));
