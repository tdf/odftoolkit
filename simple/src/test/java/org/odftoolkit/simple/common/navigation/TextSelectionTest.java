...
public class TextSelectionTest {
  ...
  /**
   * Test pasteAtFrontOf method of org.odftoolkit.simple.common.navigation.TextSelection copy the
  ...
  /**
   * Test pasteAtEndOf method of org.odftoolkit.simple.common.navigation.TextSelection copy the
   * first 'change' word at the end of all the 'delete' word
   */
  @Test
  ...
  /**
   * Test applyStyle method of org.odftoolkit.simple.common.navigation.TextSelection append "T4"
  ...
  /**
   * Test replaceWith method of org.odftoolkit.simple.common.navigation.TextSelection replace all
   * the 'SIMPLE' with 'Odf Toolkit'
   */
  @Test
  ...
  /**
   * Test addComment method of org.odftoolkit.simple.common.navigation.TextSelection add comment
  ...
  public void testAddComment() {
    try {
      TextDocument textDoc =
          TextDocument.loadDocument(ResourceUtilities.getAbsolutePath(TEXT_COMMENT_FILE));
  ...
  /**
   * Test addHref method of org.odftoolkit.simple.common.navigation.TextSelection add href
  ...
  /**
   * Test search pattern of org.odftoolkit.simple.common.navigation.TextSelection search a snippet
   * of text match the pattern "<%([^>]*)%>", and extract the content between "<%" and "%>"
   */
  @Test
  ...
  /**
   * Test TextSelection container element, all of them must be minimum text:p or text:h. It means
   * container element can't has child element has the same text content.
   */
  @Test
  ...
  public void testReplacewithTable() throws Exception {
    ...
    doc = (TextDocument) Document.loadDocument(ResourceUtilities.getAbsolutePath(TEST_FILE));
    ...
    try {
      ...
      doc.save(
          ResourceUtilities.newTestOutputFile(
              "TextSelectionReplacewithTableResult-BasicCases.odt"));
  ...
  public void testReplacewithImage() throws Exception {
    ...
    try {
      ...
      doc.save(
          ResourceUtilities.newTestOutputFile(
              "TextSelectionReplacewithImageResult-URI-BasicCases.odt"));
    ...
    try {
      ...
      doc.save(
          ResourceUtilities.newTestOutputFile(
              "TextSelectionReplacewithImageResult-BasicCases.odt"));
  ...
  public void testReplacewithParagraph() throws Exception {
    ...
    try {
      while (search.hasNext()) {
        ...
        Assert.assertEquals(
            TextExtractor.getText(paragraph.getOdfElement()), "Hello2 from source document!");
      }
      doc.save(
          ResourceUtilities.newTestOutputFile(
              "TextSelectionReplacewithPararaphResult-BasicCases.odt"));
      verifyReplaceWithParagraphByBasicCases(
          "TextSelectionReplacewithPararaphResult-BasicCases.odt");
    } catch (Exception e) {
      Logger.getLogger(TextSelectionTest.class.getName()).log(Level.SEVERE, e.getMessage(), e);
      Assert.fail("Failed with " + e.getClass().getName() + ": '" + e.getMessage() + "'");
  ...
  public void testReplacewithField() throws Exception {
    ...
    VariableField variableField =
        Fields.createUserVariableField(sourcedoc, "test_simple_variable", "testReplacewithField");
    Assert.assertNotNull(variableField);
    TextSpanElement newTextSpanElement =
        sourcedoc.newParagraph("Update Variable Field:").newTextSpanElement();
  ...
  public void testReplacewithTextDocument() throws Exception {
    ...
    try {
      doc.save(
          ResourceUtilities.newTestOutputFile("TextSelectionReplacewithTextDocumentResult.odt"));
    } catch (Exception e) {
      Logger.getLogger(TextSelectionTest.class.getName()).log(Level.SEVERE, e.getMessage(), e);
      Assert.fail("Failed with " + e.getClass().getName() + ": '" + e.getMessage() + "'");
    }
  ...
  private void verifyReplaceWithTableByBasicCases(String fileName) {
    try {
      doc = (TextDocument) Document.loadDocument(ResourceUtilities.getAbsolutePath(fileName));
      search = new TextNavigation("#1", doc);
      while (search.hasNext()) {
        OdfElement description = search.nextSelection().getElement();
        OdfElement replacement = (OdfElement) description.getNextSibling();
      ...
      String breakBefore = table.getStyleHandler().getTablePropertiesForRead().getBreakBefore();
      Assert.assertNotNull(breakBefore);
      description = search.nextSelection().getElement();
      replacement = description.getNextSibling();
      Assert.assertEquals("prefix", TextExtractor.getText((TextParagraphElementBase) replacement));
      Paragraph para = Paragraph.getInstanceof((TextParagraphElementBase) replacement);
      breakBefore = para.getStyleHandler().getParagraphPropertiesForRead().getBreakBefore();
      Assert.assertNotNull(breakBefore);
      replacement = replacement.getNextSibling();
      Assert.assertTrue(replacement instanceof TableTableElement);
      table = Table.getInstance((TableTableElement) replacement);
      breakBefore = table.getStyleHandler().getTablePropertiesForRead().getBreakBefore();
      Assert.assertNull(breakBefore);
      replacement = replacement.getNextSibling();
      Assert.assertEquals("suffix", TextExtractor.getText((TextParagraphElementBase) replacement));
      para = Paragraph.getInstanceof((TextParagraphElementBase) replacement);
      breakBefore = para.getStyleHandler().getParagraphPropertiesForRead().getBreakBefore();
      Assert.assertNull(breakBefore);
      description = search.nextSelection().getElement();
      replacement = description.getNextSibling();
      ...
      table = Table.getInstance((TableTableElement) replacement);
      String masterStyle =
          table.getStyleHandler().getStyleElementForRead().getAttribute("style:master-page-name");
  ...
  private void verifyReplaceWithParagraphByBasicCases(String fileName) {
    try {
      ...
      while (search.hasNext()) {
        ...
        OdfElement replacement = (OdfElement) description.getNextSibling();
        Assert.assertNotNull(replacement);
        Assert.assertEquals("Hello2 from source document!", TextExtractor.getText(replacement));
      }
      search = new TextNavigation("#2", doc);
      while (search.hasNext()) {
        OdfElement description = search.nextSelection().getElement();
      ...
      search = new TextNavigation("#3", doc);
      OdfElement description = search.nextSelection().getElement();
      TextParagraphElementBase replacement =
          (TextParagraphElementBase) description.getNextSibling();
      Assert.assertEquals("Hello2 from source document!", TextExtractor.getText(replacement));
      Paragraph para = Paragraph.getInstanceof(replacement);
      String breakBefore = para.getStyleHandler().getParagraphPropertiesForRead().getBreakBefore();
      Assert.assertNotNull(breakBefore);
      description = search.nextSelection().getElement();
      replacement = (TextParagraphElementBase) description.getNextSibling();
      Assert.assertEquals("prefix", TextExtractor.getText(replacement));
      para = Paragraph.getInstanceof(replacement);
      breakBefore = para.getStyleHandler().getParagraphPropertiesForRead().getBreakBefore();
      Assert.assertNotNull(breakBefore);
      replacement = (TextParagraphElementBase) replacement.getNextSibling();
      Assert.assertEquals("Hello2 from source document!", TextExtractor.getText(replacement));
      para = Paragraph.getInstanceof(replacement);
      breakBefore = para.getStyleHandler().getParagraphPropertiesForRead().getBreakBefore();
      Assert.assertNull(breakBefore);
      ...
      para = Paragraph.getInstanceof(replacement);
      String masterStyle =
          para.getStyleHandler().getStyleElementForRead().getAttribute("style:master-page-name");
      Assert.assertNotNull(masterStyle);
    } catch (Exception e) {
      Logger.getLogger(TextSelectionTest.class.getName()).log(Level.SEVERE, e.getMessage(), e);
      Assert.fail("Failed with " + e.getClass().getName() + ": '" + e.getMessage() + "'");
  ...
  private void verifyReplaceWithTextDocumentByBasicCases(String fileName) {
    try {
      ...
      TextParagraphElementBase pElement =
          (TextParagraphElementBase) search.nextSelection().getElement();
      Node nextPElement = pElement.getNextSibling();
      Assert.assertTrue(nextPElement instanceof TextParagraphElementBase);
      String contents = TextExtractor.getText((TextParagraphElementBase) nextPElement);
      if (!contents.startsWith("This is a picture from the source document:")) Assert.fail();
      TextSpanElement spanEle =
          (TextSpanElement) pElement.getElementsByTagName("text:span").item(0);
      Span span = Span.getInstanceof(spanEle);
      FontStyle fontStyle = span.getStyleHandler().getTextPropertiesForRead().getFontStyle();
