...
/** Test the method of class org.odftoolkit.simple.common.navigation.FieldSelection */
public class FieldSelectionTest {
  ...
  public void testReplaceWithConditionField() {
    try {
      ...
      OdfContentDom contentDom = doc.getContentDom();
      NodeList nodeList =
          contentDom.getElementsByTagName(TextConditionalTextElement.ELEMENT_NAME.getQName());
      int i = nodeList.getLength();
      OdfStylesDom styleDom = doc.getStylesDom();
      ...
      while (search.hasNext()) {
        TextSelection item = (TextSelection) search.nextSelection();
        FieldSelection fieldSelection = new FieldSelection(item);
        fieldSelection.replaceWithConditionField(
            "test_con_variable == \"true\"", "trueText", "falseText");
        i++;
      }
      nodeList =
          contentDom.getElementsByTagName(TextConditionalTextElement.ELEMENT_NAME.getQName());
  ...
  public void testReplaceWithReferenceField() {
    try {
      ...
      TextSpanElement newTextSpanElement =
          doc.newParagraph("Selection Reference Content:").newTextSpanElement();
      newTextSpanElement.setTextContent("This is a test selection reference content.");
      ReferenceField referenceField =
          Fields.createReferenceField(newTextSpanElement, "selection-test-ref");
      // count the initial reference field count.
      OdfContentDom contentDom = doc.getContentDom();
      NodeList nodeList =
          contentDom.getElementsByTagName(TextReferenceRefElement.ELEMENT_NAME.getQName());
      int i = nodeList.getLength();
      OdfStylesDom styleDom = doc.getStylesDom();
  ...
  public void testReplaceWithVariableField() {
    try {
      ...
      OdfContentDom contentDom = doc.getContentDom();
      NodeList nodeList =
          contentDom.getElementsByTagName(TextUserFieldGetElement.ELEMENT_NAME.getQName());
      int i = nodeList.getLength();
      OdfStylesDom styleDom = doc.getStylesDom();
  ...
  public void testReplaceWithSimpleField_time_field() {
    try {
      ...
      TextDocument doc1 =
          (TextDocument)
              Document.loadDocument(ResourceUtilities.getAbsolutePath(SAVE_FILE_REPLACE));
  ...
  public void testReplaceWithSimpleField_previous_page_number_field() {
    try {
      ...
      NodeList nodeList1 =
          contentDom.getElementsByTagName(TextPageNumberElement.ELEMENT_NAME.getQName());
  ...
  public void testReplaceWithSimpleField_page_count_field() {
    try {
      ...
      NodeList nodeList =
          contentDom.getElementsByTagName(TextPageCountElement.ELEMENT_NAME.getQName());
      int i = nodeList.getLength();
      OdfStylesDom styleDom = doc.getStylesDom();
  ...
  public void testReplaceWithSimpleField_subject_field() {
    try {
      ...
      NodeList nodeList =
          contentDom.getElementsByTagName(TextSubjectElement.ELEMENT_NAME.getQName());
      int i = nodeList.getLength();
      OdfStylesDom styleDom = doc.getStylesDom();
  ...
  public void testReplaceWithSimpleField_author_name_field() {
    try {
      ...
      NodeList nodeList =
          contentDom.getElementsByTagName(TextAuthorNameElement.ELEMENT_NAME.getQName());
      int i = nodeList.getLength();
      OdfStylesDom styleDom = doc.getStylesDom();
  ...
  public void testReplaceWithSimpleField_author_initials_field() {
    try {
      ...
      NodeList nodeList =
          contentDom.getElementsByTagName(TextAuthorInitialsElement.ELEMENT_NAME.getQName());
      int i = nodeList.getLength();
      OdfStylesDom styleDom = doc.getStylesDom();
  ...
  public void testReplaceWithSimpleField_chapter_field() {
    try {
      ...
      NodeList nodeList =
          contentDom.getElementsByTagName(TextChapterElement.ELEMENT_NAME.getQName());
      int i = nodeList.getLength();
      OdfStylesDom styleDom = doc.getStylesDom();
  ...
  public void testPasteAtEndOf() {
    try {
      ...
      if (pastesource == null) Assert.fail("pastesource == null.");
