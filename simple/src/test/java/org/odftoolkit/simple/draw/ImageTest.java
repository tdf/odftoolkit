...
public class ImageTest {
  ...
  public void testRemove() {
    try {
      ...
      TextDocument doc1 =
          TextDocument.loadDocument(ResourceUtilities.getAbsolutePath("imageFretest.odt"));
      ...
      while (parasIter.hasNext()) {
        ...
        if ("imagePara".equals(text)) {
          ...
          if (!flag) Assert.fail("remove() method was executed failed.");
        }
      }
      ...
      // validate
      TextDocument doc2 =
          TextDocument.loadDocument(ResourceUtilities.getAbsolutePath("imageEndtest.odt"));
      ...
      while (parasIter2.hasNext()) {
        ...
        if ("imagePara".equals(text)) {
          ...
          NodeList nodeImages = textParaEleBase.getElementsByTagName("draw:image");
          Node nodeImage = nodeImages.item(0);
          if (nodeImage == null) Assert.assertTrue(true);
          else Assert.fail();
        }
      }
  ...
  public void testSetRectangle() {
    try {
      ...
      FrameRectangle rectangle =
          new FrameRectangle(
              5.13, 4.21, 3.76, 3.51, StyleTypeDefinitions.SupportedLinearMeasure.CM);
      ...
      Assert.assertEquals(
          StyleTypeDefinitions.SupportedLinearMeasure.CM, rectangle2.getLinearMeasure());
