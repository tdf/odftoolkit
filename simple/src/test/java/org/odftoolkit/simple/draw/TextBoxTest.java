...
public class TextBoxTest {
  ...
  public void testAddTextbox() {
    ...
    try {
      ...
      textDoc =
          TextDocument.loadDocument(ResourceUtilities.getTestResourceAsStream("textsample.odt"));
      ...
      Textbox titleTextbox =
          slide1.getTextboxByUsage(PresentationDocument.PresentationClass.TITLE).get(0);
      Assert.assertNotNull(titleTextbox);
      titleTextbox.setTextContent("My Title1");
      java.util.List<Textbox> boxList =
          slide1.getTextboxByUsage(PresentationDocument.PresentationClass.OUTLINE);
  ...
  public void testGetRemoveTextbox() {
    ...
    try {
      TextDocument doc =
          TextDocument.loadDocument(ResourceUtilities.getTestResourceAsStream("SampleBox.odt"));
