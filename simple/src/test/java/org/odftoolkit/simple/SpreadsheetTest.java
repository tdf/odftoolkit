...
public class SpreadsheetTest {
  ...
  private static final String TEST_FILE_NAME = "TestSpreadsheetTable.ods";
  ...
  public void testInsertSheet() {
    try {
      ...
      Assert.assertEquals(
          sheet1.getCellByPosition("E3").getDisplayText(),
          table.getCellByPosition("E3").getDisplayText());
  ...
  public void testAppendAndRemoveSheet() {
    try {
      ...
      document =
          SpreadsheetDocument.loadDocument(
              ResourceUtilities.getTestResourceAsStream("Output_" + TEST_FILE_NAME));
