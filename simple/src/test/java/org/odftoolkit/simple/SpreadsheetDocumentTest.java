...
public class SpreadsheetDocumentTest {
  ...
  public void testGetOdfMediaType() throws Exception {
    ...
    try {
      ...
      Document.OdfMediaType odfMediaType =
          SpreadsheetDocument.OdfMediaType.getOdfMediaType(spreadDoc.getMediaTypeString());
  ...
  public void testCreateChart() throws Exception {
    try {
      SpreadsheetDocument spDocument =
          SpreadsheetDocument.loadDocument(ResourceUtilities.getAbsolutePath(TEST_FILE));
