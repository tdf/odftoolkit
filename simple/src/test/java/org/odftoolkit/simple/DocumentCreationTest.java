...
public class DocumentCreationTest {
  ...
  public void createEmbeddedDocs() throws Exception {
    ...
    odtDoc1.insertDocument(
        Document.loadDocument(
            ResourceUtilities.getTestResourceAsStream("TestEmpty_OdfGraphicsDocument.odg")),
        "Object3");
    ...
    Assert.assertEquals(
        embeddedObject1.getMediaTypeString(), Document.OdfMediaType.TEXT.getMediaTypeString());
    ...
    Assert.assertEquals(
        embeddedObject3.getMediaTypeString(), Document.OdfMediaType.GRAPHICS.getMediaTypeString());
    ...
    Assert.assertEquals(
        ...
        Document.OdfMediaType.PRESENTATION.getMediaTypeString());
  }
  ...
  public void accessEmbeddedWithinEmbeddedDocs() {
    ...
    try {
      ...
      Document emb_embDoc =
          rootDocument.getEmbeddedDocument(embDoc.getDocumentPath() + pathOfSecondInnerDoc);
  ...
  public void testSaveEmbeddedDocuments() {
    ...
    try {
      ...
      List<Document> embDocs =
          docWithEmbeddedObjects.getEmbeddedDocuments(Document.OdfMediaType.GRAPHICS);
      // Graphics Doc
      Document doc1 = embDocs.get(0);
      ...
      List<Document> embDocs3 =
          docWithEmbeddedObjects.getEmbeddedDocuments(Document.OdfMediaType.TEXT);
  ...
  @Test
  /**
   * Document docA and docB are embedded Odfdocuments, a containing b! But the relative package path
   * hierachiy is opposite, meaning OdfPackage/docB/docA
   */
  ...
  /**
   * Test if saving Documents always results in a valid ODF file. This means that the mimetype is
