...
public class SlideTest {
	 ...
	 * <b>Method</b> 1)By using PresentationDocument.getSlideCount() to Get the
	 ...
	 * 3)PresentationDocument.getSlideByName(String name)
	 * 4)Using dfPresentationDocument.getSlides() to get the slide iterator
	 * <b>Covered Element</b> &lt;office:presentation&gt;,&lt;draw:page&gt;
	 * <b>Note</b> PresentationDocument.getContentRoot override Document.getContentRoot method
	 ...
	 * <p>
	 * <b>Precondition</b> Load Presentation File at test\resources\performance\Presentation1.odp
	 * <b>Method</b> 1)By using PresentationDocument.deleteSlideByIndex(int index)
	 ...
	 * PresentationDocument.deleteSlideByName(String name)
	...
	public void testDeleteSlide() {
		try {
			...
			doc2 = PresentationDocument.loadDocument(ResourceUtilities.getTestResourceAsStream(TEST_PRESENTATION_FILE_ANOTHER));
	 ...
	 * <b>Method</b> 1)Using PresentationDocument.moveSlide(int current, int destination)
	 * to move a slide at the current position to the destination position.
	 * 2)PresentationDocument.copySlide(int source, int dest, String newName)
	 ...
	 * <b>Method</b> Using PresentationDocument.copyForeignSlide(int
	 * destIndex,PresentationDocument srcDoc, int srcIndex) to copy a slide
	 ...
	 * <p>
	 * <b>Precondition</b> Load Presentation File at test\resources\performance\Presentation1.odp & test\resources\performance\Presentation2.odp
	 * <b>Method</b> Using PresentationDocument.appendPresentation(PresentationDocument aDoc)
