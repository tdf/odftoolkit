...
public class BorderTest {
  ...
  public void testGetSetBorder() {
    ...
    Border borderbase2 =
        new Border(new Color("#0000ff"), 0.0154, 0.0008, 0.0008, SupportedLinearMeasure.IN);
    Border borderbase3 =
        new Border(new Color("#ff3333"), 0.0362, 0.0008, 0.0008, SupportedLinearMeasure.IN);
    Border borderbase4 =
  ...
  public void testSGetLinearMeasure() {
    ...
    try {
      ...
      thisBorder = cell.getBorder(CellBordersType.TOP);
      Assert.assertEquals(
          StyleTypeDefinitions.SupportedLinearMeasure.CM, thisBorder.getLinearMeasure());
      // save
      // doc.save(ResourceUtilities.newTestOutputFile("testSetWidth.ods"));
