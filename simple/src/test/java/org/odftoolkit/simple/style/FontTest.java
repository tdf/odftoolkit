...
public class FontTest {
  ...
  public void testGetSetFont() {
    ...
    try {
      ...
      cell7
          .getStyleHandler()
          .setFont(font3Base, new Locale(Locale.CHINESE.getLanguage(), Locale.CHINA.getCountry()));
      cell7
          .getStyleHandler()
    ...
    try {
      ...
      SpreadsheetDocument doc =
          SpreadsheetDocument.loadDocument(
              ResourceUtilities.getTestResourceAsStream("testFontOutput1.ods"));
  ...
  public void testNewFont4() {
    try {
      ...
      Font font =
          new Font(
              "Arial", StyleTypeDefinitions.FontStyle.ITALIC, 17.5, Color.GREEN, Locale.ENGLISH);
      Cell cell = table.getCellByPosition("A1");
      cell.setFont(font);
      cell.setStringValue("Hi World.");
