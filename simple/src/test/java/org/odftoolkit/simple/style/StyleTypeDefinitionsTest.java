...
public class StyleTypeDefinitionsTest {
    ...
    try {
      SpreadsheetDocument odsdoc =
          SpreadsheetDocument.loadDocument(
              ResourceUtilities.getTestResourceAsStream("TestSpreadsheetTable.ods"));
  ...
  public void testAnchorType() throws Exception {
    ...
    try {
      ...
      Assert.assertEquals(
          HorizontalRelative.PAGE, graphicPropertiesForWrite.getHorizontalRelative());
      Assert.assertEquals(
      ...
      StyleTypeDefinitions.AnchorType anchorType1 =
          StyleTypeDefinitions.AnchorType.enumValueOf("char");
      Assert.assertEquals(StyleTypeDefinitions.AnchorType.TO_CHARACTER, anchorType1);
      StyleTypeDefinitions.AnchorType anchorType2 =
          StyleTypeDefinitions.AnchorType.enumValueOf("aaaa");
  ...
  public void testVerticalRelative() throws Exception {
    ...
    try {
      ...
      //
      StyleTypeDefinitions.VerticalRelative vert =
          StyleTypeDefinitions.VerticalRelative.enumValueOf("");
      Assert.assertEquals("page", vert.toString());
      StyleTypeDefinitions.VerticalRelative vert1 =
          StyleTypeDefinitions.VerticalRelative.enumValueOf("aaaa");
      Assert.assertEquals("page", vert1.toString());
      StyleTypeDefinitions.VerticalRelative vert2 =
          StyleTypeDefinitions.VerticalRelative.enumValueOf("frame");
