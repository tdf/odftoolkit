...
public class PageLayoutPropertiesTest {
  ...
  public void testGetSetMargins() {
    ...
    try {
      ...
      MasterPage master = MasterPage.getOrCreateMasterPage(newDoc, "TestMaster");
      ...
      Logger.getLogger(PageLayoutPropertiesTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  }
  ...
  public void testGetSetNumFormat() {
    try {
      ...
      Assert.assertEquals(NumberFormat.HINDU_ARABIC_NUMBER.toString(), master.getNumberFormat());
  ...
  public void testGetSetWritingMode() {
    try {
      ...
      Assert.assertEquals(WritingMode.LRTB.toString(), master.getWritingMode());
      master.setNumberFormat(null);
      Assert.assertNull(master.getNumberFormat());
  ...
  public void testGetSetPrintOrientation() {
    try {
      ...
      Assert.assertEquals(PrintOrientation.LANDSCAPE.toString(), master.getPrintOrientation());
  ...
  public void testGetSetMax() {
    try {
      ...
      Assert.assertEquals(9.9996, master.getFootnoteMaxHeight());
  ...
  public void testGetSetFootnoteSep() {
    try {
      TextDocument newDoc = TextDocument.newTextDocument();
      MasterPage master = MasterPage.getOrCreateMasterPage(newDoc, "TestMaster");
      master.setFootnoteSepProperties(
          AdjustmentStyle.CENTER,
          Color.AQUA,
          10,
          10,
          LineStyle.DASH_BOLD,
