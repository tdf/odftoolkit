...
public class RadioButtonTest {
  private static final FrameRectangle radioRtg =
      new FrameRectangle(0.7972, 1.2862, 2.4441, 0.2669, SupportedLinearMeasure.IN);
  ...
  public static void createForm() {
    try {
      ...
      RadioButton radiobutton =
          (RadioButton) form.createRadioButton(doc, radioRtg, "RadioGroup1", "RadioButton 1", "1");

      // radiobutton 2
      Paragraph para = doc.addParagraph("RadioButton2 anchor to heading.");
      para.applyHeading();
      form.createRadioButton(para, radioRtg, "RadioGroup1", "RadioButton 2", "2");

      // radiobutton 3
      para = doc.addParagraph("Insert radiobutton3 here, as_char.");
      radiobutton =
          (RadioButton) form.createRadioButton(para, radioRtg, "RadioGroup1", "RadioButton 3", "3");
      ...
      form.createRadioButton(para, radioRtg, "RadioGroup1", "RadioButton 4", "4");
      doc.save(ResourceUtilities.newTestOutputFile("TestCreateRadioButton.odt"));

    } catch (Exception e) {
      Logger.getLogger(RadioButtonTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  }
    ...
    try {
      TextDocument textDoc =
          TextDocument.loadDocument(
              ResourceUtilities.getTestResourceAsStream("TestCreateRadioButton.odt"));
      ...
      while (iterator.hasNext()) {
        ...
        Assert.assertEquals("RadioButton " + (++count), radio.getLabel());
      }
    } catch (Exception e) {
      Logger.getLogger(RadioButtonTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
  ...
  public void testRemoveRadioButton() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestRemoveRadioButton.odt"));
    } catch (Exception e) {
      Logger.getLogger(RadioButtonTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  ...
  public void testSetRadioButtonRectangle() {
    try {
      ...
      find.setRectangle(new FrameRectangle(2.25455, 5, 3, 0.5, SupportedLinearMeasure.IN));
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetRadioButtonRectangle.odt"));
    } catch (Exception e) {
      Logger.getLogger(RadioButtonTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  ...
  public void testSetAnchorType() {
    try {
      ...
      // validate
      ControlStyleHandler frameStyleHandler = find.getDrawControl().getStyleHandler();
      GraphicProperties graphicPropertiesForWrite =
          frameStyleHandler.getGraphicPropertiesForWrite();
      Assert.assertEquals(
          VerticalRelative.PARAGRAPH, graphicPropertiesForWrite.getVerticalRelative());
      Assert.assertEquals(
          FrameVerticalPosition.TOP, graphicPropertiesForWrite.getVerticalPosition());
      Assert.assertEquals(
          HorizontalRelative.PARAGRAPH, graphicPropertiesForWrite.getHorizontalRelative());
      Assert.assertEquals(
          FrameHorizontalPosition.CENTER, graphicPropertiesForWrite.getHorizontalPosition());

      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetRadioButtonAnchorType.odt"));
    } catch (Exception e) {
      Logger.getLogger(RadioButtonTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  ...
  public void testSetLabel() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetRadioButtonLabel.odt"));
    } catch (Exception e) {
      Logger.getLogger(RadioButtonTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  ...
  public void testCheckedState() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetRadioButtonState.odt"));
    } catch (Exception e) {
      Logger.getLogger(RadioButtonTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  ...
  public void testSetValue() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetRadioButtonValue.odt"));
    } catch (Exception e) {
      Logger.getLogger(RadioButtonTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
