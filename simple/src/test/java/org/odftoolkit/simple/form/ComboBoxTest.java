...
public class ComboBoxTest {
  private static final FrameRectangle comboRtg =
  ...
  public static void createForm() {
    try {
      ...
      comboBox = form.createComboBox(para, comboRtg, "combo2", "default text", true);
      ...
      ((ComboBox) comboBox).setListSource("SELECT \"Publisher\", \"Identifier\" FROM \"biblio\"");
      ...
      doc.save(ResourceUtilities.newTestOutputFile("TestCreateComboBox.odt"));

    } catch (Exception e) {
      Logger.getLogger(ComboBoxTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  }
    ...
    try {
      TextDocument textDoc =
          TextDocument.loadDocument(
              ResourceUtilities.getTestResourceAsStream("TestCreateComboBox.odt"));
      ...
      Assert.assertEquals("combo" + (++count), comboBox.getName());
      Assert.assertEquals(
          "SELECT \"Publisher\", \"Identifier\" FROM \"biblio\"", comboBox.getListSource());
      Assert.assertEquals(FormListSourceType.SQL, comboBox.getListSourceType());
      ...
      Assert.assertEquals(
          textDoc
              ...
              .getOdfElement(),
          comboBox.getDrawControl().getContainerElement());
  ...
  public void testRemoveComboBox() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestRemoveComboBox.odt"));
    } catch (Exception e) {
      Logger.getLogger(ComboBoxTest.class.getName()).log(Level.SEVERE, null, e);
    }
  }
  ...
  public void testSetComboBoxRectangle() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetComboBoxRectangle.odt"));
    } catch (Exception e) {
      Logger.getLogger(ComboBoxTest.class.getName()).log(Level.SEVERE, null, e);
    }
  }
  ...
  public void testSetAnchorType() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetComboBoxAnchorType.odt"));
    } catch (Exception e) {
      Logger.getLogger(ComboBoxTest.class.getName()).log(Level.SEVERE, null, e);
    }
  }
  ...
  public void testSetProperties() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetComboBoxProperties.odt"));
    } catch (Exception e) {
      Logger.getLogger(ComboBoxTest.class.getName()).log(Level.SEVERE, null, e);
    }
  }
