...
public class FieldTest {
  private static final FrameRectangle fieldRtg =
      new FrameRectangle(0.5, 2.0, 2.9433, 0.5567, SupportedLinearMeasure.IN);
  ...
  public static void createForm() {
    try {
      ...
      FormControl dateField = form.createDateField(para, fieldRtg, "DateField", "20120715");
      ...
      FormControl timeField = form.createTimeField(para, fieldRtg, "TimeField", "15234000");
      ...
      FormControl numericField =
          form.createNumericField(para, fieldRtg, "NumericField", "-154.3567");
      ...
      Paragraph.newParagraph(doc);
      para = Paragraph.newParagraph(doc);
      FormControl patternField = form.createPatternField(para, fieldRtg, "PatternField", "12345");
      ...
      FormControl currencyField =
          form.createCurrencyField(para, fieldRtg, "CurrencyField", "135.467");
      ...
      doc.save(ResourceUtilities.newTestOutputFile("TestCreateField.odt"));

    } catch (Exception e) {
      Logger.getLogger(FieldTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  }
    ...
    try {
      TextDocument textDoc =
          TextDocument.loadDocument(
              ResourceUtilities.getTestResourceAsStream("TestCreateField.odt"));
  ...
  public void testRemoveField() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestRemoveField.odt"));
    } catch (Exception e) {
      Logger.getLogger(FieldTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  ...
  public void testSetFieldRectangle() {
    try {
      ...
      find.setRectangle(new FrameRectangle(2.25455, 0.2, 6, 2.5, SupportedLinearMeasure.IN));
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetFieldRectangle.odt"));
    } catch (Exception e) {
      Logger.getLogger(FieldTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  ...
  public void testSetAnchorType() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetFieldAnchorType.odt"));
    } catch (Exception e) {
      Logger.getLogger(FieldTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  ...
  public void testSetFormat() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetFormatValue.odt"));
    } catch (Exception e) {
      Logger.getLogger(FieldTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
