...
public class ButtonTest {
  private static final FrameRectangle btnRtg =
      new FrameRectangle(0.5, 2, 2.9433, 0.5567, SupportedLinearMeasure.IN);;
  ...
  public static void createForm() {
    try {
      ...
      doc.save(ResourceUtilities.newTestOutputFile("TestCreateButton.odt"));

    } catch (Exception e) {
      Logger.getLogger(ButtonTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  }
    ...
    try {
      TextDocument textDoc =
          TextDocument.loadDocument(
              ResourceUtilities.getTestResourceAsStream("TestCreateButton.odt"));
  ...
  public void testRemoveButton() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestRemoveButton.odt"));
    } catch (Exception e) {
      Logger.getLogger(ButtonTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  ...
  public void testSetButtonRectangle() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetButtonRectangle.odt"));
    } catch (Exception e) {
      Logger.getLogger(ButtonTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  ...
  public void testSetAnchorType() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetButtonAnchorType.odt"));
    } catch (Exception e) {
      Logger.getLogger(ButtonTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  ...
  public void testSetLabel() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetButtonLabel.odt"));
    } catch (Exception e) {
      Logger.getLogger(ButtonTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
