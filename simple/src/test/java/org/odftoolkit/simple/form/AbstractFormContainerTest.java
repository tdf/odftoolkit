...
public class AbstractFormContainerTest {
  static final FrameRectangle btnRtg =
  ...
  public static void createForm() {
    try {
      ...
      Logger.getLogger(AbstractFormContainerTest.class.getName()).log(Level.SEVERE, null, e);
    }
  }
    ...
    try {
      TextDocument textDoc =
          TextDocument.loadDocument(
              ResourceUtilities.getTestResourceAsStream("TestCreateForm.odt"));
  ...
  public void testRemoveForm() {
    try {
      ...
      while (iterator.hasNext()) {
        ...
        if (deleteForm.getFormName().equals("Form3")) break;
      }
      textDoc.removeForm(deleteForm);
      Assert.assertNotNull(textDoc.getFormByName("Form1"));
      Assert.assertNotNull(textDoc.getFormByName("Form2"));
      Assert.assertNull(textDoc.getFormByName("Form3"));
      textDoc.save(ResourceUtilities.newTestOutputFile("TestRemoveForm.odt"));
