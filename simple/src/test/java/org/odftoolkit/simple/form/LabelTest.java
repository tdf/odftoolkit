...
public class LabelTest {
  private static final FrameRectangle labelRtg =
      new FrameRectangle(0.5, 1.2553, 1.2, 0.5, SupportedLinearMeasure.IN);
  ...
  public static void createForm() {
    try {
      ...
      // label2
      Label label = (Label) form.createLabel(doc, labelRtg, "Label2", "Label2");
      ...
      doc.save(ResourceUtilities.newTestOutputFile("TestCreateLabel.odt"));

    } catch (Exception e) {
      Logger.getLogger(LabelTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  }
    ...
    try {
      TextDocument textDoc =
          TextDocument.loadDocument(
              ResourceUtilities.getTestResourceAsStream("TestCreateLabel.odt"));
  ...
  public void testRemoveLabel() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestRemoveLabel.odt"));
    } catch (Exception e) {
      Logger.getLogger(LabelTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  ...
  public void testSetLabelRectangle() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetLabelRectangle.odt"));
    } catch (Exception e) {
      Logger.getLogger(LabelTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  ...
  public void testSetAnchorType() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetLabelAnchorType.odt"));
    } catch (Exception e) {
      Logger.getLogger(LabelTest.class.getName()).log(Level.SEVERE, null, e);
    }
  }
  ...
  public void testSetLabel() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetLabelLabel.odt"));
    } catch (Exception e) {
      Logger.getLogger(LabelTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
