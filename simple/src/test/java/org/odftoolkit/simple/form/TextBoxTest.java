...
public class TextBoxTest {
  private static final FrameRectangle textBoxRtg =
      new FrameRectangle(0.5, 0.2846, 2.9432, 0.8567, SupportedLinearMeasure.IN);
  ...
  public static void createForm() {
    try {
      ...
      FormControl textBox = form.createTextBox(para, textBoxRtg, "TextBox2", "TextBox2", false);
      ...
      doc.save(ResourceUtilities.newTestOutputFile("TestCreateTextBox.odt"));
    ...
    try {
      TextDocument textDoc =
          TextDocument.loadDocument(
              ResourceUtilities.getTestResourceAsStream("TestCreateTextBox.odt"));
      ...
      while (iterator.hasNext()) {
        ...
        Assert.assertEquals("TextBox" + (count), textBox.getCurrentValue());
      }
    } catch (Exception e) {
      Logger.getLogger(TextBoxTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
  ...
  public void testRemoveCheckBox() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestRemoveTextBox.odt"));
    } catch (Exception e) {
      Logger.getLogger(TextBoxTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  ...
  public void testSetTextBoxRectangle() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetTextBoxRectangle.odt"));
    } catch (Exception e) {
      Logger.getLogger(TextBoxTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  ...
  public void testSetAnchorType() {
    try {
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetTextBoxAnchorType.odt"));
    } catch (Exception e) {
      Logger.getLogger(TextBoxTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
  ...
  public void testSetTextContent() {
    try {
      ...
      String textMultiLine =
          "This text box allow input multi-line content.\n This is the second line.";
      ...
      textDoc.save(ResourceUtilities.newTestOutputFile("TestSetTextBoxContent.odt"));
    } catch (Exception e) {
      Logger.getLogger(TextBoxTest.class.getName()).log(Level.SEVERE, null, e);
      Assert.fail();
    }
