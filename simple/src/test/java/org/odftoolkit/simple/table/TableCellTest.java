...
public class TableCellTest {
      ...
      odsdoc =
          (SpreadsheetDocument)
              SpreadsheetDocument.loadDocument(
                  ResourceUtilities.getTestResourceAsStream(SAMPLE_SPREADSHEET + ".ods"));
      odtdoc =
          (TextDocument)
              TextDocument.loadDocument(
                  ResourceUtilities.getTestResourceAsStream(SAMPLE_TEXT + ".odt"));
    } catch (Exception e) {
  ...
  public void testGetSetVertAlignment() {
    ...
    try {
      ...
      Table tbl = ods.getTableByName("Sheet1");
      Cell cell = tbl.getCellByPosition(0, 0);
      StyleTypeDefinitions.VerticalAlignmentType verticalAlignment =
  ...
  private void loadOutputSpreadsheet() {
    try {
      odsdoc =
          (SpreadsheetDocument)
              SpreadsheetDocument.loadDocument(
                  ResourceUtilities.getTestResourceAsStream(SAMPLE_SPREADSHEET + "Output.ods"));
    } catch (Exception e) {
      Logger.getLogger(TableCellTest.class.getName()).log(Level.SEVERE, e.getMessage(), e);
    }
  }
   ...
   * SIMPLE allows users to set if cell styles are inherited or not whenever a new cell is added to
  ...
  public void testGetStyleName() {
    try {
      odsstyle =
          (SpreadsheetDocument)
              SpreadsheetDocument.loadDocument(
                  ResourceUtilities.getTestResourceAsStream(SAMPLE_STYLE_SPREADSHEET + ".ods"));
  ...
  public void testSetGetFont() {
    try {
      ...
      if (!font11.equals(font1)) Assert.fail();
      ...
      if (!font22.equals(font2)) Assert.fail();
  ...
  public void testSetGetBorder() {
    try {
      ...
      Border border2 =
          new Border(Color.BLUE, 5, 1, 2, StyleTypeDefinitions.SupportedLinearMeasure.PT);
  ...
  /**
   * This test case check whether getNoteText and setNoteText work as expected. When test
   * getNoteText, the cell note may be null, a text paragraph with style or a text list. getNoteText
   * extracts the text content from them and return it as string. When test setNoteText, a text
   * paragraph will be created to show text content. text list and style is not supported.
   */
  @Test
  ...
  public void testGetSetImage() {
    try {
      ...
      doc =
          TextDocument.loadDocument(
              ResourceUtilities.getTestResourceAsStream("ImageCellTable.odt"));
  ...
  public void testCellParagraph() {
    String[] plainText = {
      ...
      "line" + System.getProperty("line.separator") + "break"
    };
  ...
  public void testCellSizeOptimal() {
    ...
    Font font2Base =
        new Font("Times New Roman", FontStyle.REGULAR, 13, Color.RED, TextLinePosition.REGULAR);
    Font font3Base =
        new Font("SimSun", FontStyle.REGULAR, 17, Color.BLUE, TextLinePosition.REGULAR);
    try {
  ...
  private void checkCellWidth(
      Cell cell, Font font, double expectedOptimalWidth, String contentStr) {
    try {
      if (font != null) {
        cell.setFont(font);
      }
  ...
  public void testSetHorizontalAlignment() {
    try {
      ...
      /**
       * The parameter can be "center", "end", "justify", "left", "right", or "start". Actually,
       * "left" will be interpreted as "start", while "right" will be interpreted as "end". If
       * argument is null, the explicit horizontal alignment setting is removed.
       */
  ...
  public void testSetBorder() {
    Border borderbase =
        new Border(new Color("#00ccff"), 0.0701, 0.0008, 0.0346, SupportedLinearMeasure.IN);
    try {
      SpreadsheetDocument doc =
          SpreadsheetDocument.loadDocument(ResourceUtilities.getTestResourceAsStream(filename));
  ...
  public void testIsTextWrapped() {
    Border borderbase =
        new Border(new Color("#00ccff"), 0.0701, 0.0008, 0.0346, SupportedLinearMeasure.CM);
    try {
      SpreadsheetDocument doc =
          SpreadsheetDocument.loadDocument(ResourceUtilities.getTestResourceAsStream(filename));
      Table table = doc.getTableByName("A");
