...
import org.openoffice.odf.dom.type.chart.OdfClassType;
import org.openoffice.odf.dom.type.OdfStyleName;


/**
 * ODF DOM Element implementation for element "<chart:grid>".
 */
...
{        
     ...
     */
    public void setChartClass( OdfClassType _aChartClass )
    {                    
        String aStringVal = OdfClassType.toString( _aChartClass );
        setOdfAttribute( OdfName.get( OdfNamespace.CHART, "class" ), aStringVal );
    }
