...
public enum OdfSourceType
{
    ...
    public static String toString( OdfSourceType _aEnum )
    {
        return _aEnum.toString();
    }

    public static OdfSourceType enumValueOf( String _aString )
    {
        for( OdfSourceType aIter : values() )
        {
