...
import org.odftoolkit.odfdom.dom.element.manifest.OdfFileEntryElement;

public class FileEntry extends OdfFileEntryElement{
	
    /**
	 * 
	 */
	private static final long serialVersionUID = 6445340008306517180L;
	
	// The following static attributes are used for JDK 5 media type detection
    ...
    public FileEntry(OdfFileDom ownerDoc) {
		super(ownerDoc);
...
//          mLog.fine("Using own mediatype handling as 'JavaBeans Activation Framework' not found: " +  e.getMessage());
    ...
    /**
     * Set the EncryptionData to the FileEntry
     * @param _checksumType
     * @param _checksum
     * @return	the new added EncryptionData
     */
    public EncryptionData setEncryptionData(String _checksumType, String _checksum) {
    	removeEncryptionData();
        return (EncryptionData)createEncryptionDataElement(_checksumType, _checksum);
    }

    /**
     * Get the EncryptionData of this FileEntry
     * @return EncryptionData
     */
    public EncryptionData getEncryptionData() {
    	return OdfElement.findFirstChildNode(EncryptionData.class, this);
    }
    
    /**
     * remove the <manifest:encryption-data> child element from FileEntry
     */
    public void removeEncryptionData(){
    	EncryptionData data = OdfElement.findFirstChildNode(EncryptionData.class, this);
        while (data != null) {
        	EncryptionData nextData = OdfElement.findNextChildNode(EncryptionData.class, data);
