...
/**
 * ODF DOM Element implementation for element "<text:table-index>".
 */
public abstract class OdfTableIndexElement extends OdfStylableElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.TEXT, "table-index" );

    public OdfTableIndexElement( OdfFileDom _aOwnerDoc )
    {
    ...
    /**
    * Create child element "text:table-index-source".
    */
    public OdfTableIndexSourceElement createTableIndexSourceElement()
    {
        OdfTableIndexSourceElement  _nTableIndexSource = ((OdfFileDom)this.ownerDocument).createOdfElement(OdfTableIndexSourceElement.class);
        this.appendChild( _nTableIndexSource);
        return  _nTableIndexSource;
    }                   
