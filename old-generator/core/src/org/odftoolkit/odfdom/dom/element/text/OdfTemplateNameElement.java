...
import org.odftoolkit.odfdom.dom.type.text.OdfTemplateNameDisplayType;


/**
 * ODF DOM Element implementation for element "<text:template-name>".
 */
...
{        
     ...
     */
    public OdfTemplateNameDisplayType getDisplay()
    {                    
        String aStringVal = getOdfAttribute( OdfName.get( OdfNamespace.TEXT, "display" ) );
        return OdfTemplateNameDisplayType.enumValueOf( aStringVal);
    }

    /**
     * Set value of attribute "text:display".
     */
    public void setDisplay( OdfTemplateNameDisplayType _aDisplay )
    {                    
        String aStringVal = OdfTemplateNameDisplayType.toString( _aDisplay );
