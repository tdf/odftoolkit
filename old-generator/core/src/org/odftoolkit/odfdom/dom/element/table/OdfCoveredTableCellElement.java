...
/**
 * ODF DOM Element implementation for element "<table:covered-table-cell>".
 */
...
{        
    ...
    */
    public OdfCellRangeSourceElement createCellRangeSourceElement(String   _aName, Integer   _aLastColumnSpanned, Integer   _aLastRowSpanned, String   _aHref)
    {
        OdfCellRangeSourceElement  _nCellRangeSource = ((OdfFileDom)this.ownerDocument).createOdfElement(OdfCellRangeSourceElement.class);
        _nCellRangeSource.setName( _aName);
        _nCellRangeSource.setLastColumnSpanned( _aLastColumnSpanned);
        _nCellRangeSource.setLastRowSpanned( _aLastRowSpanned);
        _nCellRangeSource.setHref( _aHref);
        this.appendChild( _nCellRangeSource);
        return  _nCellRangeSource;      
    }
    ...
    */
    ...
    {
        OdfDetectiveElement  _nDetective = ((OdfFileDom)this.ownerDocument).createOdfElement(OdfDetectiveElement.class);
        this.appendChild( _nDetective);
        return  _nDetective;
    }                   
