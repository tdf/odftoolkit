...
{        
    ...
    /**
     * Get value of attribute "db:related-column-name".
     */
    public String getRelatedColumnName()
    {
        return getOdfAttribute( OdfName.get( OdfNamespace.DB, "related-column-name" ) );
    }

    /**
     * Set value of attribute "db:related-column-name".
     */
    public void setRelatedColumnName( String _aRelatedColumnName )
    {
        setOdfAttribute( OdfName.get( OdfNamespace.DB, "related-column-name" ), _aRelatedColumnName );
    }
