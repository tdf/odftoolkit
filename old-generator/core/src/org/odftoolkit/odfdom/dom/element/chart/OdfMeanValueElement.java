...
/**
 * ODF DOM Element implementation for element "<chart:mean-value>".
 */
public abstract class OdfMeanValueElement extends OdfStylableElement
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = 3688682904108700145L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.CHART, "mean-value" );

    public OdfMeanValueElement( OdfFileDom _aOwnerDoc )
    {
