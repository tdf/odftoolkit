...
/**
 * ODF DOM Element implementation for element "<text:index-entry-span>".
 */
public abstract class OdfIndexEntrySpanElement extends OdfStylableElement
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = -3773545741508734770L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.TEXT, "index-entry-span" );

    public OdfIndexEntrySpanElement( OdfFileDom _aOwnerDoc )
    {
