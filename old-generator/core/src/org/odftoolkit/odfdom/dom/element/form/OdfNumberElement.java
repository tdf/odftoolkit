...
/**
 * ODF DOM Element implementation for element "<form:number>".
 */
...
{        
     ...
     */
    public void setCurrentValue( Double _aCurrentValue )
    {                    
        String aStringVal = Double.toString( _aCurrentValue );
     ...
     */
    public void setMinValue( Double _aMinValue )
    {                    
        String aStringVal = Double.toString( _aMinValue );
     ...
     */
    public void setMaxValue( Double _aMaxValue )
    {                    
        String aStringVal = Double.toString( _aMaxValue );
