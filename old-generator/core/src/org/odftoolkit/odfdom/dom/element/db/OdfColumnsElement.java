...
/**
 * ODF DOM Element implementation for element "<db:columns>".
 */
public abstract class OdfColumnsElement extends OdfElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.DB, "columns" );
