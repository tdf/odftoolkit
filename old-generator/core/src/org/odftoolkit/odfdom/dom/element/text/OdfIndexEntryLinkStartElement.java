...
/**
 * ODF DOM Element implementation for element "<text:index-entry-link-start>".
 */
public abstract class OdfIndexEntryLinkStartElement extends OdfStylableElement
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = -4857133061719335996L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.TEXT, "index-entry-link-start" );

    public OdfIndexEntryLinkStartElement( OdfFileDom _aOwnerDoc )
    {
