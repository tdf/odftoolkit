...
/**
 * ODF DOM Element implementation for element "<text:table-of-content>".
 */
...
{        
    ...
    public OdfTableOfContentElement( OdfFileDom _aOwnerDoc )
    {
    ...
    /**
    * Create child element "text:table-of-content-source".
    */
    public OdfTableOfContentSourceElement createTableOfContentSourceElement()
    {
        OdfTableOfContentSourceElement  _nTableOfContentSource = ((OdfFileDom)this.ownerDocument).createOdfElement(OdfTableOfContentSourceElement.class);
        this.appendChild( _nTableOfContentSource);
        return  _nTableOfContentSource;
    }                   
