...
/**
 * ODF DOM Element implementation for element "<text:section-source>".
 */
...
{        
    ...
    /**
     * Get value of attribute "text:section-name".
     */
    ...
    /**
     * Set value of attribute "text:section-name".
     */
    public void setSectionName( String _aSectionName )
    {
        setOdfAttribute( OdfName.get( OdfNamespace.TEXT, "section-name" ), _aSectionName );
    }

    /**
     * Get value of attribute "text:filter-name".
     */
    ...
    /**
     * Set value of attribute "text:filter-name".
     */
    public void setFilterName( String _aFilterName )
    {
        setOdfAttribute( OdfName.get( OdfNamespace.TEXT, "filter-name" ), _aFilterName );
    }
