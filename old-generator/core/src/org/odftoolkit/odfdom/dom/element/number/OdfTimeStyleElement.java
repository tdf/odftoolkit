...
{        
     ...
     */
    public void setTruncateOnOverflow( Boolean _aTruncateOnOverflow )
    {                    
        String aStringVal = OdfBoolean.toString( _aTruncateOnOverflow );
        setOdfAttribute( OdfName.get( OdfNamespace.NUMBER, "truncate-on-overflow" ), aStringVal );
    }
