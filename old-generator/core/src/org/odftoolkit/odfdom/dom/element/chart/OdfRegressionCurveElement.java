...
/**
 * ODF DOM Element implementation for element "<chart:regression-curve>".
 */
public abstract class OdfRegressionCurveElement extends OdfStylableElement
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = -6091073538538541481L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.CHART, "regression-curve" );

    public OdfRegressionCurveElement( OdfFileDom _aOwnerDoc )
    {
