...
/**
 * ODF DOM Element implementation for element "<table:first-column>".
 */
public abstract class OdfFirstColumnElement extends OdfStylableElement
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = -1208097317189055399L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.TABLE, "first-column" );

    public OdfFirstColumnElement( OdfFileDom _aOwnerDoc )
    {
