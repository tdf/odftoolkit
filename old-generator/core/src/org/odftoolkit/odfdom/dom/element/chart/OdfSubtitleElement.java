...
/**
 * ODF DOM Element implementation for element "<chart:subtitle>".
 */
public abstract class OdfSubtitleElement extends OdfStylableElement
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = -153653872728935475L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.CHART, "subtitle" );

    public OdfSubtitleElement( OdfFileDom _aOwnerDoc )
    {
