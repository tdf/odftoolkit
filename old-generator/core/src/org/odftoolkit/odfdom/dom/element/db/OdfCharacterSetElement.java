...
/**
 * ODF DOM Element implementation for element "<db:character-set>".
 */
...
{        
    ...
    /**
     * Set value of attribute "db:encoding".
     */
    public void setEncoding( String _aEncoding )
    {
        setOdfAttribute( OdfName.get( OdfNamespace.DB, "encoding" ), _aEncoding );
    }
