...
/**
 * ODF DOM Element implementation for element "<presentation:hide-text>".
 */
public abstract class OdfHideTextElement extends OdfElement
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = -94601599041526936L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.PRESENTATION, "hide-text" );

    public OdfHideTextElement( OdfFileDom _aOwnerDoc )
    {
