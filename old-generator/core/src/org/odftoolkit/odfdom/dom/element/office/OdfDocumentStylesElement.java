...
/**
 * ODF DOM Element implementation for element "<office:document-styles>".
 */
public abstract class OdfDocumentStylesElement extends OdfElement
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = 868454782313549503L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.OFFICE, "document-styles" );

    public OdfDocumentStylesElement( OdfFileDom _aOwnerDoc )
    {
