...
{        
    ...
    /**
     * Get value of attribute "text:date-adjust".
     */
    public Duration getDateAdjust()
    {                    
        String aStringVal = getOdfAttribute( OdfName.get( OdfNamespace.TEXT, "date-adjust" ) );
        return OdfDuration.valueOf( aStringVal);
    }

    /**
     * Set value of attribute "text:date-adjust".
     */
    public void setDateAdjust( Duration _aDateAdjust )
    {                    
        String aStringVal = OdfDuration.toString( _aDateAdjust );
        setOdfAttribute( OdfName.get( OdfNamespace.TEXT, "date-adjust" ), aStringVal );
    }
