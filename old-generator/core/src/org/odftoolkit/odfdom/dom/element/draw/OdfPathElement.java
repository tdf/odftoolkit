...
/**
 * ODF DOM Element implementation for element "<draw:path>".
 */
public abstract class OdfPathElement extends OdfShapeElementBase
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = 7247119159481016223L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.DRAW, "path" );

    public OdfPathElement( OdfFileDom _aOwnerDoc )
    {
