...
/**
 * ODF DOM Element implementation for element "<text:object-index-entry-template>".
 */
public abstract class OdfObjectIndexEntryTemplateElement extends OdfStylableElement
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = 2001556880079342791L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.TEXT, "object-index-entry-template" );

    public OdfObjectIndexEntryTemplateElement( OdfFileDom _aOwnerDoc )
    {
