...
/**
 * ODF DOM Element implementation for element "<text:image-count>".
 */
public abstract class OdfImageCountElement extends OdfElement
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = -1239303099612652203L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.TEXT, "image-count" );

    public OdfImageCountElement( OdfFileDom _aOwnerDoc )
    {
