...
{        
    ...
    */
    ...
    {
        OdfHeaderLeftElement  _nHeaderLeft = ((OdfFileDom)this.ownerDocument).createOdfElement(OdfHeaderLeftElement.class);
        this.appendChild( _nHeaderLeft);
        return  _nHeaderLeft;
    }                   
    ...
    */
    ...
    {
        OdfFooterLeftElement  _nFooterLeft = ((OdfFileDom)this.ownerDocument).createOdfElement(OdfFooterLeftElement.class);
        this.appendChild( _nFooterLeft);
        return  _nFooterLeft;
    }                   
