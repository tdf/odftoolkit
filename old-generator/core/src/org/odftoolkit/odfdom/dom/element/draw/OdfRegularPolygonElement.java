...
/**
 * ODF DOM Element implementation for element "<draw:regular-polygon>".
 */
...
{        
     ...
     */
    public void init(Boolean _aConcave, Double _aSharpness, Integer _aCorners)
    {
        setConcave( _aConcave );
        setSharpness( _aSharpness );
        setCorners( _aCorners );
    }
    ...
    {                    
        String aStringVal = getOdfAttribute( OdfName.get( OdfNamespace.DRAW, "concave" ) );
     ...
     */
    public void setConcave( Boolean _aConcave )
    {                    
        String aStringVal = OdfBoolean.toString( _aConcave );
        setOdfAttribute( OdfName.get( OdfNamespace.DRAW, "concave" ), aStringVal );
    }

    /**
     * Get value of attribute "draw:sharpness".
     */
    public Double getSharpness()
    {                    
        String aStringVal = getOdfAttribute( OdfName.get( OdfNamespace.DRAW, "sharpness" ) );
        return OdfPercent.valueOf( aStringVal);
    }

    /**
     * Set value of attribute "draw:sharpness".
     */
    public void setSharpness( Double _aSharpness )
    {                    
        String aStringVal = OdfPercent.toString( _aSharpness );
        setOdfAttribute( OdfName.get( OdfNamespace.DRAW, "sharpness" ), aStringVal );
    }

    /**
     * Get value of attribute "draw:corners".
     */
    public Integer getCorners()
    {                    
        String aStringVal = getOdfAttribute( OdfName.get( OdfNamespace.DRAW, "corners" ) );
        return OdfPositiveInteger.valueOf( aStringVal);
    }

    /**
     * Set value of attribute "draw:corners".
     */
    public void setCorners( Integer _aCorners )
    {                    
        String aStringVal = OdfPositiveInteger.toString( _aCorners );
        setOdfAttribute( OdfName.get( OdfNamespace.DRAW, "corners" ), aStringVal );
    }
