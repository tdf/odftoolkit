...
/**
 * ODF DOM Element implementation for element "<table:database-source-table>".
 */
...
{        
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4279588846964068550L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.TABLE, "database-source-table" );

    public OdfDatabaseSourceTableElement( OdfFileDom _aOwnerDoc )
    {
     ...
     */
    public void init(String _aDatabaseName, String _aDatabaseTableName)
    {
        setDatabaseName( _aDatabaseName );
        setDatabaseTableName( _aDatabaseTableName );
    }
    ...
    /**
     * Get value of attribute "table:database-table-name".
     */
    ...
    /**
     * Set value of attribute "table:database-table-name".
     */
    public void setDatabaseTableName( String _aDatabaseTableName )
    {
        setOdfAttribute( OdfName.get( OdfNamespace.TABLE, "database-table-name" ), _aDatabaseTableName );
    }
