...
/**
 * ODF DOM Element implementation for element "<draw:rect>".
 */
public abstract class OdfRectElement extends OdfShapeElementBase
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = -7538453261239998955L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.DRAW, "rect" );

    public OdfRectElement( OdfFileDom _aOwnerDoc )
    {
