...
{        
    ...
    */
    ...
    /**
    * Create child element "draw:enhanced-geometry".
    */
    public OdfEnhancedGeometryElement createEnhancedGeometryElement()
    {
        OdfEnhancedGeometryElement  _nEnhancedGeometry = ((OdfFileDom)this.ownerDocument).createOdfElement(OdfEnhancedGeometryElement.class);
        this.appendChild( _nEnhancedGeometry);
        return  _nEnhancedGeometry;
    }                   
