...
/**
 * ODF DOM Element implementation for element "<dr3d:sphere>".
 */
public abstract class OdfSphereElement extends OdfStyleablePresentationElement
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = 2816322614331697960L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.DR3D, "sphere" );

    public OdfSphereElement( OdfFileDom _aOwnerDoc )
    {
    ...
    /**
     * Get value of attribute "dr3d:center".
     */
    public String getCenter()
    {
        return getOdfAttribute( OdfName.get( OdfNamespace.DR3D, "center" ) );
    }

    /**
     * Set value of attribute "dr3d:center".
     */
    public void setCenter( String _aCenter )
    {
        setOdfAttribute( OdfName.get( OdfNamespace.DR3D, "center" ), _aCenter );
    }

    /**
     * Get value of attribute "dr3d:size".
     */
    public String getSize()
    {
        return getOdfAttribute( OdfName.get( OdfNamespace.DR3D, "size" ) );
    }

    /**
     * Set value of attribute "dr3d:size".
     */
    public void setSize( String _aSize )
    {
        setOdfAttribute( OdfName.get( OdfNamespace.DR3D, "size" ), _aSize );
    }
