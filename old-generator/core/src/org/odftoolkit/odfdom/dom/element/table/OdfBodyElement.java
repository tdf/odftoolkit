...
/**
 * ODF DOM Element implementation for element "<table:body>".
 */
public abstract class OdfBodyElement extends OdfStylableElement
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = -8332489631566267671L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.TABLE, "body" );
