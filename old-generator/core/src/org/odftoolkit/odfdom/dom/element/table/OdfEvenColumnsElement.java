...
/**
 * ODF DOM Element implementation for element "<table:even-columns>".
 */
public abstract class OdfEvenColumnsElement extends OdfStylableElement
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = 5218792033955864676L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.TABLE, "even-columns" );

    public OdfEvenColumnsElement( OdfFileDom _aOwnerDoc )
    {
