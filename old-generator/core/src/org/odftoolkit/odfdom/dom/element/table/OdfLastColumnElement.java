...
/**
 * ODF DOM Element implementation for element "<table:last-column>".
 */
public abstract class OdfLastColumnElement extends OdfStylableElement
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = 1119970582224990907L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.TABLE, "last-column" );

    public OdfLastColumnElement( OdfFileDom _aOwnerDoc )
    {
