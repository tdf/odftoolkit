...
/**
 * ODF DOM Element implementation for element "<table:odd-columns>".
 */
public abstract class OdfOddColumnsElement extends OdfStylableElement
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = -2491769521087151052L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.TABLE, "odd-columns" );

    public OdfOddColumnsElement( OdfFileDom _aOwnerDoc )
    {
