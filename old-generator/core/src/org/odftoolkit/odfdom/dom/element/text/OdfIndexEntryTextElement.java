...
/**
 * ODF DOM Element implementation for element "<text:index-entry-text>".
 */
public abstract class OdfIndexEntryTextElement extends OdfStylableElement
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = 2404955065103087694L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.TEXT, "index-entry-text" );

    public OdfIndexEntryTextElement( OdfFileDom _aOwnerDoc )
    {
