...
/**
 * ODF DOM Element implementation for element "<table:last-row>".
 */
public abstract class OdfLastRowElement extends OdfStylableElement
{        
    /**
	 * 
	 */
	private static final long serialVersionUID = 8580421265662133747L;
	public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.TABLE, "last-row" );

    public OdfLastRowElement( OdfFileDom _aOwnerDoc )
    {
