...
public enum OdfMessageType
{
    ...
    public static String toString( OdfMessageType _aEnum )
    {
        return _aEnum.toString();
    }

    public static OdfMessageType enumValueOf( String _aString )
    {
        for( OdfMessageType aIter : values() )
        {
