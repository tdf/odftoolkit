...
public enum OdfDrawAspectType
{
    ...
    OdfDrawAspectType( String _aValue )
    {
        m_aValue = _aValue;
    }
    ...
    public static String toString( OdfDrawAspectType _aEnum )
    {
        return _aEnum.toString();
    }

    public static OdfDrawAspectType enumValueOf( String _aString )
    {
        for( OdfDrawAspectType aIter : values() )
        {
