...
public enum OdfAxisLabelPositionType
{
    ...
    OdfAxisLabelPositionType( String _aValue )
    {
        m_aValue = _aValue;
    }
    ...
    public static String toString( OdfAxisLabelPositionType _aEnum )
    {
        return _aEnum.toString();
    }

    public static OdfAxisLabelPositionType enumValueOf( String _aString )
    {
        for( OdfAxisLabelPositionType aIter : values() )
        {
