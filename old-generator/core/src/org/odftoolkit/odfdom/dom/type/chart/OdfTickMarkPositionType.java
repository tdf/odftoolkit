...
public enum OdfTickMarkPositionType
{
    ...
    OdfTickMarkPositionType( String _aValue )
    {
        m_aValue = _aValue;
    }
    ...
    public static String toString( OdfTickMarkPositionType _aEnum )
    {
        return _aEnum.toString();
    }

    public static OdfTickMarkPositionType enumValueOf( String _aString )
    {
        for( OdfTickMarkPositionType aIter : values() )
        {
