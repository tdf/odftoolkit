...
public enum OdfEscapeDirectionType
{
    ...
    OdfEscapeDirectionType( String _aValue )
    {
        m_aValue = _aValue;
    }
    ...
    public static String toString( OdfEscapeDirectionType _aEnum )
    {
        return _aEnum.toString();
    }

    public static OdfEscapeDirectionType enumValueOf( String _aString )
    {
        for( OdfEscapeDirectionType aIter : values() )
        {
