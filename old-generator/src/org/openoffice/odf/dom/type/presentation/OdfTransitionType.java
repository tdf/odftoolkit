...
public enum OdfTransitionType
{
    ...
    OdfTransitionType( String _aValue )
    {
        m_aValue = _aValue;
    }
    ...
    public static String toString( OdfTransitionType _aEnum )
    {
        return _aEnum.toString();
    }

    public static OdfTransitionType enumValueOf( String _aString )
    {
        for( OdfTransitionType aIter : values() )
        {
