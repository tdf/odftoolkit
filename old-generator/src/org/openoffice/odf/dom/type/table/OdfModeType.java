...
public enum OdfModeType
{
    ...
    public static String toString( OdfModeType _aEnum )
    {
        return _aEnum.toString();
    }

    public static OdfModeType enumValueOf( String _aString )
    {
        for( OdfModeType aIter : values() )
        {
