...
{        
     ...
     */
    public void setPrefix( String _aPrefix )
    {
        setOdfAttribute( OdfName.get( OdfNamespace.TEXT, "prefix" ), _aPrefix );
    }
     ...
     */
    public void setSuffix( String _aSuffix )
    {
        setOdfAttribute( OdfName.get( OdfNamespace.TEXT, "suffix" ), _aSuffix );
    }
