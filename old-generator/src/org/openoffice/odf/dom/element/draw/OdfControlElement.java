...
{        
     ...
     */
    public void init(String _aControl)
    {
        setControl( _aControl );
    }
    ...
    {                    
        String aStringVal = getOdfAttribute( OdfName.get( OdfNamespace.DRAW, "control" ) );
     ...
     */
    public void setControl( String _aControl )
    {                    
        String aStringVal = OdfId.toString( _aControl );
        setOdfAttribute( OdfName.get( OdfNamespace.DRAW, "control" ), aStringVal );
    }
