...
{        
    ...
    /**
     * Get value of attribute "xlink:title".
     */
    public String getTitle()
    {
        return getOdfAttribute( OdfName.get( OdfNamespace.XLINK, "title" ) );
    }

    /**
     * Set value of attribute "xlink:title".
     */
    public void setTitle( String _aTitle )
    {
        setOdfAttribute( OdfName.get( OdfNamespace.XLINK, "title" ), _aTitle );
    }

    /**
     * Get value of attribute "meta:date".
     */
    public XMLGregorianCalendar getDate()
    {                    
        String aStringVal = getOdfAttribute( OdfName.get( OdfNamespace.META, "date" ) );
        return OdfDate.valueOf( aStringVal);
    }

    /**
     * Set value of attribute "meta:date".
     */
    public void setDate( XMLGregorianCalendar _aDate )
    {                    
        String aStringVal = OdfDate.toString( _aDate );
        setOdfAttribute( OdfName.get( OdfNamespace.META, "date" ), aStringVal );
    }
