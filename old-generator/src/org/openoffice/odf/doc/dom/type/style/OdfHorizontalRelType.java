...
{
              PARAGRAPH( "paragraph" ), CHAR( "char" ), PAGE_START_MARGIN( "page-start-margin" ), FRAME_CONTENT( "frame-content" ), FRAME_START_MARGIN( "frame-start-margin" ), PARAGRAPH_CONTENT( "paragraph-content" ), PAGE_CONTENT( "page-content" ), FRAME_END_MARGIN( "frame-end-margin" ), FRAME( "frame" ), PAGE_END_MARGIN( "page-end-margin" ), PAGE( "page" ), PARAGRAPH_START_MARGIN( "paragraph-start-margin" ), PARAGRAPH_END_MARGIN( "paragraph-end-margin" );
