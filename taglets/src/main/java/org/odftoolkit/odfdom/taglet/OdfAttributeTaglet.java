 ...
 * variable settings to <code>JAVA_DOC_BASE/doc-files/OpenDocument-v1.2-part1.html#attribute-xml_id
 * </code> .
 */
public class OdfAttributeTaglet implements Taglet {
  ...
  private static final String ODF_SPEC_PART1_PATH =
      "../../../../../../doc-files/OpenDocument-v1.2-part1.html";
  private static final String ODF_SPEC_PART3_PATH =
      "../../../../../doc-files/OpenDocument-v1.2-part3.html";
  ...
  /**
   * This method should not be called since arrays of inline tags do not exist. Method should be
   * used to convert this inline tag to a string.
   *
   * @param tags the array of <code>Tag</code>s representing of this custom tag.
   * @return Nothing is returned, instead an <code>UnsupportedOperationException</code> is being
   *     thrown.
   */
