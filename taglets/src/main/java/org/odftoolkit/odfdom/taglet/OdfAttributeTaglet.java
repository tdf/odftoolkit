 ...
 *
 *  For example the taglet <code>{@odf.attribute xml:id}</code> would be resolved without variable settings to
 *  <code>JAVA_DOC_BASE/doc-files/OpenDocument-v1.2-cd05-part1.html#attribute-xml_id</code>.
 */
public class OdfAttributeTaglet implements Taglet {
	...
	private static String mOdfSpecPath = null;
	    ...
	    public String toString(Tag tag) {
	           ...
	           String fragmentIdentifier = "attribute-" + tag.text().substring(0, pos) + "_" + tag.text().substring(pos + 1);
