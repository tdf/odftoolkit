...
public class StyleExamplesTest {
  ...
  public void testSetValue() throws Exception {
    ...
    // We need an exception from the setValue method! Otherwise we don't know that an empty
    // attribute node has to be removed
    fail(
        "An IllegalArgumentException has to be thrown for invalid attributes so the attribute node can be removed afterwards.");
  }
}
