...
public class XPathTest {
    ...
    try {
      OdfPresentationDocument odpWithSlides =
          OdfPresentationDocument.loadDocument(
              ResourceUtilities.getAbsoluteInputPath(SOURCE_FILE_1));
  ...
  public void testCopyForeignSlide() {
    try {
      ...
      OdfPresentationDocument sourceodp =
          OdfPresentationDocument.loadDocument(
              ResourceUtilities.getAbsoluteInputPath(SOURCE_FILE_2));
  ...
  public void testXPathDuplicatePrefixForForeignNamespace() throws Exception {
    try {
      ...
      OdfDocument odfDoc =
          OdfDocument.loadDocument(ResourceUtilities.getAbsoluteInputPath(SOURCE_FILE_3));
