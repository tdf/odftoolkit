...
public class DataTypeTest {
  ...
  public void testCellRangeAddress() {
    ...
    CellRangeAddress cellRangeAddress2 = new CellRangeAddress("$(first).8:$(second).19");
  ...
  public void testStyle() {
    ...
    Assert.assertEquals(styleRefs.getStyleNameRefList().get(2).toString(), styleName2.toString());
