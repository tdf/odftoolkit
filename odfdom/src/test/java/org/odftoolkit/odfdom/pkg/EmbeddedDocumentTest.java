...
public class EmbeddedDocumentTest {
  ...
  public void testEmbedEmbeddedDocument() {
    try {
      OdfDocument doc =
          OdfDocument.loadDocument(ResourceUtilities.getAbsolutePath(TEST_FILE_EMBEDDED));
      ...
      saveDoc.close();
      saveDoc =
          OdfDocument.loadDocument(ResourceUtilities.getAbsolutePath(TEST_FILE_EMBEDDED_SAVE_OUT));
  ...
  public void testembeddedDocumentsLocatedSideBySide() {
    try {
      ...
      OdfDocument testLoad =
          OdfDocument.loadDocument(TEST_FILE_FOLDER + TEST_FILE_EMBEDDED_SIDEBYSIDE_SAVE_OUT);
  ...
  public void testembeddedDocumentWithSubPath() {
    try {
      ...
      OdfDocument testLoad =
          OdfDocument.loadDocument(TEST_FILE_FOLDER + TEST_FILE_EMBEDDED_INCLUDED_SAVE_OUT);
      OdfFileEntry imageEntry =
          testLoad
              .getPackage()
              .getFileEntry(OdfPackage.OdfFile.IMAGE_DIRECTORY.getPath() + SLASH + TEST_PIC);
  ...
  public void testSaveEmbeddedDocument() {
    try {
      ...
      for (String childDocPath : embeddedDocs.keySet()) {
        ...
        OdfDocument embeddedDoc =
            OdfDocument.loadDocument(ResourceUtilities.getAbsolutePath(embedFileName));
  ...
  public void testEmbedModifiedEmbeddedDocument() {
    try {
      ...
      saveDoc =
          OdfDocument.loadDocument(ResourceUtilities.getAbsolutePath(TEST_FILE_MODIFIED_EMBEDDED));
      ...
      OdfDocument standaloneDoc =
          OdfDocument.loadDocument(
              ResourceUtilities.getAbsolutePath(TEST_FILE_MODIFIED_EMBEDDED_SAVE_STANDALONE));
  ...
  public void testRemoveEmbeddedDocument() {
    try {
      ...
      doc =
          OdfDocument.loadDocument(
              ResourceUtilities.getAbsolutePath(TEST_FILE_REMOVE_EMBEDDED_SAVE_OUT));
