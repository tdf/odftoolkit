...
public class MetaDocumentStatisticTest {
  ...
  public void setUp() throws Exception {
    doc =
        (OdfTextDocument)
            OdfTextDocument.loadDocument(ResourceUtilities.getTestResourceAsStream(filename));
    ...
    if (stat == null) {
      ...
      MetaDocumentStatisticElement statEle =
          meta.getOfficeMetaElement().newMetaDocumentStatisticElement();
  ...
  public void testGetNonWhitespaceCharacterCount() {
    ...
    Assert.assertEquals(nonWhitespaceCharacterCount, stat.getNonWhitespaceCharacterCount());
  }
