...
public class OfficeMetaTest {
  ...
  public void setUp() throws Exception {
    ...
    if (!newMetaFile.exists()) {
      doc =
          (OdfTextDocument)
              OdfTextDocument.loadDocument(ResourceUtilities.getAbsoluteInputPath(filename));
    } else {
    ...
    doc =
        (OdfTextDocument)
            OdfTextDocument.loadDocument(
                ResourceUtilities.getAbsoluteOutputPath("EmptyDocForMetaTest.odt"));
    metadom = doc.getMetaDom();
    fMetadata = new OdfOfficeMeta(metadom);
  ...
  public void testReadDocumentMeta() throws Exception {
    ...
    textDoc =
        (OdfTextDocument)
            OdfTextDocument.loadDocument(
                ResourceUtilities.getAbsoluteOutputPath("DocForMetaTest.odt"));
