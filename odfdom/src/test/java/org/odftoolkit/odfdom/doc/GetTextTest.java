...
public class GetTextTest {
  ...
  public void testToString() {
    ...
    try {
      OdfDocument doc =
          OdfDocument.loadDocument(ResourceUtilities.getAbsoluteInputPath("text-extract.odt"));
      OdfEditableTextExtractor extractor =
          OdfEditableTextExtractor.newOdfEditableTextExtractor(doc);
