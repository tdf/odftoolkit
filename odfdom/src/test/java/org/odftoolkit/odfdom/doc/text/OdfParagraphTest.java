...
public class OdfParagraphTest {
  ...
  public void testAddContentWhitespace() {
    ...
    Assert.assertEquals(OdfDocumentNamespace.TEXT.getUri(), node.getNamespaceURI());
  ...
  public void testAddStyledSpan() {
    ...
    Node node;
    Assert.assertNotNull(instance);
    instance.addStyledContent(styleName, content).addStyledSpan(spanStyleName, spanContent);
  ...
  public void testAddStyledSpanWhitespace() {
    ...
    Assert.assertNotNull(instance);
    instance
        .addStyledContent(styleName, content)
        .addStyledSpanWhitespace(spanStyleName, spanContent);
    ...
    Assert.assertEquals("3", element.getAttributeNS(OdfDocumentNamespace.TEXT.getUri(), "c"));
