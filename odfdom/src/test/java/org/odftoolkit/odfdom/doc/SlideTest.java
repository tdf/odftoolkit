...
public class SlideTest {
    ...
    try {
      doc =
          OdfPresentationDocument.loadDocument(
              ResourceUtilities.getAbsolutePath(TEST_PRESENTATION_FILE_MAIN));
  ...
  public void testDeleteSlide() {
    try {
      ...
      doc2 =
          OdfPresentationDocument.loadDocument(
              ResourceUtilities.getAbsolutePath(TEST_PRESENTATION_FILE_ANOTHER));
  ...
  public void testCopyThreeDoc() {
    try {
      ...
      OdfPresentationDocument testdoc1 =
          OdfPresentationDocument.loadDocument(
              ResourceUtilities.getAbsolutePath(TEST_PRESENTATION_DOCUMENT1));
      // testdoc1 contain "dp1" for draw page style
      OdfPresentationDocument testdoc2 =
          OdfPresentationDocument.loadDocument(
              ResourceUtilities.getAbsolutePath(TEST_PRESENTATION_DOCUMENT2));
      // testdoc1 contain "dp1" for draw page style
      OdfPresentationDocument testdoc3 =
          OdfPresentationDocument.loadDocument(
              ResourceUtilities.getAbsolutePath(TEST_PRESENTATION_DOCUMENT3));
