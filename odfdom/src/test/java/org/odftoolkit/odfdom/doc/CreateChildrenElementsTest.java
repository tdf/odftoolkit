...
public class CreateChildrenElementsTest {
    ...
    try {
      OdfPresentationDocument odfdoc =
          (OdfPresentationDocument)
              OdfDocument.loadDocument(ResourceUtilities.getAbsolutePath("presentation.odp"));
  ...
  public void testCreatChildrenForChart() {
    try {
      ...
      OdfFileDom contentDom =
          OdfDocument.loadDocument(ResourceUtilities.getAbsolutePath("empty.odt")).getContentDom();
      ...
      contentDom
          .getDocument()
          .save(ResourceUtilities.newTestOutputFile("CreatChildrenForChartTest.odt"));
  ...
  public void testCreateChildrenForTable() {
    try {
      ...
      contentDom
          .getDocument()
          .save(ResourceUtilities.newTestOutputFile("CreateChildrenForTableTest.odt"));
  ...
  public void testCreatChildrenForText() {
    try {
      ...
      contentDom
          .getDocument()
          .save(ResourceUtilities.newTestOutputFile("CreatChildrenForTextTable.odt"));
  ...
  public void testCreatChildrenForGraphic() {
    try {
      ...
      contentDom
          .getDocument()
          .save(ResourceUtilities.newTestOutputFile("CreatChildrenForGraphic.odg"));
  ...
  public void testCreatChildrenForEmbeddedDoc() {
    try {
      ...
      contentDom
          .getDocument()
          .save(ResourceUtilities.newTestOutputFile("CreatChildrenForEmbedded.odt"));
  ...
  public void testCreatChildrenForSpreadSheet() {
    try {
      ...
      contentDom
          .getDocument()
          .save(ResourceUtilities.newTestOutputFile("CreatChildrenForSpreadsheet.ods"));
  ...
  public void testCreatChildrenForForm() {
    try {
      ...
      doc.getContentDom()
          .getDocument()
          .save(ResourceUtilities.newTestOutputFile("CreatChildrenForForm.odt"));
