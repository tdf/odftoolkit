...
public class GraphicsTemplateTest {
  ...
  public void testLoadingAGraphicsTemplate() throws Exception {
    OdfDocument document =
        OdfDocument.loadDocument(ResourceUtilities.getTestInputAsStream(TEST_GRAPHICS_TEMPLATE));
    Assert.assertEquals(
        OdfDocument.OdfMediaType.GRAPHICS_TEMPLATE.getMediaTypeString(),
  ...
  public void testSavingAGraphicsTemplate() throws Exception {
    OdfDocument document =
        OdfDocument.loadDocument(ResourceUtilities.getTestInputAsStream(TEST_GRAPHICS_TEMPLATE));
    File destination =
        File.createTempFile("odfdom-test", ".otg", ResourceUtilities.getTempTestDirectory());
