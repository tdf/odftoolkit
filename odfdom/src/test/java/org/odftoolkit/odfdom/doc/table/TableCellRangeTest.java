      ...
      odsdoc =
          (OdfSpreadsheetDocument)
              OdfSpreadsheetDocument.loadDocument(
                  ResourceUtilities.getAbsoluteInputPath(filename + ".ods"));
      odtdoc =
          (OdfTextDocument)
  ...
  public void testTextCellMerge() {
    ...
    try {
      OdfTextDocument saveddoc =
          (OdfTextDocument)
              OdfTextDocument.loadDocument(
                  ResourceUtilities.getAbsoluteOutputPath(odtfilename + "MergeTwoCell.odt"));
  ...
  public void testTextColumnMerge() {
    ...
    try {
      OdfTextDocument saveddoc =
          (OdfTextDocument)
              OdfTextDocument.loadDocument(
                  ResourceUtilities.getAbsoluteOutputPath(odtfilename + "MergeFirstColumn.odt"));
  ...
  public void testSpreadSheetMerge() {
    ...
    try {
      OdfSpreadsheetDocument saveddos =
          (OdfSpreadsheetDocument)
              OdfSpreadsheetDocument.loadDocument(
                  ResourceUtilities.getAbsoluteOutputPath(filename + "CellRangeName.ods"));
