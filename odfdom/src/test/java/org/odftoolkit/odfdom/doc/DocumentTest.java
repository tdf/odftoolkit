...
public class DocumentTest {
  ...
  public void loadDocument() {
    try {
      ...
      try {
        ...
        OdfDocument ods =
            OdfDocument.loadDocument(
                ResourceUtilities.getAbsoluteInputPath(GENERATED_INVALID_SPREADSHEET));
      ...
      try {
        // Should throw error!
        OdfDocument ods =
            OdfDocument.loadDocument(ResourceUtilities.getAbsoluteInputPath(ZERO_BYTE_SPREADSHEET));
        Assert.fail();
      } catch (Exception e) {
  ...
  public void testGetContentRoot() {
    try {
      OdfTextDocument odt =
          (OdfTextDocument)
              OdfDocument.loadDocument(
                  ResourceUtilities.getAbsoluteInputPath(TEST_FILE_WITHOUT_OPT));
  ...
  private static boolean testXSLT(String odfFileNamePrefix) throws Exception {
    ...
    String xmlStringOriginal =
        inputStreamToString(
            ResourceUtilities.getTestInputAsStream("test2-" + odfFileNamePrefix + ".xml"));
  ...
  public void testSetLocale() {
    ...
    try {
      ...
      OdfPresentationDocument newDoc =
          OdfPresentationDocument.loadDocument(ResourceUtilities.getTestOutputAsStream(filename));
