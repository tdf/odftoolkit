...
public class DocumentTest {
  ...
  public void loadDocument() {
    try {
      ...
      try {
        ...
        OdfDocument ods =
            OdfDocument.loadDocument(
                ResourceUtilities.getAbsolutePath(GENERATED_INVALID_SPREADSHEET));
      ...
      try {
        // Should throw error!
        OdfDocument ods =
            OdfDocument.loadDocument(ResourceUtilities.getAbsolutePath(ZERO_BYTE_SPREADSHEET));
        Assert.fail();
      } catch (Exception e) {
  ...
  public void testGetContentRoot() {
    try {
      OdfTextDocument odt =
          (OdfTextDocument)
              OdfDocument.loadDocument(ResourceUtilities.getAbsolutePath(TEST_FILE_WITHOUT_OPT));
  ...
  private void testStyle(OdfStyle testStyle) throws Exception {
    ...
    if (testStyle.getStyleParentStyleNameAttribute() != null) {
      ...
      if (parentStyle == null) {
        parentStyle =
            ((OdfDocument) fileDom.getDocument())
                .getDocumentStyles()
  ...
  public void testSetLocale() {
    ...
    try {
      ...
      OdfPresentationDocument newDoc =
          OdfPresentationDocument.loadDocument(ResourceUtilities.getTestResourceAsStream(filename));
    ...
    try {
      ...
      OdfPackage pkg2 =
          OdfPackage.loadPackage(
              new File(ResourceUtilities.getAbsolutePath(handler2.getTestFilePath())),
              null,
              handler2);
      ...
      OdfPackage pkg3 =
          OdfPackage.loadPackage(
              new File(ResourceUtilities.getAbsolutePath(handler3.getTestFilePath())),
              null,
              handler3);
      ...
      OdfPackage pkg1 =
          OdfPackage.loadPackage(
              new File(ResourceUtilities.getAbsolutePath(handler1.getTestFilePath())),
              null,
              handler1);
