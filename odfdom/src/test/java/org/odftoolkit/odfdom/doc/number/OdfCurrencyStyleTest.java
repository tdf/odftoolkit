...
public class OdfCurrencyStyleTest {
  ...
  public void testBuildFromFormat() {
    ...
    for (int i = 0; i < formatTest.length; i++) {
      ...
      instance = new OdfNumberCurrencyStyle(dom, currencySymbol[i], formatTest[i], "fstyle");
  ...
  /**
   * Check that a <code>&lt;number:currency-symbol&gt;</code> element meets specifications.
   *
   * @param expected a string giving the currency symbol
   * @param node the node to be validated
   */
  private void checkCurrency(String expected, Node node) {
    Assert.assertTrue("node is currency symbol", node instanceof NumberCurrencySymbolElement);
  ...
  public void testGetCurrencySymbolElement() {
    ...
    OdfNumberCurrencyStyle instance = new OdfNumberCurrencyStyle(dom, "$", "$#,##0.00", "cstyle");
    ...
    Assert.assertEquals(expResult.getTextContent(), result.getTextContent());
  }
  ...
  public void testSetCurrencyLocale_String_String() {
    ...
    String language = "ko";
    String country = "KR";
    OdfNumberCurrencyStyle instance =
        new OdfNumberCurrencyStyle(dom, "\u20a9", "\u20a9#,##0.00", "kstyle"); // korean Won
    NumberCurrencySymbolElement cSymbol;
    instance.setCurrencyLocale(language, country);
    NodeList list =
        instance.getElementsByTagNameNS(OdfDocumentNamespace.NUMBER.getUri(), "currency-symbol");
  ...
  public void testSetCurrencyLocale_String() {
    ...
    OdfNumberCurrencyStyle instance =
        new OdfNumberCurrencyStyle(dom, "\u20a9", "\u20a9#,##0.00", "kstyle");
    instance.setCurrencyLocale(locale);
    list = instance.getElementsByTagNameNS(OdfDocumentNamespace.NUMBER.getUri(), "currency-symbol");
    Assert.assertTrue("Has currency symbol", list.getLength() > 0);
    cSymbol = (NumberCurrencySymbolElement) list.item(0);
    Assert.assertEquals(language, cSymbol.getNumberLanguageAttribute());
    Assert.assertEquals(country, cSymbol.getNumberCountryAttribute());
    ...
    instance = new OdfNumberCurrencyStyle(dom, "\u20a9", "\u20a9#,##0.00", "kstyle");
  ...
  public void testSetMapPositive() {
    ...
    OdfNumberCurrencyStyle instance = new OdfNumberCurrencyStyle(dom, "$", "#0", "fstyle");
