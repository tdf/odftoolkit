...
/**
 * <code>OdfDrawpage</code> represents the presentation slide feature of the ODF document.
 * <code>OdfDrawpage</code> provides methods to get the slide index,get the content of the current slide, etc.
 */
public class OdfDrawPage {

	DrawPageElement maSlideElement;
	private static Hashtable<DrawPageElement, OdfDrawPage> maSlideRepository =
			new Hashtable<DrawPageElement, OdfDrawPage>();
	 ...
	 * @return an instance of <code>OdfDrawPage</code> that can represent <code>pageElement</code>
	 */
