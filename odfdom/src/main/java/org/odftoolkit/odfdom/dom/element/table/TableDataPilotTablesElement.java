...
public class TableDataPilotTablesElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "data-pilot-tables");
   ...
   * @param tableTargetRangeAddressValue the <code>String</code> value of <code>
   *     TableTargetRangeAddressAttribute</code>, see {@odf.attribute table:target-range-address} at
   *     specification
   * @return the element {@odf.element table:data-pilot-table}
   */
  public TableDataPilotTableElement newTableDataPilotTableElement(
      String tableNameValue, String tableTargetRangeAddressValue) {
    TableDataPilotTableElement tableDataPilotTable =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TableDataPilotTableElement.class);
