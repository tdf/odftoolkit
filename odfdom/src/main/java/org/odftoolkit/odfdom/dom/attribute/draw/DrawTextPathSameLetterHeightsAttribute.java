...
public class DrawTextPathSameLetterHeightsAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.DRAW, "text-path-same-letter-heights");
   ...
   *
   * @return <code>true</code> if {@odf.attribute draw:text-path-same-letter-heights} has an element
