...
public class DrawContourPolygonElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DRAW, "contour-polygon");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DrawRecreateOnEditAttribute
   * </code> , See {@odf.attribute draw:recreate-on-edit}
   *
   * <p>Attribute is mandatory.
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DrawRecreateOnEditAttribute</code> ,
   * See {@odf.attribute draw:recreate-on-edit}
   *
