...
public class TablePageBreaksOnGroupChangeAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "page-breaks-on-group-change");
   ...
   *
   * @return <code>true</code> if {@odf.attribute table:page-breaks-on-group-change} has an element
