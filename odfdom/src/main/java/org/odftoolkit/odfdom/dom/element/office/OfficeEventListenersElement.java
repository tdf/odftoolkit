...
public class OfficeEventListenersElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.OFFICE, "event-listeners");
   ...
   *
   * @param presentationActionValue the <code>String</code> value of <code>
   *     PresentationActionAttribute</code>, see {@odf.attribute presentation:action} at
   *     specification
   * @param scriptEventNameValue the <code>String</code> value of <code>ScriptEventNameAttribute
   *     </code>, see {@odf.attribute script:event-name} at specification
   * @return the element {@odf.element presentation:event-listener}
   */
  public PresentationEventListenerElement newPresentationEventListenerElement(
      String presentationActionValue, String scriptEventNameValue) {
    PresentationEventListenerElement presentationEventListener =
        ((OdfFileDom) this.ownerDocument).newOdfElement(PresentationEventListenerElement.class);
   ...
   * @param scriptEventNameValue the <code>String</code> value of <code>ScriptEventNameAttribute
   *     </code>, see {@odf.attribute script:event-name} at specification
   * @param scriptLanguageValue the <code>String</code> value of <code>ScriptLanguageAttribute
   *     </code>, see {@odf.attribute script:language} at specification
   * @return the element {@odf.element script:event-listener}
   */
  public ScriptEventListenerElement newScriptEventListenerElement(
      String scriptEventNameValue, String scriptLanguageValue) {
    ScriptEventListenerElement scriptEventListener =
        ((OdfFileDom) this.ownerDocument).newOdfElement(ScriptEventListenerElement.class);
