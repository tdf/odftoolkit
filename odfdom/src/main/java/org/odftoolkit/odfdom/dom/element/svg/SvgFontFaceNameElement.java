...
public class SvgFontFaceNameElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.SVG, "font-face-name");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>SvgNameAttribute</code> , See
   * {@odf.attribute svg:name}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>SvgNameAttribute</code> , See
   * {@odf.attribute svg:name}
   *
