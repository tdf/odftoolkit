...
public class TextUserIndexElement extends OdfStylableElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "user-index");
   ...
   *     see {@odf.attribute text:index-name} at specification Child element is mandatory.
  ...
  public TextUserIndexSourceElement newTextUserIndexSourceElement(String textIndexNameValue) {
    TextUserIndexSourceElement textUserIndexSource =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TextUserIndexSourceElement.class);
