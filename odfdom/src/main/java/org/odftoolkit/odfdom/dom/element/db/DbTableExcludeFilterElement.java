...
public class DbTableExcludeFilterElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "table-exclude-filter");
  ...
  public DbTableFilterPatternElement newDbTableFilterPatternElement() {
    DbTableFilterPatternElement dbTableFilterPattern =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbTableFilterPatternElement.class);
