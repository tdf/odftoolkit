...
public class PresentationUseDateTimeNameAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.PRESENTATION, "use-date-time-name");
   ...
   *
   * @return <code>true</code> if {@odf.attribute presentation:use-date-time-name} has an element
