...
public class DrawObjectOleElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DRAW, "object-ole");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DrawClassIdAttribute</code> ,
   * See {@odf.attribute draw:class-id}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getDrawClassIdAttribute() {
    DrawClassIdAttribute attr =
        (DrawClassIdAttribute) getOdfAttribute(OdfDocumentNamespace.DRAW, "class-id");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DrawClassIdAttribute</code> , See
   * {@odf.attribute draw:class-id}
   *
