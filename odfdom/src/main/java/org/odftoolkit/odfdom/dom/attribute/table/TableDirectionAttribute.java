...
public class TableDirectionAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "direction");
  ...
  public enum Value {
    FROM_ANOTHER_TABLE("from-another-table"),
    FROM_SAME_TABLE("from-same-table"),
    TO_ANOTHER_TABLE("to-another-table");
   ...
   *
   * @return <code>true</code> if {@odf.attribute table:direction} has an element parent otherwise
