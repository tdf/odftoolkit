...
public class TextIndexEntryTabStopElement extends OdfStylableElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "index-entry-tab-stop");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>StyleLeaderCharAttribute</code>
   * , See {@odf.attribute style:leader-char}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getStyleLeaderCharAttribute() {
    StyleLeaderCharAttribute attr =
        (StyleLeaderCharAttribute) getOdfAttribute(OdfDocumentNamespace.STYLE, "leader-char");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>StyleLeaderCharAttribute</code> , See
   * {@odf.attribute style:leader-char}
   *
