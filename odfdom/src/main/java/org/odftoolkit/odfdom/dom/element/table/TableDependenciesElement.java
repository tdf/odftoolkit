...
public class TableDependenciesElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "dependencies");
   ...
   *     {@odf.attribute table:id} at specification Child element is mandatory.
  ...
  public TableDependencyElement newTableDependencyElement(String tableIdValue) {
    TableDependencyElement tableDependency =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TableDependencyElement.class);
