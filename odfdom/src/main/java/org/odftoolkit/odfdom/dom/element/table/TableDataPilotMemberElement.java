...
public class TableDataPilotMemberElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "data-pilot-member");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TableShowDetailsAttribute
   * </code> , See {@odf.attribute table:show-details}
   *
   * @return - the <code>Boolean</code> , the value or <code>null</code>, if the attribute is not
   *     set and no default value defined.
   */
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableShowDetailsAttribute</code> , See
   * {@odf.attribute table:show-details}
   *
  ...
  public void setTableShowDetailsAttribute(Boolean tableShowDetailsValue) {
    ...
    setOdfAttribute(attr);
    attr.setValue(tableShowDetailsValue.toString());
  }
