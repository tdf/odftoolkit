...
public class PresentationSoundElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.PRESENTATION, "sound");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>PresentationPlayFullAttribute
   * </code> , See {@odf.attribute presentation:play-full}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>PresentationPlayFullAttribute</code> ,
   * See {@odf.attribute presentation:play-full}
   *
  ...
  public void setPresentationPlayFullAttribute(Boolean presentationPlayFullValue) {
    ...
    attr.setBooleanValue(presentationPlayFullValue);
  }
