...
public class TextPageVariableSetElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "page-variable-set");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextActiveAttribute</code> ,
   * See {@odf.attribute text:active}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextActiveAttribute</code> , See
   * {@odf.attribute text:active}
   *
