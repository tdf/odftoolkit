...
public class OfficeFontFaceDeclsElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.OFFICE, "font-face-decls");
  ...
  public StyleFontFaceElement newStyleFontFaceElement(String styleNameValue) {
    StyleFontFaceElement styleFontFace =
        ((OdfFileDom) this.ownerDocument).newOdfElement(StyleFontFaceElement.class);
