...
public class DbIndexColumnsElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "index-columns");
  ...
  public DbIndexColumnElement newDbIndexColumnElement(String dbNameValue) {
    DbIndexColumnElement dbIndexColumn =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbIndexColumnElement.class);
