...
public class DbTableFilterElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "table-filter");
  ...
  public DbTableExcludeFilterElement newDbTableExcludeFilterElement() {
    DbTableExcludeFilterElement dbTableExcludeFilter =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbTableExcludeFilterElement.class);
  ...
  public DbTableIncludeFilterElement newDbTableIncludeFilterElement() {
    DbTableIncludeFilterElement dbTableIncludeFilter =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbTableIncludeFilterElement.class);
