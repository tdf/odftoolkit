...
public class StylePageLayoutElement extends OdfStyleBase {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.STYLE, "page-layout");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>StylePageUsageAttribute</code>
   * , See {@odf.attribute style:page-usage}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getStylePageUsageAttribute() {
    StylePageUsageAttribute attr =
        (StylePageUsageAttribute) getOdfAttribute(OdfDocumentNamespace.STYLE, "page-usage");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>StylePageUsageAttribute</code> , See
   * {@odf.attribute style:page-usage}
   *
  ...
  public StyleFooterStyleElement newStyleFooterStyleElement() {
    StyleFooterStyleElement styleFooterStyle =
        ((OdfFileDom) this.ownerDocument).newOdfElement(StyleFooterStyleElement.class);
  ...
  public StyleHeaderStyleElement newStyleHeaderStyleElement() {
    StyleHeaderStyleElement styleHeaderStyle =
        ((OdfFileDom) this.ownerDocument).newOdfElement(StyleHeaderStyleElement.class);
  ...
  public StylePageLayoutPropertiesElement newStylePageLayoutPropertiesElement(
    ...
    StylePageLayoutPropertiesElement stylePageLayoutProperties =
        ((OdfFileDom) this.ownerDocument).newOdfElement(StylePageLayoutPropertiesElement.class);
