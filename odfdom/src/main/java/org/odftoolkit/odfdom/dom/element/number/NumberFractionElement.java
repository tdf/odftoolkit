...
public class NumberFractionElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.NUMBER, "fraction");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>NumberDenominatorValueAttribute
   * </code> , See {@odf.attribute number:denominator-value}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>NumberDenominatorValueAttribute</code>
   * , See {@odf.attribute number:denominator-value}
   *
  ...
  public void setNumberDenominatorValueAttribute(Integer numberDenominatorValueValue) {
    ...
    attr.setValue(numberDenominatorValueValue.toString());
  }
  ...
  public void setNumberMaxDenominatorValueAttribute(Integer numberMaxDenominatorValueValue) {
    ...
    setOdfAttribute(attr);
    attr.setValue(numberMaxDenominatorValueValue.toString());
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>
   * NumberMinDenominatorDigitsAttribute</code> , See {@odf.attribute number:min-denominator-digits}
   *
   * @return - the <code>Integer</code> , the value or <code>null</code>, if the attribute is not
   *     set and no default value defined.
   */
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>NumberMinDenominatorDigitsAttribute
   * </code> , See {@odf.attribute number:min-denominator-digits}
   *
  ...
  public void setNumberMinDenominatorDigitsAttribute(Integer numberMinDenominatorDigitsValue) {
    ...
    setOdfAttribute(attr);
    attr.setValue(numberMinDenominatorDigitsValue.toString());
  }
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>
   * NumberMinNumeratorDigitsAttribute</code> , See {@odf.attribute number:min-numerator-digits}
   *
   * @return - the <code>Integer</code> , the value or <code>null</code>, if the attribute is not
   *     set and no default value defined.
   */
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>NumberMinNumeratorDigitsAttribute
   * </code> , See {@odf.attribute number:min-numerator-digits}
   *
  ...
  public void setNumberMinNumeratorDigitsAttribute(Integer numberMinNumeratorDigitsValue) {
    ...
    setOdfAttribute(attr);
    attr.setValue(numberMinNumeratorDigitsValue.toString());
  }
