...
public class TextSectionSourceElement extends OdfElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextFilterNameAttribute</code>
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextFilterNameAttribute</code> , See
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextSectionNameAttribute</code>
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextSectionNameAttribute</code> , See
