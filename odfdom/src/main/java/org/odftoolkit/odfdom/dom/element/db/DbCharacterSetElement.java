...
public class DbCharacterSetElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "character-set");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DbEncodingAttribute</code> ,
   * See {@odf.attribute db:encoding}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getDbEncodingAttribute() {
    DbEncodingAttribute attr =
        (DbEncodingAttribute) getOdfAttribute(OdfDocumentNamespace.DB, "encoding");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbEncodingAttribute</code> , See
   * {@odf.attribute db:encoding}
   *
