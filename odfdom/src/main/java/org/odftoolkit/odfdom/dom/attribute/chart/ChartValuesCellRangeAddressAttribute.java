...
public class ChartValuesCellRangeAddressAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.CHART, "values-cell-range-address");
   ...
   *
   * @return <code>true</code> if {@odf.attribute chart:values-cell-range-address} has an element
