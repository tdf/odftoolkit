...
public class DrawExtrusionFirstLightDirectionAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.DRAW, "extrusion-first-light-direction");
   ...
   *
   * @return <code>true</code> if {@odf.attribute draw:extrusion-first-light-direction} has an
