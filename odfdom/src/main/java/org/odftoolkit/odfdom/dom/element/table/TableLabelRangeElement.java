...
public class TableLabelRangeElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "label-range");
   ...
   * TableDataCellRangeAddressAttribute</code> , See {@odf.attribute table:data-cell-range-address}
   *
  ...
  public String getTableDataCellRangeAddressAttribute() {
    TableDataCellRangeAddressAttribute attr =
        (TableDataCellRangeAddressAttribute)
            getOdfAttribute(OdfDocumentNamespace.TABLE, "data-cell-range-address");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableDataCellRangeAddressAttribute
   * </code> , See {@odf.attribute table:data-cell-range-address}
   *
  ...
  public void setTableDataCellRangeAddressAttribute(String tableDataCellRangeAddressValue) {
    TableDataCellRangeAddressAttribute attr =
        new TableDataCellRangeAddressAttribute((OdfFileDom) this.ownerDocument);
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>
   * TableLabelCellRangeAddressAttribute</code> , See {@odf.attribute
  ...
  public String getTableLabelCellRangeAddressAttribute() {
    TableLabelCellRangeAddressAttribute attr =
        (TableLabelCellRangeAddressAttribute)
            getOdfAttribute(OdfDocumentNamespace.TABLE, "label-cell-range-address");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableLabelCellRangeAddressAttribute
   * </code> , See {@odf.attribute table:label-cell-range-address}
   *
  ...
  public void setTableLabelCellRangeAddressAttribute(String tableLabelCellRangeAddressValue) {
    TableLabelCellRangeAddressAttribute attr =
        new TableLabelCellRangeAddressAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
