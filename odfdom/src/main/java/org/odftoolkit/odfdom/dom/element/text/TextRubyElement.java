...
public class TextRubyElement extends OdfStylableElement {
  ...
  public TextRubyBaseElement newTextRubyBaseElement() {
    TextRubyBaseElement textRubyBase =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TextRubyBaseElement.class);
  ...
  public TextRubyTextElement newTextRubyTextElement() {
    TextRubyTextElement textRubyText =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TextRubyTextElement.class);
