...
public class TextBibliographyEntryTemplateElement extends OdfStylableElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "bibliography-entry-template");
   ...
   *
   * @param textBibliographyDataFieldValue the <code>String</code> value of <code>
   *     TextBibliographyDataFieldAttribute</code>, see {@odf.attribute
   *     text:bibliography-data-field} at specification
   * @return the element {@odf.element text:index-entry-bibliography}
   */
  public TextIndexEntryBibliographyElement newTextIndexEntryBibliographyElement(
      String textBibliographyDataFieldValue) {
    TextIndexEntryBibliographyElement textIndexEntryBibliography =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TextIndexEntryBibliographyElement.class);
    textIndexEntryBibliography.setTextBibliographyDataFieldAttribute(
        textBibliographyDataFieldValue);
