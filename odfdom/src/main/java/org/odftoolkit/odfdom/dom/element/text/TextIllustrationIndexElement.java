...
public class TextIllustrationIndexElement extends OdfStylableElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "illustration-index");
  ...
  public TextIllustrationIndexSourceElement newTextIllustrationIndexSourceElement() {
    TextIllustrationIndexSourceElement textIllustrationIndexSource =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TextIllustrationIndexSourceElement.class);
