...
public class AnimAnimateTransformElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.ANIM, "animateTransform");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>SvgTypeAttribute</code> , See
   * {@odf.attribute svg:type}
   *
   * <p>Attribute is mandatory.
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>SvgTypeAttribute</code> , See
   * {@odf.attribute svg:type}
   *
