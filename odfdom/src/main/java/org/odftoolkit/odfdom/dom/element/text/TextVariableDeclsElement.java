...
public class TextVariableDeclsElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "variable-decls");
   ...
   */
  public TextVariableDeclElement newTextVariableDeclElement(
      String officeValueTypeValue, String textNameValue) {
    TextVariableDeclElement textVariableDecl =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TextVariableDeclElement.class);
