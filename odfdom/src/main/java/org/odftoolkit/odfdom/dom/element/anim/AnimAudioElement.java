...
public class AnimAudioElement extends OdfElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>AnimAudioLevelAttribute</code>
   * , See {@odf.attribute anim:audio-level}
   *
  ...
  public Double getAnimAudioLevelAttribute() {
    AnimAudioLevelAttribute attr =
        (AnimAudioLevelAttribute) getOdfAttribute(OdfDocumentNamespace.ANIM, "audio-level");
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>AnimAudioLevelAttribute</code> , See
   * {@odf.attribute anim:audio-level}
   *
  ...
  public void setAnimAudioLevelAttribute(Double animAudioLevelValue) {
    ...
    attr.setDoubleValue(animAudioLevelValue);
  }
