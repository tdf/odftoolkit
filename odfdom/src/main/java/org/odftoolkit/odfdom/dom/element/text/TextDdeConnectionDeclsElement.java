...
public class TextDdeConnectionDeclsElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "dde-connection-decls");
   ...
   */
  public TextDdeConnectionDeclElement newTextDdeConnectionDeclElement(
      String officeDdeApplicationValue,
      String officeDdeItemValue,
      String officeDdeTopicValue,
      String officeNameValue) {
    TextDdeConnectionDeclElement textDdeConnectionDecl =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TextDdeConnectionDeclElement.class);
