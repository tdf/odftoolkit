...
public class TableSourceCellRangeAddressesAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "source-cell-range-addresses");
   ...
   *
   * @return <code>true</code> if {@odf.attribute table:source-cell-range-addresses} has an element
