...
public class ConfigConfigItemMapEntryElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.CONFIG, "config-item-map-entry");
   ...
   *     {@odf.attribute config:name} at specification
   * @param configTypeValue the <code>String</code> value of <code>ConfigTypeAttribute</code>, see
   *     {@odf.attribute config:type} at specification
   * @return the element {@odf.element config:config-item}
   */
  public ConfigConfigItemElement newConfigConfigItemElement(
      String configNameValue, String configTypeValue) {
    ConfigConfigItemElement configConfigItem =
        ((OdfFileDom) this.ownerDocument).newOdfElement(ConfigConfigItemElement.class);
   ...
   */
  public ConfigConfigItemMapIndexedElement newConfigConfigItemMapIndexedElement(
      String configNameValue) {
    ConfigConfigItemMapIndexedElement configConfigItemMapIndexed =
        ((OdfFileDom) this.ownerDocument).newOdfElement(ConfigConfigItemMapIndexedElement.class);
   ...
   */
  public ConfigConfigItemMapNamedElement newConfigConfigItemMapNamedElement(
      String configNameValue) {
    ConfigConfigItemMapNamedElement configConfigItemMapNamed =
        ((OdfFileDom) this.ownerDocument).newOdfElement(ConfigConfigItemMapNamedElement.class);
