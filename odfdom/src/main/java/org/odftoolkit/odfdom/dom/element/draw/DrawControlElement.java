...
public class DrawControlElement extends DrawShapeElementBase {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DrawControlAttribute</code> ,
   * See {@odf.attribute draw:control}
   *
  ...
  public String getDrawControlAttribute() {
    DrawControlAttribute attr =
        (DrawControlAttribute) getOdfAttribute(OdfDocumentNamespace.DRAW, "control");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DrawControlAttribute</code> , See
   * {@odf.attribute draw:control}
   *
