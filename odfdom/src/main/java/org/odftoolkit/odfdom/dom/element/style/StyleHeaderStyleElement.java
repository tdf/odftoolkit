...
public class StyleHeaderStyleElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.STYLE, "header-style");
  ...
  public StyleHeaderFooterPropertiesElement newStyleHeaderFooterPropertiesElement() {
    StyleHeaderFooterPropertiesElement styleHeaderFooterProperties =
        ((OdfFileDom) this.ownerDocument).newOdfElement(StyleHeaderFooterPropertiesElement.class);
