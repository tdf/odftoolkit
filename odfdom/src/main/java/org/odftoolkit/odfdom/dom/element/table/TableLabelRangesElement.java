...
public class TableLabelRangesElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "label-ranges");
   ...
   *
   * @param tableDataCellRangeAddressValue the <code>String</code> value of <code>
   *     TableDataCellRangeAddressAttribute</code>, see {@odf.attribute
   *     table:data-cell-range-address} at specification
   * @param tableLabelCellRangeAddressValue the <code>String</code> value of <code>
   *     TableLabelCellRangeAddressAttribute</code>, see {@odf.attribute
   *     table:label-cell-range-address} at specification
   ...
   */
  public TableLabelRangeElement newTableLabelRangeElement(
      String tableDataCellRangeAddressValue,
      String tableLabelCellRangeAddressValue,
      String tableOrientationValue) {
    TableLabelRangeElement tableLabelRange =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TableLabelRangeElement.class);
