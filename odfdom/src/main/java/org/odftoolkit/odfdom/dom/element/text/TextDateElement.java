...
public class TextDateElement extends OdfElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextDateAdjustAttribute</code>
   * , See {@odf.attribute text:date-adjust}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTextDateAdjustAttribute() {
    TextDateAdjustAttribute attr =
        (TextDateAdjustAttribute) getOdfAttribute(OdfDocumentNamespace.TEXT, "date-adjust");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextDateAdjustAttribute</code> , See
   * {@odf.attribute text:date-adjust}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextDateValueAttribute</code> ,
   * See {@odf.attribute text:date-value}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTextDateValueAttribute() {
    TextDateValueAttribute attr =
        (TextDateValueAttribute) getOdfAttribute(OdfDocumentNamespace.TEXT, "date-value");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextDateValueAttribute</code> , See
   * {@odf.attribute text:date-value}
   *
