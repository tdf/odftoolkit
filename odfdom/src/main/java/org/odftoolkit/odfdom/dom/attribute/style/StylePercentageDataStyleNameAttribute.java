...
public class StylePercentageDataStyleNameAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.STYLE, "percentage-data-style-name");
   ...
   *
   * @return <code>true</code> if {@odf.attribute style:percentage-data-style-name} has an element
