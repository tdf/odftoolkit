...
{        
	...
	{
		FormStepSizeAttribute attr = (FormStepSizeAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.FORM), "step-size" ) ;
		if( attr != null ){
			return Integer.valueOf( attr.intValue() );
		}
	...
	{
		FormPageStepSizeAttribute attr = (FormPageStepSizeAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.FORM), "page-step-size" ) ;
		if( attr != null ){
			return Integer.valueOf( attr.intValue() );
		}
		return null;
	...
	{
		FormOrientationAttribute attr = (FormOrientationAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.FORM), "orientation" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
