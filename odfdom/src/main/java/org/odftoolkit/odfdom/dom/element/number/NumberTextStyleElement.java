...
public class NumberTextStyleElement extends DataStyleElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.NUMBER, "text-style");
   ...
   */
  public NumberTextStyleElement(OdfFileDom ownerDoc, String format, String styleName) {
    super(ownerDoc, ELEMENT_NAME);
  ...
  public NumberTextContentElement newNumberTextContentElement() {
    NumberTextContentElement numberTextContent =
        ((OdfFileDom) this.ownerDocument).newOdfElement(NumberTextContentElement.class);
