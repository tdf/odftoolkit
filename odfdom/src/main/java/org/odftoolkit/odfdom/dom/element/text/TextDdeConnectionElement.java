...
public class TextDdeConnectionElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "dde-connection");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextConnectionNameAttribute
   * </code> , See {@odf.attribute text:connection-name}
   *
  ...
  public String getTextConnectionNameAttribute() {
    TextConnectionNameAttribute attr =
        (TextConnectionNameAttribute) getOdfAttribute(OdfDocumentNamespace.TEXT, "connection-name");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextConnectionNameAttribute</code> ,
   * See {@odf.attribute text:connection-name}
   *
  ...
  public void setTextConnectionNameAttribute(String textConnectionNameValue) {
    TextConnectionNameAttribute attr =
        new TextConnectionNameAttribute((OdfFileDom) this.ownerDocument);
