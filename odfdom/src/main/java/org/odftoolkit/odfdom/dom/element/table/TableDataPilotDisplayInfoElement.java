...
public class TableDataPilotDisplayInfoElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "data-pilot-display-info");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TableDisplayMemberModeAttribute
   * </code> , See {@odf.attribute table:display-member-mode}
   *
   * <p>Attribute is mandatory.
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
  ...
  public String getTableDisplayMemberModeAttribute() {
    TableDisplayMemberModeAttribute attr =
        (TableDisplayMemberModeAttribute)
            getOdfAttribute(OdfDocumentNamespace.TABLE, "display-member-mode");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableDisplayMemberModeAttribute</code>
   * , See {@odf.attribute table:display-member-mode}
   *
  ...
  public void setTableDisplayMemberModeAttribute(String tableDisplayMemberModeValue) {
    TableDisplayMemberModeAttribute attr =
        new TableDisplayMemberModeAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
    attr.setValue(tableDisplayMemberModeValue);
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>TableEnabledAttribute</code> ,
   * See {@odf.attribute table:enabled}
   *
   * <p>Attribute is mandatory.
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableEnabledAttribute</code> , See
   * {@odf.attribute table:enabled}
   *
  ...
  public void setTableEnabledAttribute(Boolean tableEnabledValue) {
    ...
    setOdfAttribute(attr);
    attr.setBooleanValue(tableEnabledValue);
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>TableMemberCountAttribute
   * </code> , See {@odf.attribute table:member-count}
   *
   * <p>Attribute is mandatory.
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableMemberCountAttribute</code> , See
   * {@odf.attribute table:member-count}
   *
  ...
  public void setTableMemberCountAttribute(Integer tableMemberCountValue) {
    ...
    setOdfAttribute(attr);
    attr.setIntValue(tableMemberCountValue);
  }
