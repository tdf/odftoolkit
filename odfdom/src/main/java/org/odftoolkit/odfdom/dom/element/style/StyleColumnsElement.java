...
public class StyleColumnsElement extends OdfElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>FoColumnCountAttribute</code> ,
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>FoColumnCountAttribute</code> , See
   * {@odf.attribute fo:column-count}
   *
  ...
  public void setFoColumnCountAttribute(Integer foColumnCountValue) {
    ...
    attr.setValue(foColumnCountValue.toString());
  }
  ...
  public String getFoColumnGapAttribute() {
    FoColumnGapAttribute attr =
        (FoColumnGapAttribute) getOdfAttribute(OdfDocumentNamespace.FO, "column-gap");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>FoColumnGapAttribute</code> , See
   * {@odf.attribute fo:column-gap}
   *
  ...
  public StyleColumnElement newStyleColumnElement(String styleRelWidthValue) {
    StyleColumnElement styleColumn =
        ((OdfFileDom) this.ownerDocument).newOdfElement(StyleColumnElement.class);
  ...
  public StyleColumnSepElement newStyleColumnSepElement(String styleWidthValue) {
    StyleColumnSepElement styleColumnSep =
        ((OdfFileDom) this.ownerDocument).newOdfElement(StyleColumnSepElement.class);
