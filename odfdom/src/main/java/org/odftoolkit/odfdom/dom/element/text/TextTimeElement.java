...
public class TextTimeElement extends OdfElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextTimeAdjustAttribute</code>
   * , See {@odf.attribute text:time-adjust}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTextTimeAdjustAttribute() {
    TextTimeAdjustAttribute attr =
        (TextTimeAdjustAttribute) getOdfAttribute(OdfDocumentNamespace.TEXT, "time-adjust");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextTimeAdjustAttribute</code> , See
   * {@odf.attribute text:time-adjust}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextTimeValueAttribute</code> ,
   * See {@odf.attribute text:time-value}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTextTimeValueAttribute() {
    TextTimeValueAttribute attr =
        (TextTimeValueAttribute) getOdfAttribute(OdfDocumentNamespace.TEXT, "time-value");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextTimeValueAttribute</code> , See
   * {@odf.attribute text:time-value}
   *
