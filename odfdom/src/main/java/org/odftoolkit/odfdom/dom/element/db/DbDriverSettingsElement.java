...
public class DbDriverSettingsElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "driver-settings");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DbBaseDnAttribute</code> , See
   * {@odf.attribute db:base-dn}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getDbBaseDnAttribute() {
    DbBaseDnAttribute attr =
        (DbBaseDnAttribute) getOdfAttribute(OdfDocumentNamespace.DB, "base-dn");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbBaseDnAttribute</code> , See
   * {@odf.attribute db:base-dn}
   *
  ...
  public void setDbParameterNameSubstitutionAttribute(Boolean dbParameterNameSubstitutionValue) {
    ...
    setOdfAttribute(attr);
    attr.setValue(dbParameterNameSubstitutionValue.toString());
  }
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DbSystemDriverSettingsAttribute
   * </code> , See {@odf.attribute db:system-driver-settings}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getDbSystemDriverSettingsAttribute() {
    DbSystemDriverSettingsAttribute attr =
        (DbSystemDriverSettingsAttribute)
            getOdfAttribute(OdfDocumentNamespace.DB, "system-driver-settings");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbSystemDriverSettingsAttribute</code>
   * , See {@odf.attribute db:system-driver-settings}
   *
  ...
  public void setDbSystemDriverSettingsAttribute(String dbSystemDriverSettingsValue) {
    DbSystemDriverSettingsAttribute attr =
        new DbSystemDriverSettingsAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
  ...
  public DbAutoIncrementElement newDbAutoIncrementElement() {
    DbAutoIncrementElement dbAutoIncrement =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbAutoIncrementElement.class);
  ...
  public DbTableSettingsElement newDbTableSettingsElement() {
    DbTableSettingsElement dbTableSettings =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbTableSettingsElement.class);
