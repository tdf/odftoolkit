...
{        
	...
	{
		SmilAttributeNameAttribute attr = (SmilAttributeNameAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.SMIL), "attributeName" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		SmilKeyTimesAttribute attr = (SmilKeyTimesAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.SMIL), "keyTimes" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		SmilKeySplinesAttribute attr = (SmilKeySplinesAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.SMIL), "keySplines" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		AnimColorInterpolationAttribute attr = (AnimColorInterpolationAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.ANIM), "color-interpolation" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
	...
	{
		AnimColorInterpolationDirectionAttribute attr = (AnimColorInterpolationDirectionAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.ANIM), "color-interpolation-direction" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
