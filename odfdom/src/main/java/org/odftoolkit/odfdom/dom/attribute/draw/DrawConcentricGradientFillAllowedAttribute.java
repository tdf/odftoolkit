...
public class DrawConcentricGradientFillAllowedAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.DRAW, "concentric-gradient-fill-allowed");
   ...
   *
   * @return <code>true</code> if {@odf.attribute draw:concentric-gradient-fill-allowed} has an
