...
public class TableDatabaseSourceQueryElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "database-source-query");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TableQueryNameAttribute</code>
   * , See {@odf.attribute table:query-name}
   *
   * <p>Attribute is mandatory.
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
  ...
  public String getTableQueryNameAttribute() {
    TableQueryNameAttribute attr =
        (TableQueryNameAttribute) getOdfAttribute(OdfDocumentNamespace.TABLE, "query-name");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableQueryNameAttribute</code> , See
   * {@odf.attribute table:query-name}
   *
