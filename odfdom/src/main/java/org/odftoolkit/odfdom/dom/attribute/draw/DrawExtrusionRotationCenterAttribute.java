...
public class DrawExtrusionRotationCenterAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.DRAW, "extrusion-rotation-center");
   ...
   *
   * @return <code>true</code> if {@odf.attribute draw:extrusion-rotation-center} has an element
