...
public class TableDeletionsElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "deletions");
  ...
  public TableCellContentDeletionElement newTableCellContentDeletionElement() {
    TableCellContentDeletionElement tableCellContentDeletion =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TableCellContentDeletionElement.class);
  ...
  public TableChangeDeletionElement newTableChangeDeletionElement() {
    TableChangeDeletionElement tableChangeDeletion =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TableChangeDeletionElement.class);
