...
public class TextNumberedParagraphElement extends OdfStylableElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextListIdAttribute</code> ,
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextListIdAttribute</code> , See
