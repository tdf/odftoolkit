...
public class TextNoteCitationElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "note-citation");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextLabelAttribute</code> , See
   * {@odf.attribute text:label}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTextLabelAttribute() {
    TextLabelAttribute attr =
        (TextLabelAttribute) getOdfAttribute(OdfDocumentNamespace.TEXT, "label");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextLabelAttribute</code> , See
   * {@odf.attribute text:label}
   *
