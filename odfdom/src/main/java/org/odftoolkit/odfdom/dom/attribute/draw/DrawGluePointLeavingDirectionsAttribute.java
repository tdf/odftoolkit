...
public class DrawGluePointLeavingDirectionsAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.DRAW, "glue-point-leaving-directions");
   ...
   *
   * @return <code>true</code> if {@odf.attribute draw:glue-point-leaving-directions} has an element
