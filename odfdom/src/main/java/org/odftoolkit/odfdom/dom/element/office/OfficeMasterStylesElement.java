...
public class OfficeMasterStylesElement extends OdfContainerElementBase {
   ...
   *
   * @param stylePageLayoutNameValue the <code>String</code> value of <code>
   *     StylePageLayoutNameAttribute</code>, see {@odf.attribute style:page-layout-name} at
   *     specification
  ...
  public StyleHandoutMasterElement newStyleHandoutMasterElement(String stylePageLayoutNameValue) {
    StyleHandoutMasterElement styleHandoutMaster =
        ((OdfFileDom) this.ownerDocument).newOdfElement(StyleHandoutMasterElement.class);
   ...
   */
  public StyleMasterPageElement newStyleMasterPageElement(
      String styleNameValue, String stylePageLayoutNameValue) {
    StyleMasterPageElement styleMasterPage =
        ((OdfFileDom) this.ownerDocument).newOdfElement(StyleMasterPageElement.class);
