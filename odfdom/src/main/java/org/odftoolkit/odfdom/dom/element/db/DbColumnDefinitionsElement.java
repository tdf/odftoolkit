...
public class DbColumnDefinitionsElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "column-definitions");
   ...
   *     </code>, see {@odf.attribute office:value-type} at specification Child element is
   *     mandatory.
   * @return the element {@odf.element db:column-definition}
   */
  public DbColumnDefinitionElement newDbColumnDefinitionElement(
      String dbNameValue, double officeValueValue, String officeValueTypeValue) {
    DbColumnDefinitionElement dbColumnDefinition =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbColumnDefinitionElement.class);
