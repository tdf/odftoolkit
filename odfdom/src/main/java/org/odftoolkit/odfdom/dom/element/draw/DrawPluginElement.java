...
{        
    public static final OdfName ELEMENT_NAME = OdfName.newName(OdfNamespaceNames.DRAW, "plugin" );
	...
	{
		DrawMimeTypeAttribute attr = (DrawMimeTypeAttribute) getOdfAttribute( OdfName.newName( OdfNamespace.newNamespace(OdfNamespaceNames.DRAW), "mime-type" ) );
		if( attr != null ){
