...
public class FormPasswordElement extends OdfElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>FormEchoCharAttribute</code> ,
   * See {@odf.attribute form:echo-char}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getFormEchoCharAttribute() {
    FormEchoCharAttribute attr =
        (FormEchoCharAttribute) getOdfAttribute(OdfDocumentNamespace.FORM, "echo-char");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>FormEchoCharAttribute</code> , See
   * {@odf.attribute form:echo-char}
   *
