...
public class StyleMapElement extends OdfElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>StyleApplyStyleNameAttribute
   * </code> , See {@odf.attribute style:apply-style-name}
   *
  ...
  public String getStyleApplyStyleNameAttribute() {
    StyleApplyStyleNameAttribute attr =
        (StyleApplyStyleNameAttribute)
            getOdfAttribute(OdfDocumentNamespace.STYLE, "apply-style-name");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>StyleApplyStyleNameAttribute</code> ,
   * See {@odf.attribute style:apply-style-name}
   *
  ...
  public void setStyleApplyStyleNameAttribute(String styleApplyStyleNameValue) {
    StyleApplyStyleNameAttribute attr =
        new StyleApplyStyleNameAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
    attr.setValue(styleApplyStyleNameValue);
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>StyleBaseCellAddressAttribute
   * </code> , See {@odf.attribute style:base-cell-address}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getStyleBaseCellAddressAttribute() {
    StyleBaseCellAddressAttribute attr =
        (StyleBaseCellAddressAttribute)
            getOdfAttribute(OdfDocumentNamespace.STYLE, "base-cell-address");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>StyleBaseCellAddressAttribute</code> ,
   * See {@odf.attribute style:base-cell-address}
   *
  ...
  public void setStyleBaseCellAddressAttribute(String styleBaseCellAddressValue) {
    StyleBaseCellAddressAttribute attr =
        new StyleBaseCellAddressAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
    attr.setValue(styleBaseCellAddressValue);
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>StyleConditionAttribute</code>
   * , See {@odf.attribute style:condition}
   *
   * <p>Attribute is mandatory.
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
  ...
  public String getStyleConditionAttribute() {
    StyleConditionAttribute attr =
        (StyleConditionAttribute) getOdfAttribute(OdfDocumentNamespace.STYLE, "condition");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>StyleConditionAttribute</code> , See
   * {@odf.attribute style:condition}
   *
