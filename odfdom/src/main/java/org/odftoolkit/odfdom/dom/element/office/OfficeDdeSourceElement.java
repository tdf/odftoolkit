...
public class OfficeDdeSourceElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.OFFICE, "dde-source");
  ...
  public void setOfficeAutomaticUpdateAttribute(Boolean officeAutomaticUpdateValue) {
    ...
    attr.setBooleanValue(officeAutomaticUpdateValue);
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>OfficeConversionModeAttribute
   * </code> , See {@odf.attribute office:conversion-mode}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getOfficeConversionModeAttribute() {
    OfficeConversionModeAttribute attr =
        (OfficeConversionModeAttribute)
            getOdfAttribute(OdfDocumentNamespace.OFFICE, "conversion-mode");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>OfficeConversionModeAttribute</code> ,
   * See {@odf.attribute office:conversion-mode}
   *
  ...
  public void setOfficeConversionModeAttribute(String officeConversionModeValue) {
    OfficeConversionModeAttribute attr =
        new OfficeConversionModeAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
