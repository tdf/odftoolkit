...
public class DrawExtrusionSecondLightDirectionAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.DRAW, "extrusion-second-light-direction");
   ...
   *
   * @return <code>true</code> if {@odf.attribute draw:extrusion-second-light-direction} has an
