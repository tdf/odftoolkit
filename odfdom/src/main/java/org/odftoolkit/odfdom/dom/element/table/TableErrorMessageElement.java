...
public class TableErrorMessageElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "error-message");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TableMessageTypeAttribute
   * </code> , See {@odf.attribute table:message-type}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTableMessageTypeAttribute() {
    TableMessageTypeAttribute attr =
        (TableMessageTypeAttribute) getOdfAttribute(OdfDocumentNamespace.TABLE, "message-type");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableMessageTypeAttribute</code> , See
   * {@odf.attribute table:message-type}
   *
