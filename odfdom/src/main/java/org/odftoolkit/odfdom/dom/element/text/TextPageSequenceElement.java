...
public class TextPageSequenceElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "page-sequence");
   ...
   *
   * @param textMasterPageNameValue the <code>String</code> value of <code>
   *     TextMasterPageNameAttribute</code>, see {@odf.attribute text:master-page-name} at
  ...
  public TextPageElement newTextPageElement(String textMasterPageNameValue) {
    TextPageElement textPage =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TextPageElement.class);
