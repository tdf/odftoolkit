...
public class TableDatabaseRangesElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "database-ranges");
   ...
   */
  public TableDatabaseRangeElement newTableDatabaseRangeElement(
      String tableTargetRangeAddressValue) {
    TableDatabaseRangeElement tableDatabaseRange =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TableDatabaseRangeElement.class);
