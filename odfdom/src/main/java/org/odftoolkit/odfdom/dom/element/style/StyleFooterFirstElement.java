...
/** DOM implementation of OpenDocument element {@odf.element style:footer-first}. */
public class StyleFooterFirstElement extends OdfElement {

  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.STYLE, "footer-first");

  /**
   * Create the instance of <code>StyleFooterFirstElement</code>
   *
   * @param ownerDoc The type is <code>OdfFileDom</code>
   */
  public StyleFooterFirstElement(OdfFileDom ownerDoc) {
   ...
   *
   * @return return <code>OdfName</code> the name of element {@odf.element style:footer-first}.
   */
  ...
  public void setStyleDisplayAttribute(Boolean styleDisplayValue) {
    ...
    attr.setValue(styleDisplayValue.toString());
  }
   ...
   *     see {@odf.attribute text:change-id} at specification Child element was added in ODF 1.3
