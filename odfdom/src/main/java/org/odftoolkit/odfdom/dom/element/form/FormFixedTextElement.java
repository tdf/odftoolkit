...
public class FormFixedTextElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.FORM, "fixed-text");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>FormMultiLineAttribute</code> ,
   * See {@odf.attribute form:multi-line}
   *
   * @return - the <code>Boolean</code> , the value or <code>null</code>, if the attribute is not
   *     set and no default value defined.
   */
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>FormMultiLineAttribute</code> , See
   * {@odf.attribute form:multi-line}
   *
  ...
  public void setFormMultiLineAttribute(Boolean formMultiLineValue) {
    ...
    setOdfAttribute(attr);
    attr.setBooleanValue(formMultiLineValue);
  }
