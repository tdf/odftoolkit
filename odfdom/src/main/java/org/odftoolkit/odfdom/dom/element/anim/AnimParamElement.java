...
public class AnimParamElement extends OdfElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>AnimNameAttribute</code> , See
   * {@odf.attribute anim:name}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>AnimNameAttribute</code> , See
   * {@odf.attribute anim:name}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>AnimValueAttribute</code> , See
   * {@odf.attribute anim:value}
   *
   * <p>Attribute is mandatory.
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
  ...
  public String getAnimValueAttribute() {
    AnimValueAttribute attr =
        (AnimValueAttribute) getOdfAttribute(OdfDocumentNamespace.ANIM, "value");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>AnimValueAttribute</code> , See
   * {@odf.attribute anim:value}
   *
