...
public class DrawGluePointElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DRAW, "glue-point");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DrawAlignAttribute</code> , See
   * {@odf.attribute draw:align}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getDrawAlignAttribute() {
    DrawAlignAttribute attr =
        (DrawAlignAttribute) getOdfAttribute(OdfDocumentNamespace.DRAW, "align");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DrawAlignAttribute</code> , See
   * {@odf.attribute draw:align}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DrawEscapeDirectionAttribute
   * </code> , See {@odf.attribute draw:escape-direction}
   *
  ...
  public String getDrawEscapeDirectionAttribute() {
    DrawEscapeDirectionAttribute attr =
        (DrawEscapeDirectionAttribute)
            getOdfAttribute(OdfDocumentNamespace.DRAW, "escape-direction");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DrawEscapeDirectionAttribute</code> ,
   * See {@odf.attribute draw:escape-direction}
   *
  ...
  public void setDrawEscapeDirectionAttribute(String drawEscapeDirectionValue) {
    DrawEscapeDirectionAttribute attr =
        new DrawEscapeDirectionAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
