...
public class TableFirstColumnElement extends OdfStylableElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "first-column");
   ...
   * TableParagraphStyleNameAttribute</code> , See {@odf.attribute table:paragraph-style-name}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTableParagraphStyleNameAttribute() {
    TableParagraphStyleNameAttribute attr =
        (TableParagraphStyleNameAttribute)
            getOdfAttribute(OdfDocumentNamespace.TABLE, "paragraph-style-name");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableParagraphStyleNameAttribute</code>
   * , See {@odf.attribute table:paragraph-style-name}
   *
  ...
  public void setTableParagraphStyleNameAttribute(String tableParagraphStyleNameValue) {
    TableParagraphStyleNameAttribute attr =
        new TableParagraphStyleNameAttribute((OdfFileDom) this.ownerDocument);
