...
public class TableDdeLinksElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "dde-links");
  ...
  public TableDdeLinkElement newTableDdeLinkElement() {
    TableDdeLinkElement tableDdeLink =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TableDdeLinkElement.class);
