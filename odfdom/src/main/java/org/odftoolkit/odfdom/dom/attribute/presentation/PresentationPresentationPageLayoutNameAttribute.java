...
public class PresentationPresentationPageLayoutNameAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.PRESENTATION, "presentation-page-layout-name");
   ...
   *
   * @return <code>true</code> if {@odf.attribute presentation:presentation-page-layout-name} has an
   *     element parent otherwise return <code>false</code> as undefined.
   */
  @Override
