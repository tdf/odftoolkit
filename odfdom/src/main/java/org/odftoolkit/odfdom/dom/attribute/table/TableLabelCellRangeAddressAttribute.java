...
public class TableLabelCellRangeAddressAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "label-cell-range-address");
   ...
   *
   * @return <code>true</code> if {@odf.attribute table:label-cell-range-address} has an element
