...
public class DbLoginElement extends OdfElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DbIsPasswordRequiredAttribute
   * </code> , See {@odf.attribute db:is-password-required}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbIsPasswordRequiredAttribute</code> ,
   * See {@odf.attribute db:is-password-required}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DbLoginTimeoutAttribute</code>
   * , See {@odf.attribute db:login-timeout}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbLoginTimeoutAttribute</code> , See
   * {@odf.attribute db:login-timeout}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DbUseSystemUserAttribute</code>
   * , See {@odf.attribute db:use-system-user}
   *
   * @return - the <code>Boolean</code> , the value or <code>null</code>, if the attribute is not
   *     set and no default value defined.
   */
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbUseSystemUserAttribute</code> , See
   * {@odf.attribute db:use-system-user}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DbUserNameAttribute</code> ,
   * See {@odf.attribute db:user-name}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getDbUserNameAttribute() {
    DbUserNameAttribute attr =
        (DbUserNameAttribute) getOdfAttribute(OdfDocumentNamespace.DB, "user-name");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbUserNameAttribute</code> , See
   * {@odf.attribute db:user-name}
   *
