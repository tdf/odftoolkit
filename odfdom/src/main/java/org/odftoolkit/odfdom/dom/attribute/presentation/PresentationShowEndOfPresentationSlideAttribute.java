...
/**
 * DOM implementation of OpenDocument attribute {@odf.attribute
...
public class PresentationShowEndOfPresentationSlideAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.PRESENTATION, "show-end-of-presentation-slide");
   ...
   *
   * @return the <code>OdfName</code> for {@odf.attribute
   *     presentation:show-end-of-presentation-slide}.
   */
  @Override
   ...
   *
   * @return <code>true</code> if {@odf.attribute presentation:show-end-of-presentation-slide} has
   *     an element parent otherwise return <code>false</code> as undefined.
   */
  @Override
