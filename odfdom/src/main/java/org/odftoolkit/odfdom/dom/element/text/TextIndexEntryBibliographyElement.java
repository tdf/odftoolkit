...
{        
	...
	{
		TextBibliographyDataFieldAttribute attr = (TextBibliographyDataFieldAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.TEXT), "bibliography-data-field" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
