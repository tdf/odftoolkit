...
public class TextIndexEntryBibliographyElement extends OdfStylableElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "index-entry-bibliography");
   ...
   * TextBibliographyDataFieldAttribute</code> , See {@odf.attribute text:bibliography-data-field}
   *
  ...
  public String getTextBibliographyDataFieldAttribute() {
    TextBibliographyDataFieldAttribute attr =
        (TextBibliographyDataFieldAttribute)
            getOdfAttribute(OdfDocumentNamespace.TEXT, "bibliography-data-field");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextBibliographyDataFieldAttribute
   * </code> , See {@odf.attribute text:bibliography-data-field}
   *
  ...
  public void setTextBibliographyDataFieldAttribute(String textBibliographyDataFieldValue) {
    TextBibliographyDataFieldAttribute attr =
        new TextBibliographyDataFieldAttribute((OdfFileDom) this.ownerDocument);
