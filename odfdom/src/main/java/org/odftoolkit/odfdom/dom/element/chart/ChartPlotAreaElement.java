...
{        
	...
	{
		ChartDataSourceHasLabelsAttribute attr = (ChartDataSourceHasLabelsAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.CHART), "data-source-has-labels" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
