...
public class DbDatabaseDescriptionElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "database-description");
   ...
   *
   * @param dbMediaTypeValue the <code>String</code> value of <code>DbMediaTypeAttribute</code>, see
   *     {@odf.attribute db:media-type} at specification
  ...
  public DbFileBasedDatabaseElement newDbFileBasedDatabaseElement(
      String dbMediaTypeValue, String xlinkHrefValue, String xlinkTypeValue) {
    DbFileBasedDatabaseElement dbFileBasedDatabase =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbFileBasedDatabaseElement.class);
   ...
   *     {@odf.attribute db:type} at specification Child element was added in ODF 1.2
  ...
  public DbServerDatabaseElement newDbServerDatabaseElement(String dbTypeValue) {
    DbServerDatabaseElement dbServerDatabase =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbServerDatabaseElement.class);
