...
public class TableNamedExpressionsElement extends OdfElement {
   ...
   *
   * @param tableExpressionValue the <code>String</code> value of <code>TableExpressionAttribute
   *     </code>, see {@odf.attribute table:expression} at specification
   ...
   */
  public TableNamedExpressionElement newTableNamedExpressionElement(
      String tableExpressionValue, String tableNameValue) {
    TableNamedExpressionElement tableNamedExpression =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TableNamedExpressionElement.class);
   ...
   */
  public TableNamedRangeElement newTableNamedRangeElement(
      String tableCellRangeAddressValue, String tableNameValue) {
    TableNamedRangeElement tableNamedRange =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TableNamedRangeElement.class);
