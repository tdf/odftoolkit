...
public class TableDataPilotMembersElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "data-pilot-members");
  ...
  public TableDataPilotMemberElement newTableDataPilotMemberElement(String tableNameValue) {
    TableDataPilotMemberElement tableDataPilotMember =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TableDataPilotMemberElement.class);
