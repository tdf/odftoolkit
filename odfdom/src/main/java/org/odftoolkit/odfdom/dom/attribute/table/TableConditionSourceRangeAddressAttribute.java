...
public class TableConditionSourceRangeAddressAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "condition-source-range-address");
   ...
   *
   * @return <code>true</code> if {@odf.attribute table:condition-source-range-address} has an
