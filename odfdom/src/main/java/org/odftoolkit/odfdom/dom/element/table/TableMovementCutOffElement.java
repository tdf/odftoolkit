...
public class TableMovementCutOffElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "movement-cut-off");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TableEndPositionAttribute
   * </code> , See {@odf.attribute table:end-position}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableEndPositionAttribute</code> , See
   * {@odf.attribute table:end-position}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TableStartPositionAttribute
   * </code> , See {@odf.attribute table:start-position}
   *
   * @return - the <code>Integer</code> , the value or <code>null</code>, if the attribute is not
   *     set and no default value defined.
   */
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableStartPositionAttribute</code> ,
   * See {@odf.attribute table:start-position}
   *
