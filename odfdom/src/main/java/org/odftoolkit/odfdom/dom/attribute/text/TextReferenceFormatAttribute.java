...
import org.odftoolkit.odfdom.OdfElement;import org.odftoolkit.odfdom.dom.element.text.TextReferenceRefElement;
...
public class TextReferenceFormatAttribute extends OdfAttribute {
	...
	public void setValue(String attrValue) {
		...
		if( parentElement != null ){
			try {
				if( parentElement instanceof TextReferenceRefElement ){
	 ...
	 * 
	 * @return <code>true</code> if text:reference-format has an element parent 
