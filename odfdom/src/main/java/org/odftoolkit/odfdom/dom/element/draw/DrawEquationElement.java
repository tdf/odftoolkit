...
public class DrawEquationElement extends OdfElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DrawFormulaAttribute</code> ,
   * See {@odf.attribute draw:formula}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getDrawFormulaAttribute() {
    DrawFormulaAttribute attr =
        (DrawFormulaAttribute) getOdfAttribute(OdfDocumentNamespace.DRAW, "formula");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DrawFormulaAttribute</code> , See
   * {@odf.attribute draw:formula}
   *
