...
public class MetaTemplateElement extends OdfElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>MetaDateAttribute</code> , See
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>MetaDateAttribute</code> , See
   * {@odf.attribute meta:date}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>XlinkTitleAttribute</code> ,
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>XlinkTitleAttribute</code> , See
