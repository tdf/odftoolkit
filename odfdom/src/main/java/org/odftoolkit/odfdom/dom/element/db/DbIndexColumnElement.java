...
public class DbIndexColumnElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "index-column");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DbIsAscendingAttribute</code> ,
   * See {@odf.attribute db:is-ascending}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbIsAscendingAttribute</code> , See
   * {@odf.attribute db:is-ascending}
   *
  ...
  public void setDbIsAscendingAttribute(Boolean dbIsAscendingValue) {
    ...
    attr.setBooleanValue(dbIsAscendingValue);
  }
