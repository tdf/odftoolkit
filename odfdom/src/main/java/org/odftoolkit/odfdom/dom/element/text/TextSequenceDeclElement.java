...
public class TextSequenceDeclElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "sequence-decl");
   ...
   * TextDisplayOutlineLevelAttribute</code> , See {@odf.attribute text:display-outline-level}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextDisplayOutlineLevelAttribute</code>
   * , See {@odf.attribute text:display-outline-level}
   *
  ...
  public void setTextDisplayOutlineLevelAttribute(Integer textDisplayOutlineLevelValue) {
    ...
    attr.setIntValue(textDisplayOutlineLevelValue);
  }
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>
   * TextSeparationCharacterAttribute</code> , See {@odf.attribute text:separation-character}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTextSeparationCharacterAttribute() {
    TextSeparationCharacterAttribute attr =
        (TextSeparationCharacterAttribute)
            getOdfAttribute(OdfDocumentNamespace.TEXT, "separation-character");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextSeparationCharacterAttribute</code>
   * , See {@odf.attribute text:separation-character}
   *
  ...
  public void setTextSeparationCharacterAttribute(String textSeparationCharacterValue) {
    TextSeparationCharacterAttribute attr =
        new TextSeparationCharacterAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
