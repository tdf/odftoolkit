...
{        
	...
	{
		TextDisplayOutlineLevelAttribute attr = (TextDisplayOutlineLevelAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.TEXT), "display-outline-level" ) ;
		if( attr != null ){
	...
	{
		TextSeparationCharacterAttribute attr = (TextSeparationCharacterAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.TEXT), "separation-character" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
