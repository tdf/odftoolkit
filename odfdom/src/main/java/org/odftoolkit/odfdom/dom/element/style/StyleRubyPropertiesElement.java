...
public class StyleRubyPropertiesElement extends OdfStylePropertiesBase {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.STYLE, "ruby-properties");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>StyleRubyAlignAttribute</code>
   * , See {@odf.attribute style:ruby-align}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getStyleRubyAlignAttribute() {
    StyleRubyAlignAttribute attr =
        (StyleRubyAlignAttribute) getOdfAttribute(OdfDocumentNamespace.STYLE, "ruby-align");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>StyleRubyAlignAttribute</code> , See
   * {@odf.attribute style:ruby-align}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>StyleRubyPositionAttribute
   * </code> , See {@odf.attribute style:ruby-position}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getStyleRubyPositionAttribute() {
    StyleRubyPositionAttribute attr =
        (StyleRubyPositionAttribute) getOdfAttribute(OdfDocumentNamespace.STYLE, "ruby-position");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>StyleRubyPositionAttribute</code> , See
   * {@odf.attribute style:ruby-position}
   *
  ...
  public void setStyleRubyPositionAttribute(String styleRubyPositionValue) {
    StyleRubyPositionAttribute attr =
        new StyleRubyPositionAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
