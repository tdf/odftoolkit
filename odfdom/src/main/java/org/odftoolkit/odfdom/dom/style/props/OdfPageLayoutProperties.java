...
public interface OdfPageLayoutProperties {
  ...
  public static final OdfStyleProperty PageHeight =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.FO, "page-height"));
  public static final OdfStyleProperty PageWidth =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.FO, "page-width"));
  ...
  public static final OdfStyleProperty FirstPageNumber =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "first-page-number"));
  public static final OdfStyleProperty FootnoteMaxHeight =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "footnote-max-height"));
  public static final OdfStyleProperty LayoutGridBaseHeight =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "layout-grid-base-height"));
  public static final OdfStyleProperty LayoutGridBaseWidth =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "layout-grid-base-width"));
  public static final OdfStyleProperty LayoutGridColor =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "layout-grid-color"));
  public static final OdfStyleProperty LayoutGridDisplay =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "layout-grid-display"));
  public static final OdfStyleProperty LayoutGridLines =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "layout-grid-lines"));
  public static final OdfStyleProperty LayoutGridMode =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "layout-grid-mode"));
  public static final OdfStyleProperty LayoutGridPrint =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "layout-grid-print"));
  public static final OdfStyleProperty LayoutGridRubyBelow =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "layout-grid-ruby-below"));
  public static final OdfStyleProperty LayoutGridRubyHeight =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "layout-grid-ruby-height"));
  public static final OdfStyleProperty LayoutGridSnapTo =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "layout-grid-snap-to"));
  public static final OdfStyleProperty LayoutGridStandardMode =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "layout-grid-standard-mode"));
  public static final OdfStyleProperty NumFormat =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "num-format"));
  public static final OdfStyleProperty NumLetterSync =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "num-letter-sync"));
  public static final OdfStyleProperty NumPrefix =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "num-prefix"));
  public static final OdfStyleProperty NumSuffix =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "num-suffix"));
  public static final OdfStyleProperty PaperTrayName =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "paper-tray-name"));
  public static final OdfStyleProperty Print =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "print"));
  public static final OdfStyleProperty PrintOrientation =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "print-orientation"));
  public static final OdfStyleProperty PrintPageOrder =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "print-page-order"));
  public static final OdfStyleProperty RegisterTruthRefStyleName =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "register-truth-ref-style-name"));
  ...
  public static final OdfStyleProperty ScaleToPages =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "scale-to-pages"));
  ...
  public static final OdfStyleProperty TableCentering =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.PageLayoutProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "table-centering"));
