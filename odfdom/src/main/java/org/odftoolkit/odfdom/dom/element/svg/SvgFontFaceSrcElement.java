...
public class SvgFontFaceSrcElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.SVG, "font-face-src");
  ...
  public SvgFontFaceNameElement newSvgFontFaceNameElement() {
    SvgFontFaceNameElement svgFontFaceName =
        ((OdfFileDom) this.ownerDocument).newOdfElement(SvgFontFaceNameElement.class);
   ...
   */
  public SvgFontFaceUriElement newSvgFontFaceUriElement(
      String xlinkHrefValue, String xlinkTypeValue) {
    SvgFontFaceUriElement svgFontFaceUri =
        ((OdfFileDom) this.ownerDocument).newOdfElement(SvgFontFaceUriElement.class);
