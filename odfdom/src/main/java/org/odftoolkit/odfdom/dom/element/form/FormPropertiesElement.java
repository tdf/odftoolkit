...
public class FormPropertiesElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.FORM, "properties");
   ...
   *
   * @param formPropertyNameValue the <code>String</code> value of <code>FormPropertyNameAttribute
   *     </code>, see {@odf.attribute form:property-name} at specification
   ...
   */
  public FormListPropertyElement newFormListPropertyElement(
      String formPropertyNameValue, String officeValueTypeValue) {
    FormListPropertyElement formListProperty =
        ((OdfFileDom) this.ownerDocument).newOdfElement(FormListPropertyElement.class);
   ...
   */
  public FormPropertyElement newFormPropertyElement(
      String formPropertyNameValue, double officeValueValue, String officeValueTypeValue) {
    FormPropertyElement formProperty =
        ((OdfFileDom) this.ownerDocument).newOdfElement(FormPropertyElement.class);
