...
public class FormListPropertyElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.FORM, "list-property");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>FormPropertyNameAttribute
   * </code> , See {@odf.attribute form:property-name}
   *
  ...
  public String getFormPropertyNameAttribute() {
    FormPropertyNameAttribute attr =
        (FormPropertyNameAttribute) getOdfAttribute(OdfDocumentNamespace.FORM, "property-name");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>FormPropertyNameAttribute</code> , See
   * {@odf.attribute form:property-name}
   *
   ...
   *
   * @param officeBooleanValueValue the <code>Boolean</code> value of <code>
   *     OfficeBooleanValueAttribute</code>, see {@odf.attribute office:boolean-value} at
   *     specification
   * @param officeDateValueValue the <code>String</code> value of <code>OfficeDateValueAttribute
   *     </code>, see {@odf.attribute office:date-value} at specification
   * @param officeStringValueValue the <code>String</code> value of <code>OfficeStringValueAttribute
   *     </code>, see {@odf.attribute office:string-value} at specification
   * @param officeTimeValueValue the <code>String</code> value of <code>OfficeTimeValueAttribute
   *     </code>, see {@odf.attribute office:time-value} at specification
   ...
   */
  public FormListValueElement newFormListValueElement(
      boolean officeBooleanValueValue,
      String officeDateValueValue,
      String officeStringValueValue,
      String officeTimeValueValue,
      double officeValueValue) {
    FormListValueElement formListValue =
        ((OdfFileDom) this.ownerDocument).newOdfElement(FormListValueElement.class);
