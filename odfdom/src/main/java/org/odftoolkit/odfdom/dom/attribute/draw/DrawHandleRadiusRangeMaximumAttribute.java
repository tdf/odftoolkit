...
public class DrawHandleRadiusRangeMaximumAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.DRAW, "handle-radius-range-maximum");
   ...
   *
   * @return <code>true</code> if {@odf.attribute draw:handle-radius-range-maximum} has an element
