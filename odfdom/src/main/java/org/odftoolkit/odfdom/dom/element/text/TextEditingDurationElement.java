...
public class TextEditingDurationElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "editing-duration");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextDurationAttribute</code> ,
   * See {@odf.attribute text:duration}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTextDurationAttribute() {
    TextDurationAttribute attr =
        (TextDurationAttribute) getOdfAttribute(OdfDocumentNamespace.TEXT, "duration");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextDurationAttribute</code> , See
   * {@odf.attribute text:duration}
   *
