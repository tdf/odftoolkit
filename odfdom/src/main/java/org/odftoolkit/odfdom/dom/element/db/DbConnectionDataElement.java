...
public class DbConnectionDataElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "connection-data");
   ...
   */
  public DbConnectionResourceElement newDbConnectionResourceElement(
      String xlinkHrefValue, String xlinkTypeValue) {
    DbConnectionResourceElement dbConnectionResource =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbConnectionResourceElement.class);
  ...
  public DbDatabaseDescriptionElement newDbDatabaseDescriptionElement() {
    DbDatabaseDescriptionElement dbDatabaseDescription =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbDatabaseDescriptionElement.class);
