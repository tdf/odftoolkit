...
public class TextChangeStartElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "change-start");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextChangeIdAttribute</code> ,
   * See {@odf.attribute text:change-id}
   *
  ...
  public String getTextChangeIdAttribute() {
    TextChangeIdAttribute attr =
        (TextChangeIdAttribute) getOdfAttribute(OdfDocumentNamespace.TEXT, "change-id");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextChangeIdAttribute</code> , See
   * {@odf.attribute text:change-id}
   *
