...
public class PresentationShowElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.PRESENTATION, "show");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>PresentationPagesAttribute
   * </code> , See {@odf.attribute presentation:pages}
   *
   * <p>Attribute is mandatory.
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
  ...
  public String getPresentationPagesAttribute() {
    PresentationPagesAttribute attr =
        (PresentationPagesAttribute) getOdfAttribute(OdfDocumentNamespace.PRESENTATION, "pages");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>PresentationPagesAttribute</code> , See
   * {@odf.attribute presentation:pages}
   *
  ...
  public void setPresentationPagesAttribute(String presentationPagesValue) {
    PresentationPagesAttribute attr =
        new PresentationPagesAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
