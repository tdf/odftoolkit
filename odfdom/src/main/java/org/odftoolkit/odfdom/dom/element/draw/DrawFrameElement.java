...
public class DrawFrameElement extends DrawShapeElementBase {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DrawCopyOfAttribute</code> ,
  ...
  public String getDrawCopyOfAttribute() {
    DrawCopyOfAttribute attr =
        (DrawCopyOfAttribute) getOdfAttribute(OdfDocumentNamespace.DRAW, "copy-of");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DrawCopyOfAttribute</code> , See
   * {@odf.attribute draw:copy-of}
   *
  ...
  public DrawAppletElement newDrawAppletElement() {
    DrawAppletElement drawApplet =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DrawAppletElement.class);
   ...
   *
   * @param drawRecreateOnEditValue the <code>Boolean</code> value of <code>
   *     DrawRecreateOnEditAttribute</code>, see {@odf.attribute draw:recreate-on-edit} at
   *     specification
   ...
   */
  public DrawContourPathElement newDrawContourPathElement(
      boolean drawRecreateOnEditValue, String svgDValue, int svgViewBoxValue) {
    DrawContourPathElement drawContourPath =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DrawContourPathElement.class);
   ...
   */
  public DrawContourPolygonElement newDrawContourPolygonElement(
      String drawPointsValue, boolean drawRecreateOnEditValue, int svgViewBoxValue) {
    DrawContourPolygonElement drawContourPolygon =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DrawContourPolygonElement.class);
  ...
  public DrawFloatingFrameElement newDrawFloatingFrameElement(
    ...
    DrawFloatingFrameElement drawFloatingFrame =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DrawFloatingFrameElement.class);
  ...
  public DrawImageElement newDrawImageElement() {
    DrawImageElement drawImage =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DrawImageElement.class);
  ...
  public DrawImageMapElement newDrawImageMapElement() {
    DrawImageMapElement drawImageMap =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DrawImageMapElement.class);
  ...
  public DrawObjectElement newDrawObjectElement() {
    DrawObjectElement drawObject =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DrawObjectElement.class);
  ...
  public DrawObjectOleElement newDrawObjectOleElement() {
    DrawObjectOleElement drawObjectOle =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DrawObjectOleElement.class);
  ...
  public DrawPluginElement newDrawPluginElement(String xlinkHrefValue, String xlinkTypeValue) {
    DrawPluginElement drawPlugin =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DrawPluginElement.class);
  ...
  public DrawTextBoxElement newDrawTextBoxElement() {
    DrawTextBoxElement drawTextBox =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DrawTextBoxElement.class);
