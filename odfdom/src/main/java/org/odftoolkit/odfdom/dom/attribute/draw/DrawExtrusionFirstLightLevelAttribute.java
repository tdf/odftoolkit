...
public class DrawExtrusionFirstLightLevelAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.DRAW, "extrusion-first-light-level");
   ...
   *
   * @return <code>true</code> if {@odf.attribute draw:extrusion-first-light-level} has an element
