...
public class TableNumberMatrixRowsSpannedAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "number-matrix-rows-spanned");
   ...
   *
   * @return <code>true</code> if {@odf.attribute table:number-matrix-rows-spanned} has an element
