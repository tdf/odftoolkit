...
public class MetaNonWhitespaceCharacterCountAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.META, "non-whitespace-character-count");
   ...
   *
   * @return <code>true</code> if {@odf.attribute meta:non-whitespace-character-count} has an
