...
public class OfficeScriptsElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.OFFICE, "scripts");
  ...
  public OfficeScriptElement newOfficeScriptElement(String scriptLanguageValue) {
    OfficeScriptElement officeScript =
        ((OdfFileDom) this.ownerDocument).newOdfElement(OfficeScriptElement.class);
