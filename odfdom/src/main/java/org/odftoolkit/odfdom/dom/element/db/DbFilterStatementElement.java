...
public class DbFilterStatementElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "filter-statement");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DbApplyCommandAttribute</code>
   * , See {@odf.attribute db:apply-command}
   *
   * @return - the <code>Boolean</code> , the value or <code>null</code>, if the attribute is not
   *     set and no default value defined.
   */
  public Boolean getDbApplyCommandAttribute() {
    DbApplyCommandAttribute attr =
        (DbApplyCommandAttribute) getOdfAttribute(OdfDocumentNamespace.DB, "apply-command");
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbApplyCommandAttribute</code> , See
   * {@odf.attribute db:apply-command}
   *
  ...
  public void setDbApplyCommandAttribute(Boolean dbApplyCommandValue) {
    ...
    attr.setBooleanValue(dbApplyCommandValue);
  }
