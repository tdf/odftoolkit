...
public class TableFilterElement extends OdfElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TableConditionSourceAttribute
   * </code> , See {@odf.attribute table:condition-source}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTableConditionSourceAttribute() {
    TableConditionSourceAttribute attr =
        (TableConditionSourceAttribute)
            getOdfAttribute(OdfDocumentNamespace.TABLE, "condition-source");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableConditionSourceAttribute</code> ,
   * See {@odf.attribute table:condition-source}
   *
  ...
  public void setTableConditionSourceAttribute(String tableConditionSourceValue) {
    TableConditionSourceAttribute attr =
        new TableConditionSourceAttribute((OdfFileDom) this.ownerDocument);
   ...
   * TableConditionSourceRangeAddressAttribute</code> , See {@odf.attribute
  ...
  public String getTableConditionSourceRangeAddressAttribute() {
    TableConditionSourceRangeAddressAttribute attr =
        (TableConditionSourceRangeAddressAttribute)
            getOdfAttribute(OdfDocumentNamespace.TABLE, "condition-source-range-address");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
   ...
   */
  public void setTableConditionSourceRangeAddressAttribute(
      String tableConditionSourceRangeAddressValue) {
    TableConditionSourceRangeAddressAttribute attr =
        new TableConditionSourceRangeAddressAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
    attr.setValue(tableConditionSourceRangeAddressValue);
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>TableDisplayDuplicatesAttribute
   * </code> , See {@odf.attribute table:display-duplicates}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableDisplayDuplicatesAttribute</code>
   * , See {@odf.attribute table:display-duplicates}
   *
  ...
  public void setTableDisplayDuplicatesAttribute(Boolean tableDisplayDuplicatesValue) {
    TableDisplayDuplicatesAttribute attr =
        new TableDisplayDuplicatesAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
    attr.setBooleanValue(tableDisplayDuplicatesValue);
  }
  ...
  public TableFilterAndElement newTableFilterAndElement() {
    TableFilterAndElement tableFilterAnd =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TableFilterAndElement.class);
