...
public class Dr3dLightElement extends OdfElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>Dr3dDirectionAttribute</code> ,
   * See {@odf.attribute dr3d:direction}
   *
  ...
  public String getDr3dDirectionAttribute() {
    Dr3dDirectionAttribute attr =
        (Dr3dDirectionAttribute) getOdfAttribute(OdfDocumentNamespace.DR3D, "direction");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>Dr3dDirectionAttribute</code> , See
   * {@odf.attribute dr3d:direction}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>Dr3dEnabledAttribute</code> ,
   * See {@odf.attribute dr3d:enabled}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>Dr3dEnabledAttribute</code> , See
   * {@odf.attribute dr3d:enabled}
   *
  ...
  public void setDr3dEnabledAttribute(Boolean dr3dEnabledValue) {
    ...
    setOdfAttribute(attr);
    attr.setBooleanValue(dr3dEnabledValue);
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>Dr3dSpecularAttribute</code> ,
   * See {@odf.attribute dr3d:specular}
   *
   * @return - the <code>Boolean</code> , the value or <code>null</code>, if the attribute is not
   *     set and no default value defined.
   */
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>Dr3dSpecularAttribute</code> , See
   * {@odf.attribute dr3d:specular}
   *
  ...
  public void setDr3dSpecularAttribute(Boolean dr3dSpecularValue) {
    ...
    setOdfAttribute(attr);
    attr.setBooleanValue(dr3dSpecularValue);
  }
