...
public class ChartSubtitleElement extends OdfStylableElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.CHART, "subtitle");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TableCellRangeAttribute</code>
   * , See {@odf.attribute table:cell-range}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTableCellRangeAttribute() {
    TableCellRangeAttribute attr =
        (TableCellRangeAttribute) getOdfAttribute(OdfDocumentNamespace.TABLE, "cell-range");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableCellRangeAttribute</code> , See
   * {@odf.attribute table:cell-range}
   *
