...
public class DrawNotifyOnUpdateOfRangesAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.DRAW, "notify-on-update-of-ranges");
   ...
   *
   * @return <code>true</code> if {@odf.attribute draw:notify-on-update-of-ranges} has an element
