...
public class OfficeSpreadsheetElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.OFFICE, "spreadsheet");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>
   * TableStructureProtectedAttribute</code> , See {@odf.attribute table:structure-protected}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableStructureProtectedAttribute</code>
   * , See {@odf.attribute table:structure-protected}
   *
  ...
  public void setTableStructureProtectedAttribute(Boolean tableStructureProtectedValue) {
    ...
    setOdfAttribute(attr);
    attr.setValue(tableStructureProtectedValue.toString());
  }
  ...
  public TableTrackedChangesElement newTableTrackedChangesElement() {
    TableTrackedChangesElement tableTrackedChanges =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TableTrackedChangesElement.class);
