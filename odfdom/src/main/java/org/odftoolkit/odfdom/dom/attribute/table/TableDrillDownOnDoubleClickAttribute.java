...
public class TableDrillDownOnDoubleClickAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "drill-down-on-double-click");
   ...
   *
   * @return <code>true</code> if {@odf.attribute table:drill-down-on-double-click} has an element
