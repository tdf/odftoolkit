...
public class StyleTablePropertiesElement extends OdfStylePropertiesBase {
   ...
   * StyleMayBreakBetweenRowsAttribute</code> , See {@odf.attribute style:may-break-between-rows}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>StyleMayBreakBetweenRowsAttribute
   * </code> , See {@odf.attribute style:may-break-between-rows}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TableAlignAttribute</code> ,
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableAlignAttribute</code> , See
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TableBorderModelAttribute
   * </code> , See {@odf.attribute table:border-model}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableBorderModelAttribute</code> , See
