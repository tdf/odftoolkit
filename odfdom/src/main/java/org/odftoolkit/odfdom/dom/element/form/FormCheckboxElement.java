...
{        
	...
	{
		FormVisualEffectAttribute attr = (FormVisualEffectAttribute) getOdfAttribute( OdfName.newName( OdfNamespace.newNamespace(OdfNamespaceNames.FORM), "visual-effect" ) );
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		FormCurrentStateAttribute attr = (FormCurrentStateAttribute) getOdfAttribute( OdfName.newName( OdfNamespace.newNamespace(OdfNamespaceNames.FORM), "current-state" ) );
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		FormIsTristateAttribute attr = (FormIsTristateAttribute) getOdfAttribute( OdfName.newName( OdfNamespace.newNamespace(OdfNamespaceNames.FORM), "is-tristate" ) );
		if( attr != null ){
			return Boolean.valueOf( attr.booleanValue() );
		}
	...
	{
		FormStateAttribute attr = (FormStateAttribute) getOdfAttribute( OdfName.newName( OdfNamespace.newNamespace(OdfNamespaceNames.FORM), "state" ) );
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
