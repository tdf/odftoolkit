...
public class FormCheckboxElement extends OdfElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>FormCurrentStateAttribute
   * </code> , See {@odf.attribute form:current-state}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getFormCurrentStateAttribute() {
    FormCurrentStateAttribute attr =
        (FormCurrentStateAttribute) getOdfAttribute(OdfDocumentNamespace.FORM, "current-state");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>FormCurrentStateAttribute</code> , See
   * {@odf.attribute form:current-state}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>FormIsTristateAttribute</code>
   * , See {@odf.attribute form:is-tristate}
   *
   * @return - the <code>Boolean</code> , the value or <code>null</code>, if the attribute is not
   *     set and no default value defined.
   */
  public Boolean getFormIsTristateAttribute() {
    FormIsTristateAttribute attr =
        (FormIsTristateAttribute) getOdfAttribute(OdfDocumentNamespace.FORM, "is-tristate");
    if (attr != null && !attr.getValue().isEmpty()) {
      return Boolean.valueOf(attr.getValue());
    }
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>FormIsTristateAttribute</code> , See
   * {@odf.attribute form:is-tristate}
   *
  ...
  public void setFormIsTristateAttribute(Boolean formIsTristateValue) {
    ...
    setOdfAttribute(attr);
    attr.setValue(formIsTristateValue.toString());
  }
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>FormStateAttribute</code> , See
   * {@odf.attribute form:state}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getFormStateAttribute() {
    FormStateAttribute attr =
        (FormStateAttribute) getOdfAttribute(OdfDocumentNamespace.FORM, "state");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>FormStateAttribute</code> , See
   * {@odf.attribute form:state}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>FormVisualEffectAttribute
   * </code> , See {@odf.attribute form:visual-effect}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getFormVisualEffectAttribute() {
    FormVisualEffectAttribute attr =
        (FormVisualEffectAttribute) getOdfAttribute(OdfDocumentNamespace.FORM, "visual-effect");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>FormVisualEffectAttribute</code> , See
   * {@odf.attribute form:visual-effect}
   *
