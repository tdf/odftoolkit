...
public class StyleTabStopsElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.STYLE, "tab-stops");
   ...
   *     {@odf.attribute style:type} at specification Child element was added in ODF 1.2
   * @return the element {@odf.element style:tab-stop}
   */
  public StyleTabStopElement newStyleTabStopElement(
      String stylePositionValue, String styleTypeValue) {
    StyleTabStopElement styleTabStop =
        ((OdfFileDom) this.ownerDocument).newOdfElement(StyleTabStopElement.class);
