...
public class TableCellRangeSourceElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "cell-range-source");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TableFilterNameAttribute</code>
   * , See {@odf.attribute table:filter-name}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTableFilterNameAttribute() {
    TableFilterNameAttribute attr =
        (TableFilterNameAttribute) getOdfAttribute(OdfDocumentNamespace.TABLE, "filter-name");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableFilterNameAttribute</code> , See
   * {@odf.attribute table:filter-name}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TableFilterOptionsAttribute
   * </code> , See {@odf.attribute table:filter-options}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTableFilterOptionsAttribute() {
    TableFilterOptionsAttribute attr =
        (TableFilterOptionsAttribute) getOdfAttribute(OdfDocumentNamespace.TABLE, "filter-options");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableFilterOptionsAttribute</code> ,
   * See {@odf.attribute table:filter-options}
   *
  ...
  public void setTableFilterOptionsAttribute(String tableFilterOptionsValue) {
    TableFilterOptionsAttribute attr =
        new TableFilterOptionsAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
    attr.setValue(tableFilterOptionsValue);
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>TableLastColumnSpannedAttribute
   * </code> , See {@odf.attribute table:last-column-spanned}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableLastColumnSpannedAttribute</code>
   * , See {@odf.attribute table:last-column-spanned}
   *
  ...
  public void setTableLastColumnSpannedAttribute(Integer tableLastColumnSpannedValue) {
    TableLastColumnSpannedAttribute attr =
        new TableLastColumnSpannedAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
    attr.setIntValue(tableLastColumnSpannedValue);
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>TableLastRowSpannedAttribute
   * </code> , See {@odf.attribute table:last-row-spanned}
   *
   * <p>Attribute is mandatory.
   *
   * @return - the <code>Integer</code> , the value or <code>null</code>, if the attribute is not
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableLastRowSpannedAttribute</code> ,
   * See {@odf.attribute table:last-row-spanned}
   *
  ...
  public void setTableLastRowSpannedAttribute(Integer tableLastRowSpannedValue) {
    TableLastRowSpannedAttribute attr =
        new TableLastRowSpannedAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
    attr.setIntValue(tableLastRowSpannedValue);
  }
