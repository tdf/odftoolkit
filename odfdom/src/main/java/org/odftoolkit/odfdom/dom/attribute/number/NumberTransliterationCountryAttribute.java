...
public class NumberTransliterationCountryAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.NUMBER, "transliteration-country");
   ...
   *
   * @return <code>true</code> if {@odf.attribute number:transliteration-country} has an element
