...
{        
	...
	{
		NumberMinExponentDigitsAttribute attr = (NumberMinExponentDigitsAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.NUMBER), "min-exponent-digits" ) ;
		if( attr != null ){
