...
public class NumberScientificNumberElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.NUMBER, "scientific-number");
   ...
   * NumberMinExponentDigitsAttribute</code> , See {@odf.attribute number:min-exponent-digits}
   *
   * @return - the <code>Integer</code> , the value or <code>null</code>, if the attribute is not
   *     set and no default value defined.
   */
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>NumberMinExponentDigitsAttribute</code>
   * , See {@odf.attribute number:min-exponent-digits}
   *
