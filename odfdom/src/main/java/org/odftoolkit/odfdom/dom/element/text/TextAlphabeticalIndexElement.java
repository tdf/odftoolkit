...
public class TextAlphabeticalIndexElement extends OdfStylableElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "alphabetical-index");
  ...
  public TextAlphabeticalIndexSourceElement newTextAlphabeticalIndexSourceElement() {
    TextAlphabeticalIndexSourceElement textAlphabeticalIndexSource =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TextAlphabeticalIndexSourceElement.class);
