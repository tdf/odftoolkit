...
public class TableDataPilotSubtotalsElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "data-pilot-subtotals");
  ...
  public TableDataPilotSubtotalElement newTableDataPilotSubtotalElement(String tableFunctionValue) {
    TableDataPilotSubtotalElement tableDataPilotSubtotal =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TableDataPilotSubtotalElement.class);
