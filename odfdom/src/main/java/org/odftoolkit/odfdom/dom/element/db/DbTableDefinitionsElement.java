...
public class DbTableDefinitionsElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "table-definitions");
  ...
  public DbTableDefinitionElement newDbTableDefinitionElement(String dbNameValue) {
    DbTableDefinitionElement dbTableDefinition =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbTableDefinitionElement.class);
