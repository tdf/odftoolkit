...
public class Dr3dSphereElement extends OdfStyleableShapeElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>Dr3dCenterAttribute</code> ,
   * See {@odf.attribute dr3d:center}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getDr3dCenterAttribute() {
    Dr3dCenterAttribute attr =
        (Dr3dCenterAttribute) getOdfAttribute(OdfDocumentNamespace.DR3D, "center");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>Dr3dCenterAttribute</code> , See
   * {@odf.attribute dr3d:center}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>Dr3dSizeAttribute</code> , See
   * {@odf.attribute dr3d:size}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>Dr3dSizeAttribute</code> , See
   * {@odf.attribute dr3d:size}
   *
