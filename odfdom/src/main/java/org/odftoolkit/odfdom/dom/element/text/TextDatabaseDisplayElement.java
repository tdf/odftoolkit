...
public class TextDatabaseDisplayElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "database-display");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextColumnNameAttribute</code>
  ...
  public String getTextColumnNameAttribute() {
    TextColumnNameAttribute attr =
        (TextColumnNameAttribute) getOdfAttribute(OdfDocumentNamespace.TEXT, "column-name");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextColumnNameAttribute</code> , See
   * {@odf.attribute text:column-name}
   *
