...
public class DbIsTableNameLengthLimitedAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "is-table-name-length-limited");
   ...
   *
   * @return <code>true</code> if {@odf.attribute db:is-table-name-length-limited} has an element
