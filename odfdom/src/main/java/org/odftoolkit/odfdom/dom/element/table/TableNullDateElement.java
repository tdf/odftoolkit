...
public class TableNullDateElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "null-date");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TableDateValueAttribute</code>
   * , See {@odf.attribute table:date-value}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTableDateValueAttribute() {
    TableDateValueAttribute attr =
        (TableDateValueAttribute) getOdfAttribute(OdfDocumentNamespace.TABLE, "date-value");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableDateValueAttribute</code> , See
   * {@odf.attribute table:date-value}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TableValueTypeAttribute</code>
   * , See {@odf.attribute table:value-type}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTableValueTypeAttribute() {
    TableValueTypeAttribute attr =
        (TableValueTypeAttribute) getOdfAttribute(OdfDocumentNamespace.TABLE, "value-type");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableValueTypeAttribute</code> , See
   * {@odf.attribute table:value-type}
   *
