...
public class TextIllustrationIndexSourceElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "illustration-index-source");
   ...
   * TextCaptionSequenceFormatAttribute</code> , See {@odf.attribute text:caption-sequence-format}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTextCaptionSequenceFormatAttribute() {
    TextCaptionSequenceFormatAttribute attr =
        (TextCaptionSequenceFormatAttribute)
            getOdfAttribute(OdfDocumentNamespace.TEXT, "caption-sequence-format");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextCaptionSequenceFormatAttribute
   * </code> , See {@odf.attribute text:caption-sequence-format}
   *
  ...
  public void setTextCaptionSequenceFormatAttribute(String textCaptionSequenceFormatValue) {
    TextCaptionSequenceFormatAttribute attr =
        new TextCaptionSequenceFormatAttribute((OdfFileDom) this.ownerDocument);
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>
   * TextCaptionSequenceNameAttribute</code> , See {@odf.attribute text:caption-sequence-name}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTextCaptionSequenceNameAttribute() {
    TextCaptionSequenceNameAttribute attr =
        (TextCaptionSequenceNameAttribute)
            getOdfAttribute(OdfDocumentNamespace.TEXT, "caption-sequence-name");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextCaptionSequenceNameAttribute</code>
   * , See {@odf.attribute text:caption-sequence-name}
   *
  ...
  public void setTextCaptionSequenceNameAttribute(String textCaptionSequenceNameValue) {
    TextCaptionSequenceNameAttribute attr =
        new TextCaptionSequenceNameAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextUseCaptionAttribute</code>
   * , See {@odf.attribute text:use-caption}
   *
   * @return - the <code>Boolean</code> , the value or <code>null</code>, if the attribute is not
   *     set and no default value defined.
   */
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextUseCaptionAttribute</code> , See
   * {@odf.attribute text:use-caption}
   *
  ...
  public void setTextUseCaptionAttribute(Boolean textUseCaptionValue) {
    ...
    setOdfAttribute(attr);
    attr.setBooleanValue(textUseCaptionValue);
  }
   ...
   */
  public TextIllustrationIndexEntryTemplateElement newTextIllustrationIndexEntryTemplateElement(
      String textStyleNameValue) {
    TextIllustrationIndexEntryTemplateElement textIllustrationIndexEntryTemplate =
        ((OdfFileDom) this.ownerDocument)
            .newOdfElement(TextIllustrationIndexEntryTemplateElement.class);
