...
public class DrawExtrusionSecondLightLevelAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.DRAW, "extrusion-second-light-level");
   ...
   *
   * @return <code>true</code> if {@odf.attribute draw:extrusion-second-light-level} has an element
