...
public class DbAdditionalColumnStatementAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "additional-column-statement");
   ...
   *
   * @return <code>true</code> if {@odf.attribute db:additional-column-statement} has an element
