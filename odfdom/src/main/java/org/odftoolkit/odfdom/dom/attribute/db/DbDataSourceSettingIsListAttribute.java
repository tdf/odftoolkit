...
public class DbDataSourceSettingIsListAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "data-source-setting-is-list");
   ...
   *
   * @return <code>true</code> if {@odf.attribute db:data-source-setting-is-list} has an element
