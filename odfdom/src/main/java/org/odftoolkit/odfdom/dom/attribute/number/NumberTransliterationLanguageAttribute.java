...
public class NumberTransliterationLanguageAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.NUMBER, "transliteration-language");
   ...
   *
   * @return <code>true</code> if {@odf.attribute number:transliteration-language} has an element
