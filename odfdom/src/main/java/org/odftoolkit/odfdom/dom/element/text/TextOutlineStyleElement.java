...
public class TextOutlineStyleElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "outline-style");
   ...
   *     {@odf.attribute text:level} at specification Child element is mandatory.
   * @return the element {@odf.element text:outline-level-style}
   */
  public TextOutlineLevelStyleElement newTextOutlineLevelStyleElement(
      String styleNumFormatValue, int textLevelValue) {
    TextOutlineLevelStyleElement textOutlineLevelStyle =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TextOutlineLevelStyleElement.class);
