...
public class SvgFontFaceUriElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.SVG, "font-face-uri");
  ...
  public SvgFontFaceFormatElement newSvgFontFaceFormatElement() {
    SvgFontFaceFormatElement svgFontFaceFormat =
        ((OdfFileDom) this.ownerDocument).newOdfElement(SvgFontFaceFormatElement.class);
