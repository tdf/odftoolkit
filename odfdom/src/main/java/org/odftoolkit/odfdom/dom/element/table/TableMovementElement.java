...
public class TableMovementElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "movement");
  ...
  public TableSourceRangeAddressElement newTableSourceRangeAddressElement() {
    TableSourceRangeAddressElement tableSourceRangeAddress =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TableSourceRangeAddressElement.class);
  ...
  public TableTargetRangeAddressElement newTableTargetRangeAddressElement() {
    TableTargetRangeAddressElement tableTargetRangeAddress =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TableTargetRangeAddressElement.class);
