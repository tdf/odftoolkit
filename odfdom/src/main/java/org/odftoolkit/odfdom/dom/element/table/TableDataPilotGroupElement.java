...
public class TableDataPilotGroupElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "data-pilot-group");
   ...
   */
  public TableDataPilotGroupMemberElement newTableDataPilotGroupMemberElement(
      String tableNameValue) {
    TableDataPilotGroupMemberElement tableDataPilotGroupMember =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TableDataPilotGroupMemberElement.class);
