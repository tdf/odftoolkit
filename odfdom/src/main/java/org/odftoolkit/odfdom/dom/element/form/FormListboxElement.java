...
{        
	...
	{
		FormDropdownAttribute attr = (FormDropdownAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.FORM), "dropdown" ) ;
		if( attr != null ){
			return Boolean.valueOf( attr.booleanValue() );
		}
	...
	{
		FormSizeAttribute attr = (FormSizeAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.FORM), "size" ) ;
		if( attr != null ){
	...
	{
		FormBoundColumnAttribute attr = (FormBoundColumnAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.FORM), "bound-column" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		FormListSourceAttribute attr = (FormListSourceAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.FORM), "list-source" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		FormListSourceTypeAttribute attr = (FormListSourceTypeAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.FORM), "list-source-type" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		FormListLinkageTypeAttribute attr = (FormListLinkageTypeAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.FORM), "list-linkage-type" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		FormSourceCellRangeAttribute attr = (FormSourceCellRangeAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.FORM), "source-cell-range" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		FormMultipleAttribute attr = (FormMultipleAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.FORM), "multiple" ) ;
		if( attr != null ){
			return Boolean.valueOf( attr.booleanValue() );
		}
	...
	{
		FormXformsListSourceAttribute attr = (FormXformsListSourceAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.FORM), "xforms-list-source" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
