...
public class MetaAutoReloadElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.META, "auto-reload");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>MetaDelayAttribute</code> , See
   * {@odf.attribute meta:delay}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getMetaDelayAttribute() {
    MetaDelayAttribute attr =
        (MetaDelayAttribute) getOdfAttribute(OdfDocumentNamespace.META, "delay");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>MetaDelayAttribute</code> , See
   * {@odf.attribute meta:delay}
   *
