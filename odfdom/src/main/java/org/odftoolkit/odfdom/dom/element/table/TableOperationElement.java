...
public class TableOperationElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "operation");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TableIndexAttribute</code> ,
   * See {@odf.attribute table:index}
   *
  ...
  public Integer getTableIndexAttribute() {
    TableIndexAttribute attr =
        (TableIndexAttribute) getOdfAttribute(OdfDocumentNamespace.TABLE, "index");
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableIndexAttribute</code> , See
   * {@odf.attribute table:index}
   *
  ...
  public void setTableIndexAttribute(Integer tableIndexValue) {
    ...
    attr.setIntValue(tableIndexValue);
  }
