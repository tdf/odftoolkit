...
public class StyleLegendExpansionAspectRatioAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.STYLE, "legend-expansion-aspect-ratio");
   ...
   *
   * @return <code>true</code> if {@odf.attribute style:legend-expansion-aspect-ratio} has an
