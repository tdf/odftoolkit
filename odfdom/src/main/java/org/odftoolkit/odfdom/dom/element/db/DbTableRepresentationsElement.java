...
public class DbTableRepresentationsElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "table-representations");
  ...
  public DbTableRepresentationElement newDbTableRepresentationElement(String dbNameValue) {
    DbTableRepresentationElement dbTableRepresentation =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbTableRepresentationElement.class);
