...
public class DrawObjectElement extends OdfElement {
   ...
   * DrawNotifyOnUpdateOfRangesAttribute</code> , See {@odf.attribute
  ...
  public String getDrawNotifyOnUpdateOfRangesAttribute() {
    DrawNotifyOnUpdateOfRangesAttribute attr =
        (DrawNotifyOnUpdateOfRangesAttribute)
            getOdfAttribute(OdfDocumentNamespace.DRAW, "notify-on-update-of-ranges");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DrawNotifyOnUpdateOfRangesAttribute
   * </code> , See {@odf.attribute draw:notify-on-update-of-ranges}
   *
  ...
  public void setDrawNotifyOnUpdateOfRangesAttribute(String drawNotifyOnUpdateOfRangesValue) {
    DrawNotifyOnUpdateOfRangesAttribute attr =
        new DrawNotifyOnUpdateOfRangesAttribute((OdfFileDom) this.ownerDocument);
