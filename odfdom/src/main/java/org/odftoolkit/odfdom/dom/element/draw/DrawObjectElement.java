...
{        
	...
	{
		DrawNotifyOnUpdateOfRangesAttribute attr = (DrawNotifyOnUpdateOfRangesAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.DRAW), "notify-on-update-of-ranges" ) ;
		if( attr != null ){
