...
{        
	...
	{
		ChartLegendPositionAttribute attr = (ChartLegendPositionAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.CHART), "legend-position" ) ;
		if( attr != null ){
	...
	{
		ChartLegendAlignAttribute attr = (ChartLegendAlignAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.CHART), "legend-align" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		StyleLegendExpansionAttribute attr = (StyleLegendExpansionAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.STYLE), "legend-expansion" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		StyleLegendExpansionAspectRatioAttribute attr = (StyleLegendExpansionAspectRatioAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.STYLE), "legend-expansion-aspect-ratio" ) ;
		if( attr != null ){
