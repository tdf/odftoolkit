...
public class TextTableIndexSourceElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "table-index-source");
   ...
   */
  public TextTableIndexEntryTemplateElement newTextTableIndexEntryTemplateElement(
      String textStyleNameValue) {
    TextTableIndexEntryTemplateElement textTableIndexEntryTemplate =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TextTableIndexEntryTemplateElement.class);
