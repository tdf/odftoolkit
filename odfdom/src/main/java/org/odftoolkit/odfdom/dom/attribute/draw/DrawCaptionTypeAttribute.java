...
public class DrawCaptionTypeAttribute extends OdfAttribute {
  ...
  public enum Value {
    ANGLED_CONNECTOR_LINE("angled-connector-line"),
    ANGLED_LINE("angled-line"),
   ...
   *
   * @return <code>true</code> if {@odf.attribute draw:caption-type} has an element parent otherwise
