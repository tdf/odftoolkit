...
public class TextChangedRegionElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "changed-region");
  ...
  public TextDeletionElement newTextDeletionElement() {
    TextDeletionElement textDeletion =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TextDeletionElement.class);
  ...
  public TextFormatChangeElement newTextFormatChangeElement() {
    TextFormatChangeElement textFormatChange =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TextFormatChangeElement.class);
  ...
  public TextInsertionElement newTextInsertionElement() {
    TextInsertionElement textInsertion =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TextInsertionElement.class);
