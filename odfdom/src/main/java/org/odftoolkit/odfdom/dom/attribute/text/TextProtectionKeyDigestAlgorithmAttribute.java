...
public class TextProtectionKeyDigestAlgorithmAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "protection-key-digest-algorithm");
   ...
   *
   * @return <code>true</code> if {@odf.attribute text:protection-key-digest-algorithm} has an
