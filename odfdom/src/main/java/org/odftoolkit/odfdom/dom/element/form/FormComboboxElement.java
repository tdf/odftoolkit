...
public class FormComboboxElement extends OdfElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>FormAutoCompleteAttribute
   * </code> , See {@odf.attribute form:auto-complete}
   *
   * @return - the <code>Boolean</code> , the value or <code>null</code>, if the attribute is not
   *     set and no default value defined.
   */
  public Boolean getFormAutoCompleteAttribute() {
    FormAutoCompleteAttribute attr =
        (FormAutoCompleteAttribute) getOdfAttribute(OdfDocumentNamespace.FORM, "auto-complete");
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>FormAutoCompleteAttribute</code> , See
   * {@odf.attribute form:auto-complete}
   *
  ...
  public void setFormAutoCompleteAttribute(Boolean formAutoCompleteValue) {
    ...
    attr.setBooleanValue(formAutoCompleteValue);
  }
  ...
  public FormItemElement newFormItemElement() {
    FormItemElement formItem =
        ((OdfFileDom) this.ownerDocument).newOdfElement(FormItemElement.class);
