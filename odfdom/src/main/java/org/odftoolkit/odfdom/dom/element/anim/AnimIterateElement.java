...
{        
	...
	{
		AnimIterateTypeAttribute attr = (AnimIterateTypeAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.ANIM), "iterate-type" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		AnimIterateIntervalAttribute attr = (AnimIterateIntervalAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.ANIM), "iterate-interval" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		SmilEndsyncAttribute attr = (SmilEndsyncAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.SMIL), "endsync" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
