...
{        
	...
	{
		AnimIterateTypeAttribute attr = (AnimIterateTypeAttribute) getOdfAttribute( OdfName.newName( OdfNamespace.newNamespace(OdfNamespaceNames.ANIM), "iterate-type" ) );
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		AnimIterateIntervalAttribute attr = (AnimIterateIntervalAttribute) getOdfAttribute( OdfName.newName( OdfNamespace.newNamespace(OdfNamespaceNames.ANIM), "iterate-interval" ) );
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
