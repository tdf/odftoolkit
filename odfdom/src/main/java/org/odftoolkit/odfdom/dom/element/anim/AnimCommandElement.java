...
public class AnimCommandElement extends OdfElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>AnimCommandAttribute</code> ,
   * See {@odf.attribute anim:command}
   *
  ...
  public String getAnimCommandAttribute() {
    AnimCommandAttribute attr =
        (AnimCommandAttribute) getOdfAttribute(OdfDocumentNamespace.ANIM, "command");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>AnimCommandAttribute</code> , See
   * {@odf.attribute anim:command}
   *
   ...
   *
   * @param animNameValue the <code>String</code> value of <code>AnimNameAttribute</code>, see
   *     {@odf.attribute anim:name} at specification
   * @param animValueValue the <code>String</code> value of <code>AnimValueAttribute</code>, see
   *     {@odf.attribute anim:value} at specification
  ...
  public AnimParamElement newAnimParamElement(String animNameValue, String animValueValue) {
    AnimParamElement animParam =
        ((OdfFileDom) this.ownerDocument).newOdfElement(AnimParamElement.class);
