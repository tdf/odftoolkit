...
public class TextRelativeTabStopPositionAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "relative-tab-stop-position");
   ...
   *
   * @return <code>true</code> if {@odf.attribute text:relative-tab-stop-position} has an element
