...
public class DbSchemaDefinitionElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "schema-definition");
  ...
  public DbTableDefinitionsElement newDbTableDefinitionsElement() {
    DbTableDefinitionsElement dbTableDefinitions =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbTableDefinitionsElement.class);
