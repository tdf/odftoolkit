...
public class DbTableDefinitionElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "table-definition");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DbSchemaNameAttribute</code> ,
   * See {@odf.attribute db:schema-name}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getDbSchemaNameAttribute() {
    DbSchemaNameAttribute attr =
        (DbSchemaNameAttribute) getOdfAttribute(OdfDocumentNamespace.DB, "schema-name");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbSchemaNameAttribute</code> , See
   * {@odf.attribute db:schema-name}
   *
  ...
  public DbColumnDefinitionsElement newDbColumnDefinitionsElement() {
    DbColumnDefinitionsElement dbColumnDefinitions =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbColumnDefinitionsElement.class);
  ...
  public DbIndicesElement newDbIndicesElement() {
    DbIndicesElement dbIndices =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbIndicesElement.class);
