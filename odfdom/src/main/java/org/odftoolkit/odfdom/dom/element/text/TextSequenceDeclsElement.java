...
public class TextSequenceDeclsElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "sequence-decls");
   ...
   *
   * @param textDisplayOutlineLevelValue the <code>Integer</code> value of <code>
   *     TextDisplayOutlineLevelAttribute</code>, see {@odf.attribute text:display-outline-level} at
   *     specification
   ...
   */
  public TextSequenceDeclElement newTextSequenceDeclElement(
      int textDisplayOutlineLevelValue, String textNameValue) {
    TextSequenceDeclElement textSequenceDecl =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TextSequenceDeclElement.class);
