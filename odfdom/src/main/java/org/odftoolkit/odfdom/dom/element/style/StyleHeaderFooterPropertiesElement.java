...
public class StyleHeaderFooterPropertiesElement extends OdfStylePropertiesBase {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.STYLE, "header-footer-properties");
  ...
  public static final OdfStyleProperty DynamicSpacing =
      OdfStyleProperty.get(
          OdfStylePropertiesSet.HeaderFooterProperties,
          OdfName.newName(OdfDocumentNamespace.STYLE, "dynamic-spacing"));
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>StyleDynamicSpacingAttribute
   * </code> , See {@odf.attribute style:dynamic-spacing}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>StyleDynamicSpacingAttribute</code> ,
   * See {@odf.attribute style:dynamic-spacing}
   *
  ...
  public void setStyleDynamicSpacingAttribute(Boolean styleDynamicSpacingValue) {
    StyleDynamicSpacingAttribute attr =
        new StyleDynamicSpacingAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
    attr.setBooleanValue(styleDynamicSpacingValue);
  }
