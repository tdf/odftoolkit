...
public class TableNamedExpressionElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "named-expression");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TableExpressionAttribute</code>
   * , See {@odf.attribute table:expression}
   *
  ...
  public String getTableExpressionAttribute() {
    TableExpressionAttribute attr =
        (TableExpressionAttribute) getOdfAttribute(OdfDocumentNamespace.TABLE, "expression");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableExpressionAttribute</code> , See
   * {@odf.attribute table:expression}
   *
