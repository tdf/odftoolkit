...
{        
    public static final OdfName ELEMENT_NAME = OdfName.newName(OdfNamespaceNames.TEXT, "ruby-text" );
	...
	{
		super( ownerDoc, ELEMENT_NAME, OdfStyleFamily.Ruby, OdfName.newName(OdfNamespaceNames.TEXT, "style-name" )	);
	}
