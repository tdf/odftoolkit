...
public class DrawHandleRadiusRangeMinimumAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.DRAW, "handle-radius-range-minimum");
   ...
   *
   * @return <code>true</code> if {@odf.attribute draw:handle-radius-range-minimum} has an element
