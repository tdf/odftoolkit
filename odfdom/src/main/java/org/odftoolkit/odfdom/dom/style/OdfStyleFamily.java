...
public class OdfStyleFamily implements Comparable<OdfStyleFamily> {
  ...
  public static final OdfStyleFamily Chart =
      new OdfStyleFamily(
          ...
          new OdfStyleProperty[] {
            ...
            StyleChartPropertiesElement.DataLabelSeries,
            ...
            StyleChartPropertiesElement.RegressionForceIntercept,
            StyleChartPropertiesElement.RegressionInterceptValue,
            StyleChartPropertiesElement.RegressionMaxDegree,
            StyleChartPropertiesElement.RegressionMovingType,
            StyleChartPropertiesElement.RegressionName,
            StyleChartPropertiesElement.RegressionPeriod,
            ...
            StyleParagraphPropertiesElement.ContextualSpacing,
  ...
  public static final OdfStyleFamily Ruby =
      new OdfStyleFamily(
          "ruby",
          new OdfStyleProperty[] {
            StyleRubyPropertiesElement.RubyAlign, StyleRubyPropertiesElement.RubyPosition
          });
  ...
  /**
   * page is not a style:family but by adding it here, these properties can be handled in a
   * consistent way
   */
  ...
  /**
   * list is not a style:family but by adding it here, these properties can be handled in a
   * consistent way
   */
