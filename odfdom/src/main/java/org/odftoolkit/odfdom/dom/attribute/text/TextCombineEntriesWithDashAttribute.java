...
public class TextCombineEntriesWithDashAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "combine-entries-with-dash");
   ...
   *
   * @return <code>true</code> if {@odf.attribute text:combine-entries-with-dash} has an element
