...
{        
	...
	{
		TableMultiDeletionSpannedAttribute attr = (TableMultiDeletionSpannedAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.TABLE), "multi-deletion-spanned" ) ;
		if( attr != null ){
			return Integer.valueOf( attr.intValue() );
		}
		return null;
