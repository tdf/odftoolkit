...
{        
	...
	{
		TableMultiDeletionSpannedAttribute attr = (TableMultiDeletionSpannedAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfNamespaceNames.TABLE), "multi-deletion-spanned" ) ;
		if( attr != null ){
			return Integer.valueOf( attr.intValue() );
		}
		return null;
