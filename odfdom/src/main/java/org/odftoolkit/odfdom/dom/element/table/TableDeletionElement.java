...
public class TableDeletionElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "deletion");
   ...
   * TableMultiDeletionSpannedAttribute</code> , See {@odf.attribute table:multi-deletion-spanned}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableMultiDeletionSpannedAttribute
   * </code> , See {@odf.attribute table:multi-deletion-spanned}
   *
  ...
  public void setTableMultiDeletionSpannedAttribute(Integer tableMultiDeletionSpannedValue) {
    TableMultiDeletionSpannedAttribute attr =
        new TableMultiDeletionSpannedAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
    attr.setValue(tableMultiDeletionSpannedValue.toString());
  }
  ...
  public TableCutOffsElement newTableCutOffsElement() {
    TableCutOffsElement tableCutOffs =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TableCutOffsElement.class);
