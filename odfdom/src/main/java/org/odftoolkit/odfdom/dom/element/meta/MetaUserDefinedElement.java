...
public class MetaUserDefinedElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.META, "user-defined");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>MetaNameAttribute</code> , See
   * {@odf.attribute meta:name}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>MetaNameAttribute</code> , See
   * {@odf.attribute meta:name}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>MetaValueTypeAttribute</code> ,
   * See {@odf.attribute meta:value-type}
   *
   * <p>Attribute is mandatory.
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
  ...
  public String getMetaValueTypeAttribute() {
    MetaValueTypeAttribute attr =
        (MetaValueTypeAttribute) getOdfAttribute(OdfDocumentNamespace.META, "value-type");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>MetaValueTypeAttribute</code> , See
   * {@odf.attribute meta:value-type}
   *
