...
public class ConfigConfigItemElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.CONFIG, "config-item");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>ConfigTypeAttribute</code> ,
   * See {@odf.attribute config:type}
   *
   * <p>Attribute is mandatory.
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
  ...
  public String getConfigTypeAttribute() {
    ConfigTypeAttribute attr =
        (ConfigTypeAttribute) getOdfAttribute(OdfDocumentNamespace.CONFIG, "type");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>ConfigTypeAttribute</code> , See
   * {@odf.attribute config:type}
   *
