...
public class TableEmbeddedNumberBehaviorAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "embedded-number-behavior");
   ...
   *
   * @return <code>true</code> if {@odf.attribute table:embedded-number-behavior} has an element
