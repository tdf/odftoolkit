...
public class TextObjectIndexElement extends OdfStylableElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "object-index");
  ...
  public TextObjectIndexSourceElement newTextObjectIndexSourceElement() {
    TextObjectIndexSourceElement textObjectIndexSource =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TextObjectIndexSourceElement.class);
