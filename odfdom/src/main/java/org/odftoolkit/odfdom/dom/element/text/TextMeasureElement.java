...
public class TextMeasureElement extends OdfElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextKindAttribute</code> , See
   * {@odf.attribute text:kind}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextKindAttribute</code> , See
   * {@odf.attribute text:kind}
   *
