...
/** DOM implementation of OpenDocument element {@odf.element style:header-first}. */
public class StyleHeaderFirstElement extends OdfElement {

  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.STYLE, "header-first");

  /**
   * Create the instance of <code>StyleHeaderFirstElement</code>
   *
   * @param ownerDoc The type is <code>OdfFileDom</code>
   */
  public StyleHeaderFirstElement(OdfFileDom ownerDoc) {
   ...
   *
   * @return return <code>OdfName</code> the name of element {@odf.element style:header-first}.
   */
