...
public class AnimAnimateMotionElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.ANIM, "animateMotion");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>SvgOriginAttribute</code> , See
   * {@odf.attribute svg:origin}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getSvgOriginAttribute() {
    SvgOriginAttribute attr =
        (SvgOriginAttribute) getOdfAttribute(OdfDocumentNamespace.SVG, "origin");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>SvgOriginAttribute</code> , See
   * {@odf.attribute svg:origin}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>SvgPathAttribute</code> , See
   * {@odf.attribute svg:path}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>SvgPathAttribute</code> , See
   * {@odf.attribute svg:path}
   *
