...
{        
	...
	{
		SvgPathAttribute attr = (SvgPathAttribute) getOdfAttribute( OdfName.newName( OdfNamespace.newNamespace(OdfNamespaceNames.SVG), "path" ) );
		if( attr != null ){
	...
	{
		SvgOriginAttribute attr = (SvgOriginAttribute) getOdfAttribute( OdfName.newName( OdfNamespace.newNamespace(OdfNamespaceNames.SVG), "origin" ) );
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
