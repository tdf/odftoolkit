...
{        
	...
	{
		SvgPathAttribute attr = (SvgPathAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.SVG), "path" ) ;
		if( attr != null ){
	...
	{
		SvgOriginAttribute attr = (SvgOriginAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.SVG), "origin" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
