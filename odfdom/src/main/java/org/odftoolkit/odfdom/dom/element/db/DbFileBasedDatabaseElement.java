...
public class DbFileBasedDatabaseElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "file-based-database");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DbExtensionAttribute</code> ,
   * See {@odf.attribute db:extension}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getDbExtensionAttribute() {
    DbExtensionAttribute attr =
        (DbExtensionAttribute) getOdfAttribute(OdfDocumentNamespace.DB, "extension");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbExtensionAttribute</code> , See
   * {@odf.attribute db:extension}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DbMediaTypeAttribute</code> ,
   * See {@odf.attribute db:media-type}
   *
  ...
  public String getDbMediaTypeAttribute() {
    DbMediaTypeAttribute attr =
        (DbMediaTypeAttribute) getOdfAttribute(OdfDocumentNamespace.DB, "media-type");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbMediaTypeAttribute</code> , See
   * {@odf.attribute db:media-type}
   *
