...
public class OfficeBodyElement extends OdfElement {
  ...
  public OfficeChartElement newOfficeChartElement() {
    OfficeChartElement officeChart =
        ((OdfFileDom) this.ownerDocument).newOdfElement(OfficeChartElement.class);
  ...
  public OfficeDatabaseElement newOfficeDatabaseElement() {
    OfficeDatabaseElement officeDatabase =
        ((OdfFileDom) this.ownerDocument).newOdfElement(OfficeDatabaseElement.class);
  ...
  public OfficeDrawingElement newOfficeDrawingElement() {
    OfficeDrawingElement officeDrawing =
        ((OdfFileDom) this.ownerDocument).newOdfElement(OfficeDrawingElement.class);
  ...
  public OfficeImageElement newOfficeImageElement() {
    OfficeImageElement officeImage =
        ((OdfFileDom) this.ownerDocument).newOdfElement(OfficeImageElement.class);
  ...
  public OfficePresentationElement newOfficePresentationElement() {
    OfficePresentationElement officePresentation =
        ((OdfFileDom) this.ownerDocument).newOdfElement(OfficePresentationElement.class);
  ...
  public OfficeSpreadsheetElement newOfficeSpreadsheetElement() {
    OfficeSpreadsheetElement officeSpreadsheet =
        ((OdfFileDom) this.ownerDocument).newOdfElement(OfficeSpreadsheetElement.class);
  ...
  public OfficeTextElement newOfficeTextElement() {
    OfficeTextElement officeText =
        ((OdfFileDom) this.ownerDocument).newOdfElement(OfficeTextElement.class);
