...
{        
	...
	{
		DrawEngineAttribute attr = (DrawEngineAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.DRAW), "engine" ) ;
		if( attr != null ){
	...
	{
		DrawDataAttribute attr = (DrawDataAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.DRAW), "data" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
