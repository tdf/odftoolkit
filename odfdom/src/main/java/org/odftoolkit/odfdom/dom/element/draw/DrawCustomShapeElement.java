...
public class DrawCustomShapeElement extends DrawShapeElementBase {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DRAW, "custom-shape");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DrawDataAttribute</code> , See
   * {@odf.attribute draw:data}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DrawDataAttribute</code> , See
   * {@odf.attribute draw:data}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DrawEngineAttribute</code> ,
   * See {@odf.attribute draw:engine}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getDrawEngineAttribute() {
    DrawEngineAttribute attr =
        (DrawEngineAttribute) getOdfAttribute(OdfDocumentNamespace.DRAW, "engine");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DrawEngineAttribute</code> , See
   * {@odf.attribute draw:engine}
   *
  ...
  public DrawEnhancedGeometryElement newDrawEnhancedGeometryElement() {
    DrawEnhancedGeometryElement drawEnhancedGeometry =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DrawEnhancedGeometryElement.class);
