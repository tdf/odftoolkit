...
{        
	...
	{
		DrawEngineAttribute attr = (DrawEngineAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfNamespaceNames.DRAW), "engine" ) ;
		if( attr != null ){
	...
	{
		DrawDataAttribute attr = (DrawDataAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfNamespaceNames.DRAW), "data" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
