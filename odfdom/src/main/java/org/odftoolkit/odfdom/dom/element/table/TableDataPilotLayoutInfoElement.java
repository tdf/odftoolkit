...
public class TableDataPilotLayoutInfoElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "data-pilot-layout-info");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TableAddEmptyLinesAttribute
   * </code> , See {@odf.attribute table:add-empty-lines}
   *
  ...
  public Boolean getTableAddEmptyLinesAttribute() {
    TableAddEmptyLinesAttribute attr =
        (TableAddEmptyLinesAttribute)
            getOdfAttribute(OdfDocumentNamespace.TABLE, "add-empty-lines");
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableAddEmptyLinesAttribute</code> ,
   * See {@odf.attribute table:add-empty-lines}
   *
  ...
  public void setTableAddEmptyLinesAttribute(Boolean tableAddEmptyLinesValue) {
    TableAddEmptyLinesAttribute attr =
        new TableAddEmptyLinesAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
    attr.setBooleanValue(tableAddEmptyLinesValue);
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>TableLayoutModeAttribute</code>
   * , See {@odf.attribute table:layout-mode}
   *
   * <p>Attribute is mandatory.
   *
  ...
  public String getTableLayoutModeAttribute() {
    TableLayoutModeAttribute attr =
        (TableLayoutModeAttribute) getOdfAttribute(OdfDocumentNamespace.TABLE, "layout-mode");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableLayoutModeAttribute</code> , See
   * {@odf.attribute table:layout-mode}
   *
