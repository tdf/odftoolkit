...
public class TableUseBandingColumnsStylesAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "use-banding-columns-styles");
   ...
   *
   * @return <code>true</code> if {@odf.attribute table:use-banding-columns-styles} has an element
