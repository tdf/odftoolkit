...
public class DbTableTypeFilterElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "table-type-filter");
  ...
  public DbTableTypeElement newDbTableTypeElement() {
    DbTableTypeElement dbTableType =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbTableTypeElement.class);
