...
public class NumberCalendarAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.NUMBER, "calendar");
   ...
   *
   * @return <code>true</code> if {@odf.attribute number:calendar} has an element parent otherwise
