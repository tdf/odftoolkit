...
public class PresentationStartWithNavigatorAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.PRESENTATION, "start-with-navigator");
   ...
   *
   * @return <code>true</code> if {@odf.attribute presentation:start-with-navigator} has an element
