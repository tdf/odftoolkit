...
public class DbApplicationConnectionSettingsElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "application-connection-settings");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>DbAppendTableAliasNameAttribute
   * </code> , See {@odf.attribute db:append-table-alias-name}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbAppendTableAliasNameAttribute</code>
   * , See {@odf.attribute db:append-table-alias-name}
   *
  ...
  public void setDbAppendTableAliasNameAttribute(Boolean dbAppendTableAliasNameValue) {
    DbAppendTableAliasNameAttribute attr =
        new DbAppendTableAliasNameAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
    attr.setValue(dbAppendTableAliasNameValue.toString());
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>
   * DbBooleanComparisonModeAttribute</code> , See {@odf.attribute db:boolean-comparison-mode}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getDbBooleanComparisonModeAttribute() {
    DbBooleanComparisonModeAttribute attr =
        (DbBooleanComparisonModeAttribute)
            getOdfAttribute(OdfDocumentNamespace.DB, "boolean-comparison-mode");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbBooleanComparisonModeAttribute</code>
   * , See {@odf.attribute db:boolean-comparison-mode}
   *
  ...
  public void setDbBooleanComparisonModeAttribute(String dbBooleanComparisonModeValue) {
    DbBooleanComparisonModeAttribute attr =
        new DbBooleanComparisonModeAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
    attr.setValue(dbBooleanComparisonModeValue);
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>DbEnableSql92CheckAttribute
   * </code> , See {@odf.attribute db:enable-sql92-check}
   *
   * @return - the <code>Boolean</code> , the value or <code>null</code>, if the attribute is not
   *     set and no default value defined.
   */
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbEnableSql92CheckAttribute</code> ,
   * See {@odf.attribute db:enable-sql92-check}
   *
  ...
  public void setDbEnableSql92CheckAttribute(Boolean dbEnableSql92CheckValue) {
    DbEnableSql92CheckAttribute attr =
        new DbEnableSql92CheckAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
    attr.setValue(dbEnableSql92CheckValue.toString());
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>
   * DbIgnoreDriverPrivilegesAttribute</code> , See {@odf.attribute db:ignore-driver-privileges}
   *
   * @return - the <code>Boolean</code> , the value or <code>null</code>, if the attribute is not
   *     set and no default value defined.
   */
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbIgnoreDriverPrivilegesAttribute
   * </code> , See {@odf.attribute db:ignore-driver-privileges}
   *
  ...
  public void setDbIgnoreDriverPrivilegesAttribute(Boolean dbIgnoreDriverPrivilegesValue) {
    DbIgnoreDriverPrivilegesAttribute attr =
        new DbIgnoreDriverPrivilegesAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
    attr.setValue(dbIgnoreDriverPrivilegesValue.toString());
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>
   * DbIsTableNameLengthLimitedAttribute</code> , See {@odf.attribute
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbIsTableNameLengthLimitedAttribute
   * </code> , See {@odf.attribute db:is-table-name-length-limited}
   *
  ...
  public void setDbIsTableNameLengthLimitedAttribute(Boolean dbIsTableNameLengthLimitedValue) {
    DbIsTableNameLengthLimitedAttribute attr =
        new DbIsTableNameLengthLimitedAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
    attr.setValue(dbIsTableNameLengthLimitedValue.toString());
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>DbMaxRowCountAttribute</code> ,
   * See {@odf.attribute db:max-row-count}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbMaxRowCountAttribute</code> , See
   * {@odf.attribute db:max-row-count}
   *
  ...
  public void setDbMaxRowCountAttribute(Integer dbMaxRowCountValue) {
    ...
    setOdfAttribute(attr);
    attr.setValue(dbMaxRowCountValue.toString());
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>
   * DbSuppressVersionColumnsAttribute</code> , See {@odf.attribute db:suppress-version-columns}
   *
   * @return - the <code>Boolean</code> , the value or <code>null</code>, if the attribute is not
   *     set and no default value defined.
   */
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbSuppressVersionColumnsAttribute
   * </code> , See {@odf.attribute db:suppress-version-columns}
   *
  ...
  public void setDbSuppressVersionColumnsAttribute(Boolean dbSuppressVersionColumnsValue) {
    DbSuppressVersionColumnsAttribute attr =
        new DbSuppressVersionColumnsAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
    attr.setValue(dbSuppressVersionColumnsValue.toString());
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>DbUseCatalogAttribute</code> ,
   * See {@odf.attribute db:use-catalog}
   *
   * @return - the <code>Boolean</code> , the value or <code>null</code>, if the attribute is not
   *     set and no default value defined.
   */
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbUseCatalogAttribute</code> , See
   * {@odf.attribute db:use-catalog}
   *
  ...
  public void setDbUseCatalogAttribute(Boolean dbUseCatalogValue) {
    ...
    setOdfAttribute(attr);
    attr.setValue(dbUseCatalogValue.toString());
  }
  ...
  public DbDataSourceSettingsElement newDbDataSourceSettingsElement() {
    DbDataSourceSettingsElement dbDataSourceSettings =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbDataSourceSettingsElement.class);
  ...
  public DbTableFilterElement newDbTableFilterElement() {
    DbTableFilterElement dbTableFilter =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbTableFilterElement.class);
  ...
  public DbTableTypeFilterElement newDbTableTypeFilterElement() {
    DbTableTypeFilterElement dbTableTypeFilter =
        ((OdfFileDom) this.ownerDocument).newOdfElement(DbTableTypeFilterElement.class);
