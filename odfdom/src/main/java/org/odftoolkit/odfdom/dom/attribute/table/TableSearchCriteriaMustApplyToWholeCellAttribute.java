...
public class TableSearchCriteriaMustApplyToWholeCellAttribute extends OdfAttribute {
   ...
   *
   * @return <code>true</code> if {@odf.attribute table:search-criteria-must-apply-to-whole-cell}
   *     has an element parent otherwise return <code>false</code> as undefined.
   */
  @Override
