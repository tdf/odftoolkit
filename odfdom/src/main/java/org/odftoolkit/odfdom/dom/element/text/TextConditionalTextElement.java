...
public class TextConditionalTextElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "conditional-text");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextCurrentValueAttribute
   * </code> , See {@odf.attribute text:current-value}
   *
   * @return - the <code>Boolean</code> , the value or <code>null</code>, if the attribute is not
   *     set and no default value defined.
   */
  public Boolean getTextCurrentValueAttribute() {
    TextCurrentValueAttribute attr =
        (TextCurrentValueAttribute) getOdfAttribute(OdfDocumentNamespace.TEXT, "current-value");
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextCurrentValueAttribute</code> , See
   * {@odf.attribute text:current-value}
   *
  ...
  public void setTextCurrentValueAttribute(Boolean textCurrentValueValue) {
    ...
    setOdfAttribute(attr);
    attr.setValue(textCurrentValueValue.toString());
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>TextStringValueIfFalseAttribute
   * </code> , See {@odf.attribute text:string-value-if-false}
   *
   * <p>Attribute is mandatory.
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
  ...
  public String getTextStringValueIfFalseAttribute() {
    TextStringValueIfFalseAttribute attr =
        (TextStringValueIfFalseAttribute)
            getOdfAttribute(OdfDocumentNamespace.TEXT, "string-value-if-false");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextStringValueIfFalseAttribute</code>
   * , See {@odf.attribute text:string-value-if-false}
   *
  ...
  public void setTextStringValueIfFalseAttribute(String textStringValueIfFalseValue) {
    TextStringValueIfFalseAttribute attr =
        new TextStringValueIfFalseAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
    attr.setValue(textStringValueIfFalseValue);
  }

  /**
   * Receives the value of the ODFDOM attribute representation <code>TextStringValueIfTrueAttribute
   * </code> , See {@odf.attribute text:string-value-if-true}
   *
   * <p>Attribute is mandatory.
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
  ...
  public String getTextStringValueIfTrueAttribute() {
    TextStringValueIfTrueAttribute attr =
        (TextStringValueIfTrueAttribute)
            getOdfAttribute(OdfDocumentNamespace.TEXT, "string-value-if-true");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextStringValueIfTrueAttribute</code> ,
   * See {@odf.attribute text:string-value-if-true}
   *
  ...
  public void setTextStringValueIfTrueAttribute(String textStringValueIfTrueValue) {
    TextStringValueIfTrueAttribute attr =
        new TextStringValueIfTrueAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
