...
public class TableProtectionKeyDigestAlgorithmAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "protection-key-digest-algorithm");
   ...
   *
   * @return <code>true</code> if {@odf.attribute table:protection-key-digest-algorithm} has an
