...
public class TableErrorMacroElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "error-macro");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TableExecuteAttribute</code> ,
   * See {@odf.attribute table:execute}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TableExecuteAttribute</code> , See
   * {@odf.attribute table:execute}
   *
  ...
  public void setTableExecuteAttribute(Boolean tableExecuteValue) {
    ...
    attr.setBooleanValue(tableExecuteValue);
  }
