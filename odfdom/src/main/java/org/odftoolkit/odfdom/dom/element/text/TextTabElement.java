...
public class TextTabElement extends OdfElement {
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextTabRefAttribute</code> ,
   * See {@odf.attribute text:tab-ref}
   *
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextTabRefAttribute</code> , See
   * {@odf.attribute text:tab-ref}
   *
  ...
  public void setTextTabRefAttribute(Integer textTabRefValue) {
    ...
    attr.setValue(textTabRefValue.toString());
  }
