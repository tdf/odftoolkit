...
public class DbAutoIncrementElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "auto-increment");
   ...
   * DbAdditionalColumnStatementAttribute</code> , See {@odf.attribute
  ...
  public String getDbAdditionalColumnStatementAttribute() {
    DbAdditionalColumnStatementAttribute attr =
        (DbAdditionalColumnStatementAttribute)
            getOdfAttribute(OdfDocumentNamespace.DB, "additional-column-statement");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbAdditionalColumnStatementAttribute
   * </code> , See {@odf.attribute db:additional-column-statement}
   *
  ...
  public void setDbAdditionalColumnStatementAttribute(String dbAdditionalColumnStatementValue) {
    DbAdditionalColumnStatementAttribute attr =
        new DbAdditionalColumnStatementAttribute((OdfFileDom) this.ownerDocument);
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>
   * DbRowRetrievingStatementAttribute</code> , See {@odf.attribute db:row-retrieving-statement}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getDbRowRetrievingStatementAttribute() {
    DbRowRetrievingStatementAttribute attr =
        (DbRowRetrievingStatementAttribute)
            getOdfAttribute(OdfDocumentNamespace.DB, "row-retrieving-statement");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>DbRowRetrievingStatementAttribute
   * </code> , See {@odf.attribute db:row-retrieving-statement}
   *
  ...
  public void setDbRowRetrievingStatementAttribute(String dbRowRetrievingStatementValue) {
    DbRowRetrievingStatementAttribute attr =
        new DbRowRetrievingStatementAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
