...
public class TableNumberMatrixColumnsSpannedAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.TABLE, "number-matrix-columns-spanned");
   ...
   *
   * @return <code>true</code> if {@odf.attribute table:number-matrix-columns-spanned} has an
