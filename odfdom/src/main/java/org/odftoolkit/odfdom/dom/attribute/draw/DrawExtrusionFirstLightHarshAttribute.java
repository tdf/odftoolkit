...
public class DrawExtrusionFirstLightHarshAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.DRAW, "extrusion-first-light-harsh");
   ...
   *
   * @return <code>true</code> if {@odf.attribute draw:extrusion-first-light-harsh} has an element
