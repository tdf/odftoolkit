...
{        
	...
	{
		DrawHandleMirrorVerticalAttribute attr = (DrawHandleMirrorVerticalAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.DRAW), "handle-mirror-vertical" ) ;
		if( attr != null ){
	...
	{
		DrawHandleMirrorHorizontalAttribute attr = (DrawHandleMirrorHorizontalAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.DRAW), "handle-mirror-horizontal" ) ;
		if( attr != null ){
			return Boolean.valueOf( attr.booleanValue() );
		}
	...
	{
		DrawHandleSwitchedAttribute attr = (DrawHandleSwitchedAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.DRAW), "handle-switched" ) ;
		if( attr != null ){
			return Boolean.valueOf( attr.booleanValue() );
		}
	...
	{
		DrawHandlePositionAttribute attr = (DrawHandlePositionAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.DRAW), "handle-position" ) ;
		if( attr != null ){
	...
	{
		DrawHandleRangeXMinimumAttribute attr = (DrawHandleRangeXMinimumAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.DRAW), "handle-range-x-minimum" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		DrawHandleRangeXMaximumAttribute attr = (DrawHandleRangeXMaximumAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.DRAW), "handle-range-x-maximum" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		DrawHandleRangeYMinimumAttribute attr = (DrawHandleRangeYMinimumAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.DRAW), "handle-range-y-minimum" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		DrawHandleRangeYMaximumAttribute attr = (DrawHandleRangeYMaximumAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.DRAW), "handle-range-y-maximum" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		DrawHandlePolarAttribute attr = (DrawHandlePolarAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.DRAW), "handle-polar" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		DrawHandleRadiusRangeMinimumAttribute attr = (DrawHandleRadiusRangeMinimumAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.DRAW), "handle-radius-range-minimum" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		DrawHandleRadiusRangeMaximumAttribute attr = (DrawHandleRadiusRangeMaximumAttribute) getOdfAttribute( OdfNamespace.newNamespace(OdfDocumentNamespace.DRAW), "handle-radius-range-maximum" ) ;
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
