...
public class TextListLevelStyleBulletElement extends TextListLevelStyleElementBase {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "list-level-style-bullet");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextBulletCharAttribute</code>
   * , See {@odf.attribute text:bullet-char}
   *
  ...
  public String getTextBulletCharAttribute() {
    TextBulletCharAttribute attr =
        (TextBulletCharAttribute) getOdfAttribute(OdfDocumentNamespace.TEXT, "bullet-char");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextBulletCharAttribute</code> , See
   * {@odf.attribute text:bullet-char}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextBulletRelativeSizeAttribute
   * </code> , See {@odf.attribute text:bullet-relative-size}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTextBulletRelativeSizeAttribute() {
    TextBulletRelativeSizeAttribute attr =
        (TextBulletRelativeSizeAttribute)
            getOdfAttribute(OdfDocumentNamespace.TEXT, "bullet-relative-size");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextBulletRelativeSizeAttribute</code>
   * , See {@odf.attribute text:bullet-relative-size}
   *
  ...
  public void setTextBulletRelativeSizeAttribute(String textBulletRelativeSizeValue) {
    TextBulletRelativeSizeAttribute attr =
        new TextBulletRelativeSizeAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
