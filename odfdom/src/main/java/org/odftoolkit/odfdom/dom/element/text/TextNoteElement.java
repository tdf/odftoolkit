...
public class TextNoteElement extends OdfElement {
  ...
  public TextNoteBodyElement newTextNoteBodyElement() {
    TextNoteBodyElement textNoteBody =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TextNoteBodyElement.class);
  ...
  public TextNoteCitationElement newTextNoteCitationElement() {
    TextNoteCitationElement textNoteCitation =
        ((OdfFileDom) this.ownerDocument).newOdfElement(TextNoteCitationElement.class);
