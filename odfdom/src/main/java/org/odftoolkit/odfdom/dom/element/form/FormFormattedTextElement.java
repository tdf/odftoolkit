...
public class FormFormattedTextElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.FORM, "formatted-text");
  ...
  public void setFormSpinButtonAttribute(Boolean formSpinButtonValue) {
    ...
    setOdfAttribute(attr);
    attr.setValue(formSpinButtonValue.toString());
  }
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>FormValidationAttribute</code>
   * , See {@odf.attribute form:validation}
   *
   * @return - the <code>Boolean</code> , the value or <code>null</code>, if the attribute is not
   *     set and no default value defined.
   */
  public Boolean getFormValidationAttribute() {
    FormValidationAttribute attr =
        (FormValidationAttribute) getOdfAttribute(OdfDocumentNamespace.FORM, "validation");
    if (attr != null && !attr.getValue().isEmpty()) {
      return Boolean.valueOf(attr.getValue());
    }
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>FormValidationAttribute</code> , See
   * {@odf.attribute form:validation}
   *
  ...
  public void setFormValidationAttribute(Boolean formValidationValue) {
    ...
    setOdfAttribute(attr);
    attr.setValue(formValidationValue.toString());
  }
