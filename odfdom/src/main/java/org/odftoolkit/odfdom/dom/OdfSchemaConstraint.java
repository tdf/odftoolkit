...
public enum OdfSchemaConstraint implements ValidationConstraint {
  ...
  public String getLocalizedMessage() {
    ...
    //    PACKAGE_SHALL_BE_ZIP=%s muß eine ZIP Datei sein, wie in [ZIP] definiert. Alle Dateien
    // innerhalbe des ZIPS müssen entwder unkomprimiert (STORED) oder komprimiert sein (DEFLATED)
