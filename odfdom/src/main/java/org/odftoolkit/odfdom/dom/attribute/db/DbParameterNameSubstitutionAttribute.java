...
public class DbParameterNameSubstitutionAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.DB, "parameter-name-substitution");
   ...
   *
   * @return <code>true</code> if {@odf.attribute db:parameter-name-substitution} has an element
