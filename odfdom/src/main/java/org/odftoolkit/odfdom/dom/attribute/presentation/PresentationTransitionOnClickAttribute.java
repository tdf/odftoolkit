...
public class PresentationTransitionOnClickAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfDocumentNamespace.PRESENTATION, "transition-on-click");
   ...
   *
   * @return <code>true</code> if {@odf.attribute presentation:transition-on-click} has an element
