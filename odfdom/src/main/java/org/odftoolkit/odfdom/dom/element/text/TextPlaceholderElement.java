...
public class TextPlaceholderElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfDocumentNamespace.TEXT, "placeholder");
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextDescriptionAttribute</code>
   * , See {@odf.attribute text:description}
   *
   * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set
   *     and no default value defined.
   */
  public String getTextDescriptionAttribute() {
    TextDescriptionAttribute attr =
        (TextDescriptionAttribute) getOdfAttribute(OdfDocumentNamespace.TEXT, "description");
    if (attr != null) {
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextDescriptionAttribute</code> , See
   * {@odf.attribute text:description}
   *
  ...
  /**
   * Receives the value of the ODFDOM attribute representation <code>TextPlaceholderTypeAttribute
   * </code> , See {@odf.attribute text:placeholder-type}
   *
  ...
  public String getTextPlaceholderTypeAttribute() {
    TextPlaceholderTypeAttribute attr =
        (TextPlaceholderTypeAttribute)
            getOdfAttribute(OdfDocumentNamespace.TEXT, "placeholder-type");
    if (attr != null) {
      return String.valueOf(attr.getValue());
    }
    return null;
  ...
  /**
   * Sets the value of ODFDOM attribute representation <code>TextPlaceholderTypeAttribute</code> ,
   * See {@odf.attribute text:placeholder-type}
   *
  ...
  public void setTextPlaceholderTypeAttribute(String textPlaceholderTypeValue) {
    TextPlaceholderTypeAttribute attr =
        new TextPlaceholderTypeAttribute((OdfFileDom) this.ownerDocument);
    setOdfAttribute(attr);
