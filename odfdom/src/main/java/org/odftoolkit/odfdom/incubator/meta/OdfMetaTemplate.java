...
/**
 * <code>OdfMetaTemplate</code> feature specified the URL for the document that was used to create a
 * document.
 */
...
public class OdfMetaTemplate {
   ...
   *
   * @param element an instance of ODF Element <code>MetaTemplateElement</code>
   */
  ...
  /**
   * Return the instance of ODF Element <code>MetaTemplateElement</code> which represents this
   * feature.
   *
