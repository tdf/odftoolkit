...
/**
 * <code>OdfMetaAutoReload</code> feature specifies whether the document is reloaded or replaced by
...
public class OdfMetaAutoReload {
   ...
   *
   * @param element an instance of ODF Element <code>MetaAutoReloadElement</code>
   */
  ...
  /**
   * Return the instance of ODF Element <codeMetaAutoReloadElement</code> which represents this
   * feature.
   *
