...
public class OdfTextSpan extends TextSpanElement {
  ...
  /**
   * Set a span to have the given styleName and add the given content. If the style name is null or
   * the null string, no style is added.
   *
   * @param styleName the style:style-name value
   * @param content the span content
  ...
  /**
   * Set a span to have the given styleName and add the given content. If the style name is null or
   * the null string, no style is added. Embedded \n are converted to <code>&lt;text:line-break&gt;
   * </code> elements, and multiple blanks to <code>&lt;text:s</code>
   *
   * @param styleName the style:style-name value
   * @param content the span content
   * @return the span object
