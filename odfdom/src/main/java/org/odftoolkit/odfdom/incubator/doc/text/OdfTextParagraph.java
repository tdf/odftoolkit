...
public class OdfTextParagraph extends TextPElement {
  ...
  /**
   * Add the given content to the paragraph. If the content is null or the null string, no content
   * is added. Embedded \n are converted to <code>&lt;text:line-break&gt;</code> elements, and
   * multiple blanks to <code>&lt;text:s</code>
   *
   * @param content the paragraph content
   * @return the paragraph object
   */
  ...
  /**
   * Set a paragraph to have the given styleName and add the given content. If the style name is
   * null or the null string, no style is added. If the content is null or the null string, no
   * content is added.
   *
   * @param styleName the style:style-name value
   ...
   * Set a paragraph to have the given styleName and add the given content. If the style name is
   * null or the null string, no style is added. If the content is null or the null string, no
   * content is added. Embedded \n are converted to <code>&lt;text:line-break&gt;</code> elements,
   * and multiple blanks to <code>&lt;text:s</code>
   *
   * @param styleName the style:style-name value
   * @param content the paragraph content
   * @return the paragraph object
   ...
   * Embedded \n are converted to <code>&lt;text:line-break&gt;</code> elements, and multiple blanks
   * to <code>&lt;text:s</code>
   *
   * @param styleName
   * @param content
