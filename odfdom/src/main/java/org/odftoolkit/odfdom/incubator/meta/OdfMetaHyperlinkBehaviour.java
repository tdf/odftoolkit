...
/**
 * <code>OdfMetaHyperlinkBehaviour</code> feature specifies default behavior of hyperlinks in the
 * current document.
 */
...
public class OdfMetaHyperlinkBehaviour {
   ...
   *
   * @param element an instance of ODF Element <code>MetaHyperlinkBehaviourElement</code>.
   */
  ...
  /**
   * Return the instance of ODF Element <code>MetaHyperlinkBehaviourElement</code>. which represents
   * this feature.
   *
   * @return the instance of ODF Element <code>MetaHyperlinkBehaviourElement</code>.
   */
