...
import org.odftoolkit.odfdom.dom.element.number.DataStyleElement.StringToken;
...
public class OdfNumberBooleanStyle extends NumberBooleanStyleElement {
  ...
  /**
   * Creates a new instance of OdfNumberBooleanStyle.
   *
   ...
   */
  public OdfNumberBooleanStyle(OdfFileDom ownerDoc, String format, String styleName) {
    super(ownerDoc);
  ...
  public void setFormat(String format) {
    List<StringToken> tokens = tokenize(format, DataStyleElement.NumberFormatType.vv);
