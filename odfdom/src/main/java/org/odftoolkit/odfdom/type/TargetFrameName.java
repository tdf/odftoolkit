...
public enum TargetFrameName implements OdfDataType {
   ...
   *
   * @param aEnum the constant of TargetFrameName
   ...
   *
   * @param stringValue the name of OdfTargetFrameNameType
   ...
   * @return true if the value of argument is valid for {@odf.datatype targetFrameName} data type
   *     false otherwise
   */
