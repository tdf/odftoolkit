...
public class ScriptCode implements OdfDataType {
   ...
   *
   * @param scriptCode The String to be parsed into ScriptCode
   ...
   *
   * @return return a string representation of the value of this ScriptCode object
   */
  @Override
   ...
   * @return true if the value of argument is valid for {@odf.datatype scriptCode} data type false
   *     otherwise
   */
