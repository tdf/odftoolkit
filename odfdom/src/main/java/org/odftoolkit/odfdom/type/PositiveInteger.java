...
public class PositiveInteger implements OdfDataType {
   ...
   *
   * @param n the value of the PositiveInteger
   ...
   *
   * @return return a string representation of the value of this PositiveInteger object
   */
  @Override
  ...
  /**
   * check if the specified Integer instance is a valid {@odf.datatype positiveInteger} data type
   *
   * @param integerValue the value to be tested
   * @return true if the value of argument is valid for {@odf.datatype positiveInteger} data type
   *     false otherwise
   */
