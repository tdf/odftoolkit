...
public class ClipShape implements OdfDataType {
  ...
  private static final Pattern clipShapePattern =
      Pattern.compile(
   ...
   *
   * @param clipShape The String to be parsed into ClipShape
  ...
  public ClipShape(String clipShape) throws IllegalArgumentException {
    if (!isValid(clipShape)) {
      throw new IllegalArgumentException("parameter is invalid for datatype ClipShape");
    }
   ...
   *
   * @return return a string representation of the value of this ClipShape object
   */
  @Override
   ...
   * @return true if the value of argument is valid for {@odf.datatype clipShape} data type false
   *     otherwise
   */
