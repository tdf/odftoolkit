...
public class Vector3D implements OdfDataType {
  ...
  private static final Pattern vector3DPattern =
      Pattern.compile(
   ...
   *
   * @param vector3D The String to be parsed into Vector3D
   */
   ...
   *
   * @return return a string representation of the value of this Vector3D object
   */
  @Override
   ...
   * @return true if the value of argument is valid for {@odf.datatype vector3D} data type false
   *     otherwise
   */
