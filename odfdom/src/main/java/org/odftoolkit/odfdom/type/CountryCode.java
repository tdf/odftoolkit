...
public class CountryCode implements OdfDataType {
   ...
   *
   * @param countryCode The String to be parsed into CountryCode
   ...
   *
   * @return return a string representation of the value of this CountryCode object
   */
  @Override
   ...
   * @return true if the value of argument is valid for {@odf.datatype countryCode} data type false
   *     otherwise
   */
