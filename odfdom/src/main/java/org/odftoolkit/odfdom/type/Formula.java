...
public class Formula implements OdfDataType {
   ...
   *
   * @return return a string representation of the value of this Formula object
   */
  @Override
   ...
   * @return true if the value of argument is valid for {@odf.datatype formula} data type false
   *     otherwise
   */
