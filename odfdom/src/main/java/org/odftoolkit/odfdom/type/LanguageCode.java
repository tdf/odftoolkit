...
public class LanguageCode implements OdfDataType {
   ...
   *
   * @return return a string representation of the value of this LanguageCode object
   */
  @Override
   ...
   * @return true if the value of argument is valid for {@odf.datatype languageCode} data type false
   *     otherwise
   */
