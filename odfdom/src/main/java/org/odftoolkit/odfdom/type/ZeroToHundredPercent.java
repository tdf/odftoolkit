...
public class ZeroToHundredPercent implements OdfDataType {
   ...
   *
   * @return return a string representation of the value of this ZeroToHundredPercent object
   */
  @Override
  ...
  /**
   * check if the specified Double instance is a valid {@odf.datatype zeroToHundredPercent} data
   * type
   *
   * @param doubleValue the value to be tested
   * @return true if the value of argument is valid for {@odf.datatype zeroToHundredPercent} data
  ...
  /**
   * check if the specified String instance is a valid {@odf.datatype zeroToHundredPercent} data
   * type
   *
