...
public class TextEncoding implements OdfDataType {
   ...
   *
   * @param textEncoding The String to be parsed into TextEncoding
   ...
   *
   * @return return a string representation of the value of this TextEncoding object
   */
  @Override
   ...
   * @return true if the value of argument is valid for {@odf.datatype textEncoding} data type false
   *     otherwise
   */
