...
public class Percent implements OdfFieldDataType, OdfDataType {
   ...
   *
   * @param n the value of the Percent
   ...
   *
   * @return return a string representation of the value of this Percent object
   */
  @Override
   ...
   * @return true if the value of argument is valid for {@odf.datatype percent} data type false
   *     otherwise
   */
