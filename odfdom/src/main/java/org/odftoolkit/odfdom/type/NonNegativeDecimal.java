...
public class NonNegativeDecimal implements OdfDataType {
   ...
   *
   * @param n the value of the NonNegativeDecimal
   * @throws IllegalArgumentException if the given argument is not a valid NonNegativeDecimal
   */
  public NonNegativeDecimal(double n) throws IllegalArgumentException {
    if (n < 0)
      throw new IllegalArgumentException("parameter is invalid for datatype NonNegativeDecimal");
    mN = n;
  }
   ...
   *
   * @return return a string representation of the value of this NonNegativeDecimal object
   */
  @Override
  ...
  /**
   * check if the specified Double instance is a valid {@odf.datatype nonNegativeDecimal} data type
   *
   * @param doubleValue the value to be tested
   * @return true if the value of argument is valid for {@odf.datatype nonNegativeDecimal} data type
   *     false otherwise
   */
