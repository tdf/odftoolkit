...
public class PositiveLength extends Length {
  private static final Pattern positiveLengthPattern =
      Pattern.compile(
   ...
   *
   * @param length The String to be parsed into PositiveLength
  ...
  /**
   * check if the specified String instance is a valid {@odf.datatype positiveLength} data type
   *
   * @param stringValue the value to be tested
   * @return true if the value of argument is valid for {@odf.datatype positiveLength} data type
   *     false otherwise
   */
