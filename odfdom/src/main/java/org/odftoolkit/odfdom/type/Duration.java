...
public class Duration implements OdfFieldDataType, OdfDataType {
   ...
   *
   * @return return a string representation of the value of this DurationType object
   */
  @Override
   ...
   * @return true if the value of argument is valid for {@odf.datatype duration} data type false
   *     otherwise
   */
