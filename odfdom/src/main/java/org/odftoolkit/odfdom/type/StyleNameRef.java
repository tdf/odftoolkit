...
public class StyleNameRef implements OdfDataType {
   ...
   *
   * @return return a string representation of the value of this StyleNameRef object
   */
  @Override
   ...
   * @return true if the value of argument is valid for {@odf.datatype styleNameRef} data type false
   *     otherwise
   */
