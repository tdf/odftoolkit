...
public class SignedZeroToHundredPercent implements OdfDataType {
  private double mN;
  private static final Pattern signedZeroToHundredPercentPattern =
      Pattern.compile("^-?([0-9]?[0-9](\\.[0-9]*)?|100(\\.0*)?|\\.[0-9]+)%$");

  /**
   * Allocates a SignedZeroToHundredPercent object representing the n argument
   *
   * @param n the value of the SignedZeroToHundredPercent
  ...
  public SignedZeroToHundredPercent(double n) throws IllegalArgumentException {
    if (n > 1 || n < -1)
      throw new IllegalArgumentException(
          "parameter is invalid for datatype SignedZeroToHundredPercent");
    mN = n;
  }
   ...
   *
   * @return return a string representation of the value of this SignedZeroToHundredPercent object
   */
  @Override
  ...
  public static SignedZeroToHundredPercent valueOf(String stringValue)
    ...
    if (n != -1) {
      return new SignedZeroToHundredPercent(
  ...
  /**
   * check if the specified Double instance is a valid {@odf.datatype signedZeroToHundredPercent}
   * data type
   *
   * @param doubleValue the value to be tested
   * @return true if the value of argument is valid for {@odf.datatype signedZeroToHundredPercent}
  ...
  /**
   * check if the specified String instance is a valid {@odf.datatype 'signedZeroToHundredPercent'}
   * data type
   *
  ...
  public static boolean isValid(String stringValue) {
    if ((stringValue == null)
        || (!signedZeroToHundredPercentPattern.matcher(stringValue).matches())) {
      return false;
    } else {
      return true;
    }
