...
//		MILES(1609344.0, "mi");
     ...
     * @throws NumberFormatException if the given argument is not a valid Length (an Integer only will be presumed to be 'pt')
     */
    public Length(String length) throws NumberFormatException {
        if (!isValid(length)) {
            try {
                ...
                throw new NumberFormatException("parameter '" + length + "' is invalid for datatype Length");
            }
        }
     ...
     * @return Returns a <code>Unit</code> object representing the specified
     * Length unit.
     */
     ...
     * @return Returns a <code>int</code> value representing the specified
     * Length value.
     */
     ...
     * @return Returns a <code>long</code> value representing the specified
     * Length value.
     */
     ...
     * @return Returns a <code>double</code> value representing the specified
     * Length value.
     */
