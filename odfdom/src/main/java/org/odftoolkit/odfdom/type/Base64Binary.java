...
public class Base64Binary implements OdfDataType {
   ...
   *
   * @param bytes the value to be represented by the Base64Binary Object
   ...
   *
   * @return return a string representation of the value of this Base64Binary object
   */
  @Override
   ...
   * @return true if the value of argument is valid for {@odf.datatype base64Binary} data type false
   *     otherwise
   */
