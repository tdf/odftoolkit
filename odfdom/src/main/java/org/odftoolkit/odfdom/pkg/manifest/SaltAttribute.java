...
public class SaltAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName("urn:oasis:names:tc:opendocument:xmlns:manifest:1.0", "manifest:salt");
   ...
   *
   * @return <code>true</code> if {@odf.attribute manifest:salt} has an element parent otherwise
