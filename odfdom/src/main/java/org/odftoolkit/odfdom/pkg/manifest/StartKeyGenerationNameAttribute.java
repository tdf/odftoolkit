...
public class StartKeyGenerationNameAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(OdfPackageNamespace.MANIFEST, "start-key-generation-name");
   ...
   *
   * @return <code>true</code> if {@odf.attribute manifest:start-key-generation-name} has an element
