...
public class ChecksumAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName("urn:oasis:names:tc:opendocument:xmlns:manifest:1.0", "manifest:checksum");
   ...
   *
   * @return <code>true</code> if {@odf.attribute manifest:checksum} has an element parent otherwise
