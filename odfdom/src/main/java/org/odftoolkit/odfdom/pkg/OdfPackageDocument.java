...
public class OdfPackageDocument implements Closeable {
  ...
  /**
   * The mediatype of the ODF package document. Note: Not necessarily an ODF XML mediatype as
  ...
  /**
   * Close the OdfPackageDocument, its OdfPackage and release all temporary created data. Acter
