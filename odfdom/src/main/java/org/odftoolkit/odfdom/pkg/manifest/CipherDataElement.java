...
public class CipherDataElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfPackageNamespace.MANIFEST, "CipherData");
   ...
   */
  public CipherDataElement(OdfFileDom ownerDoc) {
  ...
  public CipherValueElement newCipherValueElement() {
    CipherValueElement cipherValue =
        ((OdfFileDom) this.ownerDocument).newOdfElement(CipherValueElement.class);
    this.appendChild(cipherValue);
    return cipherValue;
  }
}
