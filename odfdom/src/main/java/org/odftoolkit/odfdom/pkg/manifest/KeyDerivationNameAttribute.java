...
public class KeyDerivationNameAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName(
          "urn:oasis:names:tc:opendocument:xmlns:manifest:1.0", "manifest:key-derivation-name");
   ...
   *
   * @return <code>true</code> if {@odf.attribute manifest:key-derivation-name} has an element
