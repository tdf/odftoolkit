...
public abstract class OdfElement extends ElementNSImpl {
   ...
   * @return the first sibbling of the given reference node that is a clazz or null if none is
   *     found.
   */
  @SuppressWarnings("unchecked")
   ...
   * @return the first previous sibbling of the given reference node that is a clazz or null if none
   *     is found.
   */
  @SuppressWarnings("unchecked")
