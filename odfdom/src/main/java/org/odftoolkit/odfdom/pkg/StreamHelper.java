...
/**
 * This class reads from an InputStream and writes to an OutputStream. No streams will be closed -
 * calling classes must do this.
 */
class StreamHelper {
  ...
  /**
   * Read from the input stream and write to the output. This method does not close any stream;
   * calling methods must take care of that.
   *
  ...
  /**
   * Read from the input stream and write to the output. This method can only be called once. A
   * second call will result in an IOException. This method does not close any stream; calling
   * methods must take care of that.
   *
   * @throws IOException when io error happens
   */
