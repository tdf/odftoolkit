 ...
 * constructors of org.odftoolkit.odfdom.pkg.OdfNamespace.
 */
public interface NamespaceName {

  /**
   * @return the prefix currently related to XML Namespace. Note: Even in a single XML file, a user
   *     might assign different prefixes to a XML Namespace, different NamespaceNames might exist.
   */
