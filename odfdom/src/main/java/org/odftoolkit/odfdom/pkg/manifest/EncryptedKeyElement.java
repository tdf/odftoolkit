...
public class EncryptedKeyElement extends OdfElement {
  ...
  public static final OdfName ELEMENT_NAME =
      OdfName.newName(OdfPackageNamespace.MANIFEST, "encrypted-key");
  ...
  public CipherDataElement newCipherDataElement() {
    CipherDataElement cipherData =
        ((OdfFileDom) this.ownerDocument).newOdfElement(CipherDataElement.class);
   ...
   *
   * @param pGPAlgorithmValue the <code>String</code> value of <code>PGPAlgorithmAttribute</code>,
   *     see {@odf.attribute manifest:PGPAlgorithm} at specification
  ...
  public EncryptionMethodElement newEncryptionMethodElement(String pGPAlgorithmValue) {
    EncryptionMethodElement encryptionMethod =
        ((OdfFileDom) this.ownerDocument).newOdfElement(EncryptionMethodElement.class);
