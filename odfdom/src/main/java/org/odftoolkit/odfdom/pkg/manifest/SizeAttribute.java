...
public class SizeAttribute extends OdfAttribute {
  ...
  public static final OdfName ATTRIBUTE_NAME =
      OdfName.newName("urn:oasis:names:tc:opendocument:xmlns:manifest:1.0", "manifest:size");
   ...
   *
   * @return <code>true</code> if {@odf.attribute manifest:size} has an element parent otherwise
