...
public class OdfHelper {
  ...
  private static final String REFERENCE_OUTPUT_FILES =
      "target" + File.separator + "reference-output-files.xml";
  ...
  private static final String PKG_MANIFEST_OUTPUT_FILES =
      "target" + File.separator + "pkg-manifest-output-files.xml";
  ...
  private static final String PKG_DSIG_OUTPUT_FILES =
      "target" + File.separator + "pkg-dsig-output-files.xml";
  ...
  public void start() throws Exception {
    ...
    fillTemplates(
        odfPkgResourceDir,
        mOdf12ManifestRoot,
        PKG_MANIFEST_OUTPUT_FILES_TEMPLATE,
        PKG_MANIFEST_OUTPUT_FILES,
  ...
  private static void createOutputFileList(
      VelocityEngine ve, String template, String output, XMLModel model) throws Exception {
  ...
  public static void processFileList(
      VelocityEngine ve, Expression root, String outputRuleFile, XMLModel model) throws Exception {
