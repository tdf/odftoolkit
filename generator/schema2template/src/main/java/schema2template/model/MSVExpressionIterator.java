...
public final class MSVExpressionIterator implements Iterator<Expression> {
  ...
  // The vertical tree position is remembered by the stack, the vertical position will be remembered
  // by a sibling index
   ...
   * no (unvisited) children, but unvistsiblings -> go up and right
   */
