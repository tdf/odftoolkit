...
/**
 * Domain specific models (Odf, Java, ...) often return 'ns:localname' Strings. The purpose of this
 * class is to encapsulate these Strings so in templates they can be treated like other QNamed
 * objects.
 *
 * <p>Contract: These objects are distincted only by the encapsulated String. So they use this
 * String for equals(o), hashCode() and compareTo(o).
 */
