...
import org.odftoolkit.odfdom.dom.attribute.table.TableDateValueTypeAttribute;
...
public class TableNullDateElement extends OdfElement {
	...
	/**
	 * Receives the value of the ODFDOM attribute representation <code>TableDateValueTypeAttribute</code> , See {@odf.attribute table:date-value-type}
	 *
	 * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set and no default value defined.
	 */
	public String getTableDateValueTypeAttribute() {
		TableDateValueTypeAttribute attr = (TableDateValueTypeAttribute) getOdfAttribute(OdfDocumentNamespace.TABLE, "date-value-type");
		if (attr != null) {
	...
	/**
	 * Sets the value of ODFDOM attribute representation <code>TableDateValueTypeAttribute</code> , See {@odf.attribute table:date-value-type}
	 *
	 * @param tableDateValueTypeValue   The type is <code>String</code>
	 */
	public void setTableDateValueTypeAttribute(String tableDateValueTypeValue) {
		TableDateValueTypeAttribute attr = new TableDateValueTypeAttribute((OdfFileDom) this.ownerDocument);
		setOdfAttribute(attr);
		attr.setValue(tableDateValueTypeValue);
	}
