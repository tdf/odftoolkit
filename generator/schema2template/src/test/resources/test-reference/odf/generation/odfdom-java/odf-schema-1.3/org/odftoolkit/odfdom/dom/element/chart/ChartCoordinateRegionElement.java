...
/**
 * DOM implementation of OpenDocument element  {@odf.element chart:coordinate-region}.
 *
 */
public class ChartCoordinateRegionElement extends OdfElement {

	public static final OdfName ELEMENT_NAME = OdfName.newName(OdfDocumentNamespace.CHART, "coordinate-region");

	/**
	 * Create the instance of <code>ChartCoordinateRegionElement</code>
	 *
	 * @param  ownerDoc     The type is <code>OdfFileDom</code>
	 */
	public ChartCoordinateRegionElement(OdfFileDom ownerDoc) {
	 ...
	 *
	 * @return  return   <code>OdfName</code> the name of element {@odf.element chart:coordinate-region}.
	 */
