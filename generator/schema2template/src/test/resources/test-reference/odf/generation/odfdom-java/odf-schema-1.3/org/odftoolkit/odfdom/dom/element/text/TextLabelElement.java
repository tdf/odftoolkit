...
public class TextLabelElement extends OdfElement {
	...
	/**
	 * Receives the value of the ODFDOM attribute representation <code>TextCurrentSelectedAttribute</code> , See {@odf.attribute text:current-selected}
	 *
	...
	/**
	 * Sets the value of ODFDOM attribute representation <code>TextCurrentSelectedAttribute</code> , See {@odf.attribute text:current-selected}
	 *
	...
	public void setTextCurrentSelectedAttribute(Boolean textCurrentSelectedValue) {
		TextCurrentSelectedAttribute attr = new TextCurrentSelectedAttribute((OdfFileDom) this.ownerDocument);
