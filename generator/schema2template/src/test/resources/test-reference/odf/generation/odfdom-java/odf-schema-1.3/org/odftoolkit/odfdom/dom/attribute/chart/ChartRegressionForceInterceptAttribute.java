...
public static final OdfName ATTRIBUTE_NAME = OdfName.newName(OdfDocumentNamespace.CHART, "regression-force-intercept");


	/**
	 * Create the instance of OpenDocument attribute {@odf.attribute chart:regression-force-intercept}.
	 *
	 ...
	 *
	 * @return <code>true</code> if {@odf.attribute chart:regression-force-intercept} has an element parent
