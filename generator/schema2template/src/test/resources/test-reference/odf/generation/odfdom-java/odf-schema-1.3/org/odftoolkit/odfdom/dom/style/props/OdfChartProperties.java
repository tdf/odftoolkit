...
public interface OdfChartProperties {
	...
	public final static OdfStyleProperty DataLabelSeries =
		OdfStyleProperty.get(OdfStylePropertiesSet.ChartProperties, OdfName.newName(OdfDocumentNamespace.CHART, "data-label-series"));
	...
	public final static OdfStyleProperty RegressionForceIntercept =
		OdfStyleProperty.get(OdfStylePropertiesSet.ChartProperties, OdfName.newName(OdfDocumentNamespace.CHART, "regression-force-intercept"));
	public final static OdfStyleProperty RegressionInterceptValue =
		OdfStyleProperty.get(OdfStylePropertiesSet.ChartProperties, OdfName.newName(OdfDocumentNamespace.CHART, "regression-intercept-value"));
	public final static OdfStyleProperty RegressionMaxDegree =
		OdfStyleProperty.get(OdfStylePropertiesSet.ChartProperties, OdfName.newName(OdfDocumentNamespace.CHART, "regression-max-degree"));
	public final static OdfStyleProperty RegressionMovingType =
		OdfStyleProperty.get(OdfStylePropertiesSet.ChartProperties, OdfName.newName(OdfDocumentNamespace.CHART, "regression-moving-type"));
	public final static OdfStyleProperty RegressionName =
		OdfStyleProperty.get(OdfStylePropertiesSet.ChartProperties, OdfName.newName(OdfDocumentNamespace.CHART, "regression-name"));
	public final static OdfStyleProperty RegressionPeriod =
		OdfStyleProperty.get(OdfStylePropertiesSet.ChartProperties, OdfName.newName(OdfDocumentNamespace.CHART, "regression-period"));
