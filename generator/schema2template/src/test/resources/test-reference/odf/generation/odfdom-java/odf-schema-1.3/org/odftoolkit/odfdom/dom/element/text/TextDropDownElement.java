...
/**
 * DOM implementation of OpenDocument element  {@odf.element text:drop-down}.
 *
 */
public class TextDropDownElement extends OdfElement {

	public static final OdfName ELEMENT_NAME = OdfName.newName(OdfDocumentNamespace.TEXT, "drop-down");

	/**
	 * Create the instance of <code>TextDropDownElement</code>
	 *
	 * @param  ownerDoc     The type is <code>OdfFileDom</code>
	 */
	public TextDropDownElement(OdfFileDom ownerDoc) {
	 ...
	 *
	 * @return  return   <code>OdfName</code> the name of element {@odf.element text:drop-down}.
	 */
	...
	/**
	 * Create child element {@odf.element text:label}.
	 *
	 * Child element was added in ODF 1.3
	 *
	 * @return the element {@odf.element text:label}
	 */
	public TextLabelElement newTextLabelElement() {
		TextLabelElement textLabel = ((OdfFileDom) this.ownerDocument).newOdfElement(TextLabelElement.class);
