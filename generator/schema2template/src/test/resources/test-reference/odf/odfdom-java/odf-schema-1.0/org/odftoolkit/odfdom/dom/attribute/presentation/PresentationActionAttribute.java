...
public static final OdfName ATTRIBUTE_NAME = OdfName.newName(OdfDocumentNamespace.PRESENTATION, "action");
	 ...
	 */
	public enum Value {
		EXECUTE("execute"), FADE_OUT("fade-out"), FIRST_PAGE("first-page"), HIDE("hide"), LAST_PAGE("last-page"), NEXT_PAGE("next-page"), NONE("none"), PREVIOUS_PAGE("previous-page"), SHOW("show"), SOUND("sound"), STOP("stop"), VERB("verb");
