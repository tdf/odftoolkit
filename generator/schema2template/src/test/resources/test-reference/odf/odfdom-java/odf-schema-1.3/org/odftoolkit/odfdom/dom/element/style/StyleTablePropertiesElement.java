...
public class StyleTablePropertiesElement extends OdfStylePropertiesBase {
	...
	/**
	 * Receives the value of the ODFDOM attribute representation <code>TableTabColorAttribute</code> , See {@odf.attribute table:tab-color}
	 *
	 * @return - the <code>String</code> , the value or <code>null</code>, if the attribute is not set and no default value defined.
	 */
	public String getTableTabColorAttribute() {
		TableTabColorAttribute attr = (TableTabColorAttribute) getOdfAttribute(OdfDocumentNamespace.TABLE, "tab-color");
		if (attr != null) {
			return String.valueOf(attr.getValue());
		}
		return null;
	...
	/**
	 * Sets the value of ODFDOM attribute representation <code>TableTabColorAttribute</code> , See {@odf.attribute table:tab-color}
	 *
