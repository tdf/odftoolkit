...
public interface OdfParagraphProperties {
	...
	public final static OdfStyleProperty ContextualSpacing =
		OdfStyleProperty.get(OdfStylePropertiesSet.ParagraphProperties, OdfName.newName(OdfDocumentNamespace.STYLE, "contextual-spacing"));
