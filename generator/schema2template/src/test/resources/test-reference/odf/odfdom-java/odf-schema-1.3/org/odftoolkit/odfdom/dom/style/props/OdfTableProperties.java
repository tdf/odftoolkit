...
public interface OdfTableProperties {
	...
	public final static OdfStyleProperty TabColor =
		OdfStyleProperty.get(OdfStylePropertiesSet.TableProperties, OdfName.newName(OdfDocumentNamespace.TABLE, "tab-color"));
}
