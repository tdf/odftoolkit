...
import org.odftoolkit.odfdom.dom.attribute.NameAttribute;
...
public class SvgFontFaceNameElement extends OdfElement {
	...
	/**
	 * Receives the value of the ODFDOM attribute representation <code>NameAttribute</code> , See {@odf.attribute name}
	 *
	...
	/**
	 * Sets the value of ODFDOM attribute representation <code>NameAttribute</code> , See {@odf.attribute name}
	 *
	 * @param nameValue   The type is <code>String</code>
	 */
	public void setNameAttribute(String nameValue) {
		NameAttribute attr = new NameAttribute((OdfFileDom) this.ownerDocument);
		setOdfAttribute(attr);
		attr.setValue(nameValue);
	}
