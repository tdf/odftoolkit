 ...
 * <p>**********************************************************************
 */
package schema2template.template.odf;
...
import schema2template.template.TemplateAPIRegressionTest;
import schema2template.template.TemplateAPIRegressionTest.MethodSet;

public class OdfTemplateAPIRegressionTest {

  public OdfTemplateAPIRegressionTest() {}
  ...
  public void testOdfRelevantCoverage() {
    ...
    methods = TemplateAPIRegressionTest.getMethods(OdfModel.class);
    ...
    methods = TemplateAPIRegressionTest.getMethods(SourceCodeModel.class);
    ...
    methods = TemplateAPIRegressionTest.getMethods(SourceCodeBaseClass.class);
